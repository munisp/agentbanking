...
export default function CbdcIntegrationGatewayScreen() {
  ...
  const fetchData = async () => {
    try {
      setError(null);
      const res = await fetch(`${API_BASE}/api/trpc/cbdcIntegrationGateway.list`);
  ...
  return (
    ...
    >
      <View style={styles.header}>
        <Text style={styles.title}>Cbdc Integration Gateway</Text>
