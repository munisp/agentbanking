...
class MerchantSettlementDashboardScreen extends StatefulWidget {
  const MerchantSettlementDashboardScreen({super.key});
  @override
  State<MerchantSettlementDashboardScreen> createState() => _MerchantSettlementDashboardScreenState();
}

class _MerchantSettlementDashboardScreenState extends State<MerchantSettlementDashboardScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Merchant Settlement'),
        actions: [
