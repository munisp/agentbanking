...
class CarrierLivePricingScreen extends StatefulWidget {
  const CarrierLivePricingScreen({super.key});
  @override
  State<CarrierLivePricingScreen> createState() => _CarrierLivePricingScreenState();
}

class _CarrierLivePricingScreenState extends State<CarrierLivePricingScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Carrier Live Pricing'),
        actions: [
