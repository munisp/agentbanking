...
class TransactionReversalManagerScreen extends StatefulWidget {
  const TransactionReversalManagerScreen({super.key});
  @override
  State<TransactionReversalManagerScreen> createState() => _TransactionReversalManagerScreenState();
}

class _TransactionReversalManagerScreenState extends State<TransactionReversalManagerScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Transaction Reversal Manager'),
        actions: [
