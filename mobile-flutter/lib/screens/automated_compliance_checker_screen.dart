...
class AutomatedComplianceCheckerScreen extends StatefulWidget {
  const AutomatedComplianceCheckerScreen({super.key});
  @override
  State<AutomatedComplianceCheckerScreen> createState() => _AutomatedComplianceCheckerScreenState();
}

class _AutomatedComplianceCheckerScreenState extends State<AutomatedComplianceCheckerScreen> {
  ...
  Future<void> _load() async {
    try {
      final result = await ApiService.instance.get('/compliance/list', queryParams: {'page': '1', 'limit': '50'});
      setState(() {
        _data = result ?? {};
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Automated Compliance Checker'),
        actions: [
