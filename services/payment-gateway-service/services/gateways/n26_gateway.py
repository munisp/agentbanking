"""
N26 Payment Gateway Integration
Provider: N26
...
class N26Gateway:
    ...
    def _get_base_url(self) -> str:
        ...
        if self.environment == "production":
            return "https://api.n26.com/v1"
        return "https://sandbox-api.n26.com/v1"
    ...
    async def get_quote(self, amount: Decimal, from_currency: str, 
        ...
        async with httpx.AsyncClient() as client:
            ...
            if response.status_code == 200:
                ...
                raise Exception(f"N26 API error: {response.status_code}")
    ...
    async def create_transfer(self, quote_id: str, sender: Dict, 
        ...
        async with httpx.AsyncClient() as client:
            ...
            if response.status_code in [200, 201]:
                ...
                raise Exception(f"N26 transfer failed: {response.status_code}")
