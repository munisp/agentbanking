...
The real implementation lives in the standalone service (services/edge-computing/).
...
_UNAVAILABLE = (
    "edge-computing endpoints are not served by this gateway router. "
    "Use the standalone edge-computing service."
)
...
async def health_check():
    return JSONResponse(
        status_code=503,
        content={"status": "unavailable", "service": "edge-computing", "detail": _UNAVAILABLE},
    )
