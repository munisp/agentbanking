...
class BulkTransactionProcessingScreen extends StatefulWidget {
  const BulkTransactionProcessingScreen({super.key});
  @override
  State<BulkTransactionProcessingScreen> createState() => _BulkTransactionProcessingScreenState();
}

class _BulkTransactionProcessingScreenState extends State<BulkTransactionProcessingScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Bulk Transaction Processing'),
        actions: [
