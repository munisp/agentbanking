...
class ReportBuilderTemplatesScreen extends StatefulWidget {
  const ReportBuilderTemplatesScreen({super.key});
  @override
  State<ReportBuilderTemplatesScreen> createState() => _ReportBuilderTemplatesScreenState();
}

class _ReportBuilderTemplatesScreenState extends State<ReportBuilderTemplatesScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Report Builder Templates'),
        actions: [
