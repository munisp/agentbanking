...
class DisputeAnalyticsDashboardScreen extends StatefulWidget {
  const DisputeAnalyticsDashboardScreen({super.key});
  @override
  State<DisputeAnalyticsDashboardScreen> createState() => _DisputeAnalyticsDashboardScreenState();
}

class _DisputeAnalyticsDashboardScreenState extends State<DisputeAnalyticsDashboardScreen> {
