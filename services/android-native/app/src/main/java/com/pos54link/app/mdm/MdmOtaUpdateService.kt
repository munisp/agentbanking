...
/**
 * 54agent MDM OTA Update Service
 *
...
class MdmOtaUpdateService : IntentService("MdmOtaUpdateService") {
    ...
    private fun downloadApk(downloadUrl: String): File {
        val apkFile = File(cacheDir, "54agent_update_${System.currentTimeMillis()}.apk")
    ...
    private fun createNotificationChannel() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val channel = NotificationChannel(
                ...
                description = "54agent device management update notifications"
            }
    ...
    private fun showProgressNotification(message: String) {
        ...
        val notification = NotificationCompat.Builder(this, NOTIFICATION_CHANNEL_ID)
            ...
            .setContentTitle("54agent MDM Update")
    ...
    private fun showErrorNotification(message: String) {
        ...
        val notification = NotificationCompat.Builder(this, NOTIFICATION_CHANNEL_ID)
            ...
            .setContentTitle("54agent MDM Update Failed")
            .setContentText(message)
            .setAutoCancel(true)
