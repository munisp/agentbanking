...
class GatewayHealthMonitorScreen extends StatefulWidget {
  const GatewayHealthMonitorScreen({super.key});
  @override
  State<GatewayHealthMonitorScreen> createState() => _GatewayHealthMonitorScreenState();
}

class _GatewayHealthMonitorScreenState extends State<GatewayHealthMonitorScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Gateway Health Monitor'),
        actions: [
