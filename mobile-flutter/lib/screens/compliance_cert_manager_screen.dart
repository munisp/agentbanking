...
class ComplianceCertManagerScreen extends StatefulWidget {
  const ComplianceCertManagerScreen({super.key});
  @override
  State<ComplianceCertManagerScreen> createState() => _ComplianceCertManagerScreenState();
}

class _ComplianceCertManagerScreenState extends State<ComplianceCertManagerScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Compliance Cert Manager'),
        actions: [
