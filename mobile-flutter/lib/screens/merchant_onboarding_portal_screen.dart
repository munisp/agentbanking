...
class MerchantOnboardingPortalScreen extends StatefulWidget {
  const MerchantOnboardingPortalScreen({super.key});
  @override
  State<MerchantOnboardingPortalScreen> createState() => _MerchantOnboardingPortalScreenState();
}

class _MerchantOnboardingPortalScreenState extends State<MerchantOnboardingPortalScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Merchant Onboarding Portal'),
        actions: [
