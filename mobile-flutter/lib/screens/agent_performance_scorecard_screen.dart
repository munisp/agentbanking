...
class AgentPerformanceScorecardScreen extends StatefulWidget {
  const AgentPerformanceScorecardScreen({super.key});
  @override
  State<AgentPerformanceScorecardScreen> createState() => _AgentPerformanceScorecardScreenState();
}

class _AgentPerformanceScorecardScreenState extends State<AgentPerformanceScorecardScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Agent Performance Scorecard'),
        actions: [
