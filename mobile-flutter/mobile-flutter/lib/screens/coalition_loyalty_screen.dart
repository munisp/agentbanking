...
class CoalitionLoyaltyScreen extends StatefulWidget {
  const CoalitionLoyaltyScreen({super.key});
  @override
  State<CoalitionLoyaltyScreen> createState() => _CoalitionLoyaltyScreenState();
}

class _CoalitionLoyaltyScreenState extends State<CoalitionLoyaltyScreen> {
  ...
  Future<void> _load() async {
    try {
      final result = await ApiService.instance.get('/loyalty/list', queryParams: {'page': '1', 'limit': '50'});
      setState(() {
        _data = result ?? {};
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Coalition Loyalty'),
        actions: [
