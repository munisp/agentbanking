...
class OperationalRunbookScreen extends StatefulWidget {
  const OperationalRunbookScreen({super.key});
  @override
  State<OperationalRunbookScreen> createState() => _OperationalRunbookScreenState();
}

class _OperationalRunbookScreenState extends State<OperationalRunbookScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Operational Runbook'),
        actions: [
