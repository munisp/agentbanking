  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.headerTitle}>Multi Currency</Text>
        ...
        renderItem={({ item }) => (
          <TouchableOpacity style={styles.card}>
            <View style={styles.cardHeader}>
              <Text style={styles.cardTitle}>{item.fromCurrency}</Text>
              <Text style={styles.cardBadge}>{item.rate}</Text>
            </View>
            <Text style={styles.cardSubtitle}>{item.toCurrency}</Text>
            <Text style={styles.cardMeta}>{item.amount}</Text>
          </TouchableOpacity>
        )}
      />
    </View>
