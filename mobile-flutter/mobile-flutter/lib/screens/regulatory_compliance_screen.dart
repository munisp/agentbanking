...
class RegulatoryComplianceScreen extends StatefulWidget {
  const RegulatoryComplianceScreen({super.key});
  @override
  State<RegulatoryComplianceScreen> createState() => _RegulatoryComplianceScreenState();
}

class _RegulatoryComplianceScreenState extends State<RegulatoryComplianceScreen> {
