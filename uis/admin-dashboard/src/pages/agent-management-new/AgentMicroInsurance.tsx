...
export default function AgentMicroInsurance() {
  ...
  const summary = trpc.agentMicroInsurance.getStats.useQuery()?.data as
    | Record<string, unknown>
    | undefined;
  const listQ = trpc.agentMicroInsurance.listPolicies.useQuery({ limit: 20 });
        ...
        <div className="flex items-center justify-between flex-wrap gap-4">
          <div>
            ...
            <p className="text-muted-foreground">
              Insurance policy management, claims processing, and coverage
              tracking
            </p>
          </div>
          <div className="flex gap-2 flex-wrap">
            <Button onClick={() => toast.success("New Policy initiated")}>
              New Policy
            </Button>
            <Button
              variant="outline"
              onClick={() => toast.success("File Claim initiated")}
            >
              File Claim
            </Button>
            <Button
              variant="outline"
              onClick={() => toast.success("Renew initiated")}
            >
              Renew
            </Button>
          </div>
