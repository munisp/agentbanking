...
if _otel_endpoint:
    try:
        ...
        _resource = Resource.create({
            "service.name": os.environ.get("OTEL_SERVICE_NAME", "ussd-session-replayer"),
...
DATABASE_URL = os.environ.get("DATABASE_URL", "postgres://postgres:postgres@localhost:5432/ussd_session_replayer")
...
async def startup_event():
    ...
    await publish_kafka("ussd.session.replayer.started", {
        "service": "ussd-session-replayer",
