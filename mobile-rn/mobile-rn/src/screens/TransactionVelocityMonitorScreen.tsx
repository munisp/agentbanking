...
const TransactionVelocityMonitorScreen: React.FC = () => {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.header}>Transaction Velocity Monitor</Text>
...
export default TransactionVelocityMonitorScreen;
