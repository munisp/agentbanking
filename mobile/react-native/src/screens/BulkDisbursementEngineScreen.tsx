...
export default function BulkDisbursementEngineScreen() {
  ...
  const fetchData = async () => {
    try {
      setError(null);
      const res = await fetch(`${API_BASE}/api/trpc/bulkDisbursementEngine.list`);
  ...
  return (
    ...
    >
      <View style={styles.header}>
        <Text style={styles.title}>Bulk Disbursement Engine</Text>
