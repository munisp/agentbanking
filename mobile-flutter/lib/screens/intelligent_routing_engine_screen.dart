...
class IntelligentRoutingEngineScreen extends StatefulWidget {
  const IntelligentRoutingEngineScreen({super.key});
  @override
  State<IntelligentRoutingEngineScreen> createState() => _IntelligentRoutingEngineScreenState();
}

class _IntelligentRoutingEngineScreenState extends State<IntelligentRoutingEngineScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Intelligent Routing Engine'),
        actions: [
