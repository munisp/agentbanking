...
export default function ChaosEngineeringConsole() {
  ...
  const summary = trpc.chaosEngineeringConsole.getSummary.useQuery()?.data as
    | Record<string, unknown>
    | undefined;
  const listQ = trpc.chaosEngineeringConsole.list.useQuery({
    limit: 20,
    offset: page * 20,
        ...
        <div className="flex items-center justify-between flex-wrap gap-4">
          <div>
            ...
            <p className="text-muted-foreground">
              Fault injection, resilience testing, and system stability
              experiments
            </p>
          </div>
          <div className="flex gap-2 flex-wrap">
            ...
            <Button
              variant="outline"
              onClick={() => toast.success("Run Test initiated")}
            >
              Run Test
            </Button>
          </div>
          ...
          <Card key="0">
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {(summary?.totalExperiments ?? 0).toLocaleString()}
              </div>
            </CardContent>
          </Card>
          <Card key="1">
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {(summary?.activeTests ?? 0).toLocaleString()}
              </div>
            </CardContent>
          </Card>
          <Card key="2">
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {(summary?.systemsImpacted ?? 0).toLocaleString()}
              </div>
            </CardContent>
          </Card>
          <Card key="3">
