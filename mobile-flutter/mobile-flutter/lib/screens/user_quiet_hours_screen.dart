...
class UserQuietHoursScreen extends StatefulWidget {
  const UserQuietHoursScreen({super.key});
  @override
  State<UserQuietHoursScreen> createState() => _UserQuietHoursScreenState();
}

class _UserQuietHoursScreenState extends State<UserQuietHoursScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('User Quiet Hours'),
        actions: [
