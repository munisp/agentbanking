...
const FraudCaseManagementScreen: React.FC = () => {
  ...
  const load = useCallback(async () => {
    try {
      setError('');
      const { data } = await apiClient.get('/fraud/list?page=1&limit=50');
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.header}>Fraud Case Management</Text>
...
export default FraudCaseManagementScreen;
