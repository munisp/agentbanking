# 54agent Workspace Redundancy Audit
...
| ------------------------------------------------------------- | ------ | ------------------------------------ |
| `/home/ubuntu/.archived-stale/54agent-phases-65-70/`           | ~30 MB | Superseded by current implementation |
| `/home/ubuntu/.archived-stale/54agent-phases-65-70.zip`        | ~15 MB | Same content as directory            |
| `/home/ubuntu/.archived-stale/54agent-production-overhaul/`    | ~20 MB | Superseded by pos-shell-demo         |
| `/home/ubuntu/.archived-stale/54agent-production-overhaul.zip` | ~10 MB | Same content as directory            |
| `/home/ubuntu/.archived-stale/pos-demo/`                      | ~5 MB  | Early prototype, superseded          |

**Retained:** `/home/ubuntu/.archived-stale/54agent-pos-shell-complete.zip` and `/home/ubuntu/.archived-stale/54agent-pos-source.zip` — these are the most recent pre-overhaul snapshots and should be kept as rollback references.
