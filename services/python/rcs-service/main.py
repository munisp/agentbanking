...
DATABASE_URL = os.environ.get("DATABASE_URL", "postgres://postgres:postgres@localhost:5432/rcs_service")
...
messages_cache = []  # PG-backed via pg_get_list("rcs-service", "messages")
orders_cache = []  # PG-backed via pg_get_list("rcs-service", "orders")
