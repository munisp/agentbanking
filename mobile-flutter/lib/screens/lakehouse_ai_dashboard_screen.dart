...
class LakehouseAiDashboardScreen extends StatefulWidget {
  const LakehouseAiDashboardScreen({super.key});
  @override
  State<LakehouseAiDashboardScreen> createState() => _LakehouseAiDashboardScreenState();
}

class _LakehouseAiDashboardScreenState extends State<LakehouseAiDashboardScreen> {
