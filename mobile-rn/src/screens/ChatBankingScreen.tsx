  ...
  if (loading) {
    return (
      <View style={styles.center}>
        ...
        <Text style={styles.loadingText}>Loading Chat Banking...</Text>
      </View>
    );
  }
  ...
  return (
    ...
    >
      ...
      <View style={styles.header}>
        <Text style={styles.title}>Chat Banking</Text>
        <Text style={styles.subtitle}>WhatsApp and conversational banking</Text>
      </View>
