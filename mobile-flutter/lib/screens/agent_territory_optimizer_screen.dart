...
class AgentTerritoryOptimizerScreen extends StatefulWidget {
  const AgentTerritoryOptimizerScreen({super.key});
  @override
  State<AgentTerritoryOptimizerScreen> createState() => _AgentTerritoryOptimizerScreenState();
}

class _AgentTerritoryOptimizerScreenState extends State<AgentTerritoryOptimizerScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Agent Territory Optimizer'),
        actions: [
