...
class PlatformRecommendationsScreen extends StatefulWidget {
  const PlatformRecommendationsScreen({super.key});
  @override
  State<PlatformRecommendationsScreen> createState() => _PlatformRecommendationsScreenState();
}

class _PlatformRecommendationsScreenState extends State<PlatformRecommendationsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Platform Recommendations'),
        actions: [
