...
class RansomwareAlertDashboardScreen extends StatefulWidget {
  const RansomwareAlertDashboardScreen({super.key});
  @override
  State<RansomwareAlertDashboardScreen> createState() => _RansomwareAlertDashboardScreenState();
}

class _RansomwareAlertDashboardScreenState extends State<RansomwareAlertDashboardScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Ransomware Alert'),
        actions: [
