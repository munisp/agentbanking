...
export default function AgentGeoFenceScreen() {
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.headerTitle}>Geo Fencing</Text>
        ...
        renderItem={({ item }) => (
          <TouchableOpacity style={styles.card}>
            <View style={styles.cardHeader}>
              <Text style={styles.cardTitle}>{item.zoneName}</Text>
              <Text style={styles.cardBadge}>{item.latitude}</Text>
            </View>
            <Text style={styles.cardSubtitle}>{item.radius}</Text>
            <Text style={styles.cardMeta}>{item.longitude}</Text>
          </TouchableOpacity>
        )}
      />
    </View>
