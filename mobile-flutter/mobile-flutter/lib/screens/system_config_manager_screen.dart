...
class SystemConfigManagerScreen extends StatefulWidget {
  const SystemConfigManagerScreen({super.key});
  @override
  State<SystemConfigManagerScreen> createState() => _SystemConfigManagerScreenState();
}

class _SystemConfigManagerScreenState extends State<SystemConfigManagerScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('System Config Manager'),
        actions: [
