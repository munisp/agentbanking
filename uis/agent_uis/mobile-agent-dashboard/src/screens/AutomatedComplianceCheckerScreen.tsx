...
const AutomatedComplianceCheckerScreen: React.FC = () => {
  ...
  const load = useCallback(async () => {
    try {
      setError('');
      const { data } = await apiClient.get('/compliance/list?page=1&limit=50');
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.header}>Automated Compliance Checker</Text>
...
export default AutomatedComplianceCheckerScreen;
