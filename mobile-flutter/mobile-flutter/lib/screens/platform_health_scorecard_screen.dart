...
class PlatformHealthScorecardScreen extends StatefulWidget {
  const PlatformHealthScorecardScreen({super.key});
  @override
  State<PlatformHealthScorecardScreen> createState() => _PlatformHealthScorecardScreenState();
}

class _PlatformHealthScorecardScreenState extends State<PlatformHealthScorecardScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Platform Health Scorecard'),
        actions: [
