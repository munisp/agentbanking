...
if _otel_endpoint:
    try:
        ...
        _resource = Resource.create({
            "service.name": os.environ.get("OTEL_SERVICE_NAME", "critical-gaps"),
...
DATABASE_URL = os.environ.get("DATABASE_URL", "postgres://postgres:postgres@localhost:5432/critical_gaps")
...
async def startup_event():
    ...
    await publish_kafka("critical.gaps.started", {
        "service": "critical-gaps",
