...
class PlatformConfigCenterScreen extends StatefulWidget {
  const PlatformConfigCenterScreen({super.key});
  @override
  State<PlatformConfigCenterScreen> createState() => _PlatformConfigCenterScreenState();
}

class _PlatformConfigCenterScreenState extends State<PlatformConfigCenterScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Platform Config Center'),
        actions: [
