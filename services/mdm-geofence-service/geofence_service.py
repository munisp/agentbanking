"""
54agent MDM Geofence Cross-Wiring Service
=========================================
...
Default configuration (all overridable via environment variables):
  ...
  POSTGRES_URL        = postgresql://54agent:54agent@localhost:5432/54agent_pos
  HTTP_PORT           = 8096
...
POSTGRES_URL        = os.getenv("POSTGRES_URL", "postgresql://54agent:54agent@localhost:5432/54agent_pos")
...
app = FastAPI(title="54agent MDM Geofence Service", version="1.0.0")
