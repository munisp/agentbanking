...
class ReconciliationEngineScreen extends StatefulWidget {
  const ReconciliationEngineScreen({super.key});
  @override
  State<ReconciliationEngineScreen> createState() => _ReconciliationEngineScreenState();
}

class _ReconciliationEngineScreenState extends State<ReconciliationEngineScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Reconciliation Engine'),
        actions: [
