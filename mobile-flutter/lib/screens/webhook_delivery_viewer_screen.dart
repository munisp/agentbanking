...
class WebhookDeliveryViewerScreen extends StatefulWidget {
  const WebhookDeliveryViewerScreen({super.key});
  @override
  State<WebhookDeliveryViewerScreen> createState() => _WebhookDeliveryViewerScreenState();
}

class _WebhookDeliveryViewerScreenState extends State<WebhookDeliveryViewerScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Webhook Delivery Viewer'),
        actions: [
