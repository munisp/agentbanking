...
class CustomerOnboardingPipelineScreen extends StatefulWidget {
  const CustomerOnboardingPipelineScreen({super.key});
  @override
  State<CustomerOnboardingPipelineScreen> createState() => _CustomerOnboardingPipelineScreenState();
}

class _CustomerOnboardingPipelineScreenState extends State<CustomerOnboardingPipelineScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Customer Onboarding Pipeline'),
        actions: [
