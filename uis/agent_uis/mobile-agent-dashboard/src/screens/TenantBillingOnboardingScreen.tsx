...
const TenantBillingOnboardingScreen: React.FC = () => {
  ...
  const load = useCallback(async () => {
    try {
      setError('');
      const { data } = await apiClient.get('/billing/list?page=1&limit=50');
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.header}>Tenant Billing Onboarding</Text>
...
export default TenantBillingOnboardingScreen;
