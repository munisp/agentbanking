...
The real implementation lives in the standalone service (services/instagram-service/).
...
_UNAVAILABLE = (
    "instagram-service endpoints are not served by this gateway router. "
    "Use the standalone instagram-service service."
)
...
async def health_check():
    return JSONResponse(
        status_code=503,
        content={"status": "unavailable", "service": "instagram-service", "detail": _UNAVAILABLE},
    )
