...
class SocialCommerceGatewayScreen extends StatefulWidget {
  const SocialCommerceGatewayScreen({super.key});
  @override
  State<SocialCommerceGatewayScreen> createState() => _SocialCommerceGatewayScreenState();
}

class _SocialCommerceGatewayScreenState extends State<SocialCommerceGatewayScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Social Commerce Gateway'),
        actions: [
