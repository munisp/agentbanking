...
export default function RegulatoryFilingAutomationScreen() {
  ...
  const fetchData = async () => {
    try {
      setError(null);
      const res = await fetch(`${API_BASE}/api/trpc/regulatoryFilingAutomation.list`);
  ...
  return (
    ...
    >
      <View style={styles.header}>
        <Text style={styles.title}>Regulatory Filing Automation</Text>
