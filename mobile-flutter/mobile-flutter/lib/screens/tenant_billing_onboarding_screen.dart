...
class TenantBillingOnboardingScreen extends StatefulWidget {
  const TenantBillingOnboardingScreen({super.key});
  @override
  State<TenantBillingOnboardingScreen> createState() => _TenantBillingOnboardingScreenState();
}

class _TenantBillingOnboardingScreenState extends State<TenantBillingOnboardingScreen> {
  ...
  Future<void> _load() async {
    try {
      final result = await ApiService.instance.get('/billing/list', queryParams: {'page': '1', 'limit': '50'});
      setState(() {
        _data = result ?? {};
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Tenant Billing Onboarding'),
        actions: [
