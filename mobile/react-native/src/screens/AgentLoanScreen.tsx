...
export default function AgentLoanScreen() {
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.headerTitle}>Agent Loan</Text>
        ...
        renderItem={({ item }) => (
          <TouchableOpacity style={styles.card}>
            <View style={styles.cardHeader}>
              <Text style={styles.cardTitle}>{item.loanAmount}</Text>
              <Text style={styles.cardBadge}>{item.interestRate}</Text>
            </View>
            <Text style={styles.cardSubtitle}>{item.tenure}</Text>
