...
export default function NfcTapToPayScreen() {
  ...
  if (loading) {
    return (
      <View style={styles.center}>
        ...
        <Text style={styles.loadingText}>Loading NFC Tap-to-Pay...</Text>
      </View>
    );
  }
  ...
  return (
    ...
    >
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.subtitle}>NFC terminal and contactless payments</Text>
      </View>
