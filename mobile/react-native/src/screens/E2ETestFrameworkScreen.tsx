...
export default function E2ETestFrameworkScreen() {
  ...
  const fetchData = async () => {
    try {
      setError(null);
      const res = await fetch(`${API_BASE}/api/trpc/e2ETestFramework.list`);
  ...
  return (
    ...
    >
      <View style={styles.header}>
        <Text style={styles.title}>E2 E Test Framework</Text>
