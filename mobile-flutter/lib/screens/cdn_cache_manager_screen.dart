...
class CdnCacheManagerScreen extends StatefulWidget {
  const CdnCacheManagerScreen({super.key});
  @override
  State<CdnCacheManagerScreen> createState() => _CdnCacheManagerScreenState();
}

class _CdnCacheManagerScreenState extends State<CdnCacheManagerScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Cdn Cache Manager'),
        actions: [
