...
class AdvancedLoadingStatesScreen extends StatefulWidget {
  const AdvancedLoadingStatesScreen({super.key});
  @override
  State<AdvancedLoadingStatesScreen> createState() => _AdvancedLoadingStatesScreenState();
}

class _AdvancedLoadingStatesScreenState extends State<AdvancedLoadingStatesScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Advanced Loading States'),
        actions: [
