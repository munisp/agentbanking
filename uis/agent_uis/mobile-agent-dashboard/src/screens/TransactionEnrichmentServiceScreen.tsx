...
const TransactionEnrichmentServiceScreen: React.FC = () => {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.header}>Transaction Enrichment Service</Text>
...
export default TransactionEnrichmentServiceScreen;
