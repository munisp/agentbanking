...
class NlFinancialQueryScreen extends StatefulWidget {
  const NlFinancialQueryScreen({super.key});
  @override
  State<NlFinancialQueryScreen> createState() => _NlFinancialQueryScreenState();
}

class _NlFinancialQueryScreenState extends State<NlFinancialQueryScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Nl Financial Query'),
        actions: [
