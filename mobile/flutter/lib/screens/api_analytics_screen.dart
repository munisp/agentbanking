      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return Card(
            ...
            child: ListTile(
              title: Text(item['endpoint']?.toString() ?? 'N/A'),
              subtitle: Text(item['requestCount']?.toString() ?? ''),
              trailing: Text(item['avgLatency']?.toString() ?? '', style: const TextStyle(fontWeight: FontWeight.bold)),
            ),
          );
        },
      ),
