...
export default function TransactionVelocityMonitorScreen() {
  ...
  const fetchData = async () => {
    try {
      setError(null);
      const res = await fetch(`${API_BASE}/api/trpc/transactionVelocityMonitor.list`);
  ...
  return (
    ...
    >
      <View style={styles.header}>
        <Text style={styles.title}>Transaction Velocity Monitor</Text>
