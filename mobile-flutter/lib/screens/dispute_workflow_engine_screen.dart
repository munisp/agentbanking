...
class DisputeWorkflowEngineScreen extends StatefulWidget {
  const DisputeWorkflowEngineScreen({super.key});
  @override
  State<DisputeWorkflowEngineScreen> createState() => _DisputeWorkflowEngineScreenState();
}

class _DisputeWorkflowEngineScreenState extends State<DisputeWorkflowEngineScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Dispute Workflow Engine'),
        actions: [
