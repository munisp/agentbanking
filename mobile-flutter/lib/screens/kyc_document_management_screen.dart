...
class KycDocumentManagementScreen extends StatefulWidget {
  const KycDocumentManagementScreen({super.key});
  @override
  State<KycDocumentManagementScreen> createState() => _KycDocumentManagementScreenState();
}

class _KycDocumentManagementScreenState extends State<KycDocumentManagementScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Kyc Document Management'),
        actions: [
