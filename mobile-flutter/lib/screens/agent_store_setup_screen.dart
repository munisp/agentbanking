...
class AgentStoreSetupScreen extends StatefulWidget {
  const AgentStoreSetupScreen({super.key});
  @override
  State<AgentStoreSetupScreen> createState() => _AgentStoreSetupScreenState();
}

class _AgentStoreSetupScreenState extends State<AgentStoreSetupScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Agent Store Setup'),
        actions: [
