...
class LoyaltySystemScreen extends StatefulWidget {
  const LoyaltySystemScreen({super.key});
  @override
  State<LoyaltySystemScreen> createState() => _LoyaltySystemScreenState();
}

class _LoyaltySystemScreenState extends State<LoyaltySystemScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Loyalty System'),
        actions: [
