...
class AgentClusterAnalyticsScreen extends StatefulWidget {
  const AgentClusterAnalyticsScreen({super.key});
  @override
  State<AgentClusterAnalyticsScreen> createState() => _AgentClusterAnalyticsScreenState();
}

class _AgentClusterAnalyticsScreenState extends State<AgentClusterAnalyticsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Agent Cluster Analytics'),
        actions: [
