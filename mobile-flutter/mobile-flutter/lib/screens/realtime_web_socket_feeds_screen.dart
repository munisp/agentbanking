...
class RealtimeWebSocketFeedsScreen extends StatefulWidget {
  const RealtimeWebSocketFeedsScreen({super.key});
  @override
  State<RealtimeWebSocketFeedsScreen> createState() => _RealtimeWebSocketFeedsScreenState();
}

class _RealtimeWebSocketFeedsScreenState extends State<RealtimeWebSocketFeedsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Realtime Web Socket Feeds'),
        actions: [
