...
const MultiChannelNotificationHubScreen: React.FC = () => {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.header}>Multi Channel Notification Hub</Text>
...
export default MultiChannelNotificationHubScreen;
