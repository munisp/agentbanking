CREATE TABLE "sim_orchestrator_config" (
	...
	"relayEndpoint" varchar(256) DEFAULT 'https://api.54agent.io/api/trpc/simOrchestrator.ingestProbe' NOT NULL,
	"apiKey" varchar(128) DEFAULT '54agent-sim-orchestrator-default-key' NOT NULL,
