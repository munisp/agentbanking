...
export default function AgentGamificationPage() {
  ...
  const leaderboardQuery = {data: null, isLoading: false, refetch: () => {}};
  const achievementsQuery = {data: null, isLoading: false, refetch: () => {}};
  const badgesQuery = {data: null, isLoading: false, refetch: () => {}};
