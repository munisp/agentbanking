...
class DbtIntegrationScreen extends StatefulWidget {
  const DbtIntegrationScreen({super.key});
  @override
  State<DbtIntegrationScreen> createState() => _DbtIntegrationScreenState();
}

class _DbtIntegrationScreenState extends State<DbtIntegrationScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Dbt Integration'),
        actions: [
