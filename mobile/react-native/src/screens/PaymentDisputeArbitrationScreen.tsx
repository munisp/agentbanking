...
export default function PaymentDisputeArbitrationScreen() {
  ...
  const fetchData = async () => {
    try {
      setError(null);
      const res = await fetch(`${API_BASE}/api/trpc/paymentDisputeArbitration.list`);
  ...
  return (
    ...
    >
      <View style={styles.header}>
        <Text style={styles.title}>Payment Dispute Arbitration</Text>
