...
class AgentOnboardingWorkflowScreen extends StatefulWidget {
  const AgentOnboardingWorkflowScreen({super.key});
  @override
  State<AgentOnboardingWorkflowScreen> createState() => _AgentOnboardingWorkflowScreenState();
}

class _AgentOnboardingWorkflowScreenState extends State<AgentOnboardingWorkflowScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Agent Onboarding Workflow'),
        actions: [
