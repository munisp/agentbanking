...
const PlatformMaturityScorecardScreen: React.FC = () => {
  ...
  const load = useCallback(async () => {
    try {
      setError('');
      const { data } = await apiClient.get('/cards/list?page=1&limit=50');
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.header}>Platform Maturity Scorecard</Text>
...
export default PlatformMaturityScorecardScreen;
