...
const HealthInsuranceMicroScreen: React.FC = () => {
  ...
  const load = useCallback(async () => {
    try {
      setError('');
      const { data } = await apiClient.get('/insurance/list?page=1&limit=50');
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.header}>Health Insurance Micro</Text>
...
export default HealthInsuranceMicroScreen;
