// resilience-agent — 54agent Nigeria Connectivity Resilience Service
//
...
import (
	...
	"github.com/54agent/resilience-agent/internal/carrier"
	"github.com/54agent/resilience-agent/internal/probe"
	"github.com/54agent/resilience-agent/internal/retry"
)
