...
The real implementation lives in the standalone service (services/jumia-service/).
...
_UNAVAILABLE = (
    "jumia-service endpoints are not served by this gateway router. "
    "Use the standalone jumia-service service."
)
...
async def health_check():
    return JSONResponse(
        status_code=503,
        content={"status": "unavailable", "service": "jumia-service", "detail": _UNAVAILABLE},
    )
