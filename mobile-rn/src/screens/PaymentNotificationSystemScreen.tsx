...
const PaymentNotificationSystemScreen: React.FC = () => {
  ...
  const load = useCallback(async () => {
    try {
      setError('');
      const { data } = await apiClient.get('/payments/list?page=1&limit=50');
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.header}>Payment Notification System</Text>
...
export default PaymentNotificationSystemScreen;
