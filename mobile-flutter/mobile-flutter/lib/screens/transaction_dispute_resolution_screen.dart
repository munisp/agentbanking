...
class TransactionDisputeResolutionScreen extends StatefulWidget {
  const TransactionDisputeResolutionScreen({super.key});
  @override
  State<TransactionDisputeResolutionScreen> createState() => _TransactionDisputeResolutionScreenState();
}

class _TransactionDisputeResolutionScreenState extends State<TransactionDisputeResolutionScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Transaction Dispute Resolution'),
        actions: [
