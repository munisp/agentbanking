...
class CanaryReleaseManagerScreen extends StatefulWidget {
  const CanaryReleaseManagerScreen({super.key});
  @override
  State<CanaryReleaseManagerScreen> createState() => _CanaryReleaseManagerScreenState();
}

class _CanaryReleaseManagerScreenState extends State<CanaryReleaseManagerScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Canary Release Manager'),
        actions: [
