...
class ApacheNifiScreen extends StatefulWidget {
  const ApacheNifiScreen({super.key});
  @override
  State<ApacheNifiScreen> createState() => _ApacheNifiScreenState();
}

class _ApacheNifiScreenState extends State<ApacheNifiScreen> {
