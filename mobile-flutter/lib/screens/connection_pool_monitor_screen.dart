...
class ConnectionPoolMonitorScreen extends StatefulWidget {
  const ConnectionPoolMonitorScreen({super.key});
  @override
  State<ConnectionPoolMonitorScreen> createState() => _ConnectionPoolMonitorScreenState();
}

class _ConnectionPoolMonitorScreenState extends State<ConnectionPoolMonitorScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Connection Pool Monitor'),
        actions: [
