...
export default function TransactionMapVizPage() {
  ...
  useEffect(() => {
    ...
    fetch(`${CORE_BANKING_URL}/api/v1/transaction-map-viz/stats`, { headers: authHeaders() })
      ...
      <div className="space-y-6 p-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground mt-1">Real-time map visualization of transaction locations</p>
          </div>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          ...
          <TabsContent value="settings">
            <Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  <p className="text-muted-foreground">Configure Transaction Map settings and preferences.</p>
