...
class BankingWorkflowPatternsScreen extends StatefulWidget {
  const BankingWorkflowPatternsScreen({super.key});
  @override
  State<BankingWorkflowPatternsScreen> createState() => _BankingWorkflowPatternsScreenState();
}

class _BankingWorkflowPatternsScreenState extends State<BankingWorkflowPatternsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Banking Workflow Patterns'),
        actions: [
