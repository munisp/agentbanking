...
export default function ReportBuilderTemplatesPage() {
  ...
  useEffect(() => {
    ...
    fetch(`${CORE_BANKING_URL}/api/v1/report-builder-templates/stats`, { headers: authHeaders() })
      ...
      <div className="space-y-6 p-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground mt-1">Pre-built templates for common financial reports</p>
          </div>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          ...
          <TabsContent value="settings">
            <Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  <p className="text-muted-foreground">Configure Report Templates settings and preferences.</p>
