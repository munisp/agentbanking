...
const AlertNotificationPreferencesScreen: React.FC = () => {
  ...
  const load = useCallback(async () => {
    try {
      setError('');
      const { data } = await apiClient.get('/notifications/list?page=1&limit=50');
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.header}>Alert Notification Preferences</Text>
...
export default AlertNotificationPreferencesScreen;
