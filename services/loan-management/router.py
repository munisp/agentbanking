...
The real implementation lives in the standalone service (services/loan-management/).
...
_UNAVAILABLE = (
    "loan-management endpoints are not served by this gateway router. "
    "Use the standalone loan-management service."
)
...
async def health_check():
    return JSONResponse(
        status_code=503,
        content={"status": "unavailable", "service": "loan-management", "detail": _UNAVAILABLE},
    )
