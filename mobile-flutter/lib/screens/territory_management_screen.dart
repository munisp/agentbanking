...
class TerritoryManagementScreen extends StatefulWidget {
  const TerritoryManagementScreen({super.key});
  @override
  State<TerritoryManagementScreen> createState() => _TerritoryManagementScreenState();
}

class _TerritoryManagementScreenState extends State<TerritoryManagementScreen> {
