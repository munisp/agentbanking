...
class ConnectionQualityScreen extends StatefulWidget {
  const ConnectionQualityScreen({super.key});
  @override
  State<ConnectionQualityScreen> createState() => _ConnectionQualityScreenState();
}

class _ConnectionQualityScreenState extends State<ConnectionQualityScreen> {
