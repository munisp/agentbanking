...
class AgentInventoryMgmtScreen extends StatefulWidget {
  const AgentInventoryMgmtScreen({super.key});
  @override
  State<AgentInventoryMgmtScreen> createState() => _AgentInventoryMgmtScreenState();
}

class _AgentInventoryMgmtScreenState extends State<AgentInventoryMgmtScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Agent Inventory Mgmt'),
        actions: [
