...
class AuditTrailExportScreen extends StatefulWidget {
  const AuditTrailExportScreen({super.key});
  @override
  State<AuditTrailExportScreen> createState() => _AuditTrailExportScreenState();
}

class _AuditTrailExportScreenState extends State<AuditTrailExportScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Audit Trail Export'),
        actions: [
