...
class MultiTenancyScreen extends StatefulWidget {
  const MultiTenancyScreen({super.key});
  @override
  State<MultiTenancyScreen> createState() => _MultiTenancyScreenState();
}

class _MultiTenancyScreenState extends State<MultiTenancyScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Multi Tenancy'),
        actions: [
