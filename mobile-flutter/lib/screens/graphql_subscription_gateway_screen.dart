...
class GraphqlSubscriptionGatewayScreen extends StatefulWidget {
  const GraphqlSubscriptionGatewayScreen({super.key});
  @override
  State<GraphqlSubscriptionGatewayScreen> createState() => _GraphqlSubscriptionGatewayScreenState();
}

class _GraphqlSubscriptionGatewayScreenState extends State<GraphqlSubscriptionGatewayScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Graphql Subscription Gateway'),
        actions: [
