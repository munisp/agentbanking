...
class DbSchemaMigrationManagerScreen extends StatefulWidget {
  const DbSchemaMigrationManagerScreen({super.key});
  @override
  State<DbSchemaMigrationManagerScreen> createState() => _DbSchemaMigrationManagerScreenState();
}

class _DbSchemaMigrationManagerScreenState extends State<DbSchemaMigrationManagerScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Db Schema Migration Manager'),
        actions: [
