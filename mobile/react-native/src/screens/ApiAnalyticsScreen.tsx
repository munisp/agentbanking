...
/** API usage metrics and latency */
export default function ApiAnalyticsScreen() {
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.headerTitle}>API Analytics</Text>
        ...
        renderItem={({ item }) => (
          <TouchableOpacity style={styles.card}>
            <View style={styles.cardHeader}>
              <Text style={styles.cardTitle}>{item.endpoint}</Text>
              <Text style={styles.cardBadge}>{item.avgLatency}</Text>
            </View>
            <Text style={styles.cardSubtitle}>{item.requestCount}</Text>
            <Text style={styles.cardMeta}>{item.errorRate}</Text>
          </TouchableOpacity>
        )}
      />
    </View>
