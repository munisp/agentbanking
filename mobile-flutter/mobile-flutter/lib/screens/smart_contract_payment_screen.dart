...
class SmartContractPaymentScreen extends StatefulWidget {
  const SmartContractPaymentScreen({super.key});
  @override
  State<SmartContractPaymentScreen> createState() => _SmartContractPaymentScreenState();
}

class _SmartContractPaymentScreenState extends State<SmartContractPaymentScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Smart Contract Payment'),
        actions: [
