...
class AutomatedTestingFrameworkScreen extends StatefulWidget {
  const AutomatedTestingFrameworkScreen({super.key});
  @override
  State<AutomatedTestingFrameworkScreen> createState() => _AutomatedTestingFrameworkScreenState();
}

class _AutomatedTestingFrameworkScreenState extends State<AutomatedTestingFrameworkScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Automated Testing Framework'),
        actions: [
