package com.pos54agent.app.mdm
 ...
 *   server_url       — MDM server base URL (default: https://54agent.manus.space)
...
class MdmHeartbeatWorker(
    ...
    companion object {
        ...
        private const val WORK_NAME = "54agent_mdm_heartbeat"
        private const val PREFS_NAME = "mdm_config"
        private const val DEFAULT_SERVER_URL = "https://54agent.manus.space"
    ...
    private fun sendHeartbeat(
        ...
        return try {
            ...
            conn.setRequestProperty("X-54agent-Device-Token", deviceToken)
    ...
    private fun captureAndUploadScreenshot(serverUrl: String, deviceToken: String, commandId: String) {
        ...
        val intent = Intent("com.pos54agent.app.MDM_SCREENSHOT").apply {
    ...
    private fun scheduleOtaUpdate(downloadUrl: String) {
        ...
        val intent = Intent("com.pos54agent.app.MDM_OTA_UPDATE").apply {
