...
export default function RealtimeDashboardWidgetsScreen() {
  ...
  const fetchData = async () => {
    try {
      setError(null);
      const res = await fetch(`${API_BASE}/api/trpc/realtimeDashboardWidgets.list`);
  ...
  return (
    ...
    >
      <View style={styles.header}>
        <Text style={styles.title}>Realtime Dashboard Widgets</Text>
