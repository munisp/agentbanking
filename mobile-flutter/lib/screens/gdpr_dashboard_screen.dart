...
class GdprDashboardScreen extends StatefulWidget {
  const GdprDashboardScreen({super.key});
  @override
  State<GdprDashboardScreen> createState() => _GdprDashboardScreenState();
}

class _GdprDashboardScreenState extends State<GdprDashboardScreen> {
