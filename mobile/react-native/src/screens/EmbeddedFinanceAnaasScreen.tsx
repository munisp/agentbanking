...
export default function EmbeddedFinanceAnaasScreen() {
  ...
  const fetchData = async () => {
    try {
      setError(null);
      const res = await fetch(`${API_BASE}/api/trpc/embeddedFinanceAnaas.list`);
  ...
  return (
    ...
    >
      <View style={styles.header}>
        <Text style={styles.title}>Embedded Finance Anaas</Text>
