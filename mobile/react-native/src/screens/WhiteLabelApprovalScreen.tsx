...
export default function WhiteLabelApprovalScreen() {
  ...
  const fetchData = async () => {
    try {
      setError(null);
      const res = await fetch(`${API_BASE}/api/trpc/whiteLabelApproval.list`);
  ...
  return (
    ...
    >
      <View style={styles.header}>
        <Text style={styles.title}>White Label Approval</Text>
