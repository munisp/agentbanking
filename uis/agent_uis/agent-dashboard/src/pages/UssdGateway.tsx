...
export default function UssdGateway() {
  ...
  const menuTree = {data: null, isLoading: false, refetch: () => {}};
  const analytics = {data: null, isLoading: false, refetch: () => {}};
  const sessions = {data: null, isLoading: false, refetch: () => {}};
  const txns = {data: null, isLoading: false, refetch: () => {}};
  const processInput = {
    mutate: (payload: any) => { setInput(""); },
    mutateAsync: async (payload: any) => { setInput(""); },
