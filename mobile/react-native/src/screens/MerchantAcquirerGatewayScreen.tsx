...
export default function MerchantAcquirerGatewayScreen() {
  ...
  const fetchData = async () => {
    try {
      setError(null);
      const res = await fetch(`${API_BASE}/api/trpc/merchantAcquirerGateway.list`);
  ...
  return (
    ...
    >
      <View style={styles.header}>
        <Text style={styles.title}>Merchant Acquirer Gateway</Text>
