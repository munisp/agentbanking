...
class SimOrchestratorDashboardScreen extends StatefulWidget {
  const SimOrchestratorDashboardScreen({super.key});
  @override
  State<SimOrchestratorDashboardScreen> createState() => _SimOrchestratorDashboardScreenState();
}

class _SimOrchestratorDashboardScreenState extends State<SimOrchestratorDashboardScreen> {
  ...
  Future<void> _load() async {
    try {
      final result = await ApiService.instance.get('/dashboard/list', queryParams: {'page': '1', 'limit': '50'});
      setState(() {
        _data = result ?? {};
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Sim Orchestrator'),
        actions: [
