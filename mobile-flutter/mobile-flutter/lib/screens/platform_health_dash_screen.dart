...
class PlatformHealthDashScreen extends StatefulWidget {
  const PlatformHealthDashScreen({super.key});
  @override
  State<PlatformHealthDashScreen> createState() => _PlatformHealthDashScreenState();
}

class _PlatformHealthDashScreenState extends State<PlatformHealthDashScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Platform Health Dash'),
        actions: [
