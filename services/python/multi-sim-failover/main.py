...
if _otel_endpoint:
    try:
        ...
        _resource = Resource.create({
            "service.name": os.environ.get("OTEL_SERVICE_NAME", "multi-sim-failover"),
...
DATABASE_URL = os.environ.get("DATABASE_URL", "postgres://postgres:postgres@localhost:5432/multi_sim_failover")
...
async def startup_event():
    ...
    await publish_kafka("multi.sim.failover.started", {
