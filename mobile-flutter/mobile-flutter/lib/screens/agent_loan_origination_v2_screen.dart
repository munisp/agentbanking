...
class AgentLoanOriginationV2Screen extends StatefulWidget {
  const AgentLoanOriginationV2Screen({super.key});
  @override
  State<AgentLoanOriginationV2Screen> createState() => _AgentLoanOriginationV2ScreenState();
}

class _AgentLoanOriginationV2ScreenState extends State<AgentLoanOriginationV2Screen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Agent Loan Origination V2'),
        actions: [
