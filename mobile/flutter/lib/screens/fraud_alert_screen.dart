      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return Card(
            ...
            child: ListTile(
              title: Text(item['alertType']?.toString() ?? 'N/A'),
              subtitle: Text(item['severity']?.toString() ?? ''),
              trailing: Text(item['transactionRef']?.toString() ?? '', style: const TextStyle(fontWeight: FontWeight.bold)),
            ),
          );
        },
      ),
