package com.pos54agent.app.voice
...
class GoogleAssistantManager(private val context: Context) {
    ...
    fun handleAssistantIntent(intent: Intent): String? {
        return when (intent.action) {
            "com.pos54agent.CHECK_BALANCE" -> handleCheckBalance()
            "com.pos54agent.SEND_MONEY" -> handleSendMoney(intent)
            "com.pos54agent.VIEW_SPENDING" -> handleViewSpending(intent)
            else -> null
        }
    }
