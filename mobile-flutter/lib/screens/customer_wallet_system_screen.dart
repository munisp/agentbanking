...
class CustomerWalletSystemScreen extends StatefulWidget {
  const CustomerWalletSystemScreen({super.key});
  @override
  State<CustomerWalletSystemScreen> createState() => _CustomerWalletSystemScreenState();
}

class _CustomerWalletSystemScreenState extends State<CustomerWalletSystemScreen> {
  ...
  Future<void> _load() async {
    try {
      final result = await ApiService.instance.get('/wallet/list', queryParams: {'page': '1', 'limit': '50'});
      setState(() {
        _data = result ?? {};
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Customer Wallet System'),
        actions: [
