...
class CustomerSegmentationEngineScreen extends StatefulWidget {
  const CustomerSegmentationEngineScreen({super.key});
  @override
  State<CustomerSegmentationEngineScreen> createState() => _CustomerSegmentationEngineScreenState();
}

class _CustomerSegmentationEngineScreenState extends State<CustomerSegmentationEngineScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Customer Segmentation Engine'),
        actions: [
