...
class AnnouncementReactionsScreen extends StatefulWidget {
  const AnnouncementReactionsScreen({super.key});
  @override
  State<AnnouncementReactionsScreen> createState() => _AnnouncementReactionsScreenState();
}

class _AnnouncementReactionsScreenState extends State<AnnouncementReactionsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Announcement Reactions'),
        actions: [
