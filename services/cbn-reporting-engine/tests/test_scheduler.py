...
class TestReportSubmission:
    ...
    def test_report_s3_key_format(self):
        ...
        year = "2026"
        month = "03"
        filename = "54agent001_monthly_activity_2026-03-31.json"
    ...
    def test_report_json_serializable(self):
        ...
        assert parsed["institutionCode"] == "54agent001"
