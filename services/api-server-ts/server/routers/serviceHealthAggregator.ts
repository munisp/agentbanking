...
const SERVICE_REGISTRY = [
  // Core API
  { name: "54agent API", url: "http://localhost:3001/api/health" },
  ...
  // Infrastructure
  { name: "Keycloak", url: "http://localhost:8080/auth/realms/54agent" },
...
function validateServicehealthaggregatorInput(
