...
class ConversationalBankingScreen extends StatefulWidget {
  const ConversationalBankingScreen({super.key});
  @override
  State<ConversationalBankingScreen> createState() => _ConversationalBankingScreenState();
}

class _ConversationalBankingScreenState extends State<ConversationalBankingScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Conversational Banking'),
        actions: [
