...
class UssdGatewayScreen extends StatefulWidget {
  const UssdGatewayScreen({super.key});
  @override
  State<UssdGatewayScreen> createState() => _UssdGatewayScreenState();
}

class _UssdGatewayScreenState extends State<UssdGatewayScreen> {
