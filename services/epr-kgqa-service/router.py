...
The real implementation lives in the standalone service (services/epr-kgqa-service/).
...
_UNAVAILABLE = (
    "epr-kgqa-service endpoints are not served by this gateway router. "
    "Use the standalone epr-kgqa-service service."
)
...
async def health_check():
    return JSONResponse(
        status_code=503,
        content={"status": "unavailable", "service": "epr-kgqa-service", "detail": _UNAVAILABLE},
    )
