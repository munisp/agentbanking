...
class AgentPerformanceIncentivesScreen extends StatefulWidget {
  const AgentPerformanceIncentivesScreen({super.key});
  @override
  State<AgentPerformanceIncentivesScreen> createState() => _AgentPerformanceIncentivesScreenState();
}

class _AgentPerformanceIncentivesScreenState extends State<AgentPerformanceIncentivesScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Agent Performance Incentives'),
        actions: [
