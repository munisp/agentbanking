...
class MerchantRiskScoringScreen extends StatefulWidget {
  const MerchantRiskScoringScreen({super.key});
  @override
  State<MerchantRiskScoringScreen> createState() => _MerchantRiskScoringScreenState();
}

class _MerchantRiskScoringScreenState extends State<MerchantRiskScoringScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Merchant Risk Scoring'),
        actions: [
