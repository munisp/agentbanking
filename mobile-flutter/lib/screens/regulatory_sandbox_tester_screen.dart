...
class RegulatorySandboxTesterScreen extends StatefulWidget {
  const RegulatorySandboxTesterScreen({super.key});
  @override
  State<RegulatorySandboxTesterScreen> createState() => _RegulatorySandboxTesterScreenState();
}

class _RegulatorySandboxTesterScreenState extends State<RegulatorySandboxTesterScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Regulatory Sandbox Tester'),
        actions: [
