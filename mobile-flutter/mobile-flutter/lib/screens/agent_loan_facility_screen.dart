...
class AgentLoanFacilityScreen extends StatefulWidget {
  const AgentLoanFacilityScreen({super.key});
  @override
  State<AgentLoanFacilityScreen> createState() => _AgentLoanFacilityScreenState();
}

class _AgentLoanFacilityScreenState extends State<AgentLoanFacilityScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Agent Loan Facility'),
        actions: [
