...
The real implementation lives in the standalone service (services/ml-engine/).
...
_UNAVAILABLE = (
    "ml-engine endpoints are not served by this gateway router. "
    "Use the standalone ml-engine service."
)
...
async def health_check():
    return JSONResponse(
        status_code=503,
        content={"status": "unavailable", "service": "ml-engine", "detail": _UNAVAILABLE},
    )
