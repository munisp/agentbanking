...
export default function CurrencyHedging() {
  ...
  const summary = trpc.currencyHedging.getSummary.useQuery()?.data as
    | Record<string, unknown>
    | undefined;
  const listQ = trpc.currencyHedging.list.useQuery({
    limit: 20,
    offset: page * 20,
        ...
        <div className="flex items-center justify-between flex-wrap gap-4">
          <div>
            ...
            <p className="text-muted-foreground">
              FX exposure management, hedging strategies, and position tracking
            </p>
          </div>
          <div className="flex gap-2 flex-wrap">
            <Button onClick={() => toast.success("New Hedge initiated")}>
              New Hedge
            </Button>
            <Button
              variant="outline"
              onClick={() => toast.success("Close Position initiated")}
            >
              Close Position
            </Button>
          </div>
          ...
          <Card key="0">
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {(summary?.openPositions ?? 0).toLocaleString()}
              </div>
            </CardContent>
          </Card>
          <Card key="1">
