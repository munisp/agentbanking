...
/// Partner integrations and shared revenue
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return Card(
            ...
            child: ListTile(
              title: Text(item['partnerName']?.toString() ?? 'N/A'),
              subtitle: Text(item['integrationStatus']?.toString() ?? ''),
              trailing: Text(item['revenue']?.toString() ?? '', style: const TextStyle(fontWeight: FontWeight.bold)),
            ),
          );
        },
      ),
