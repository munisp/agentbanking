...
export default function IntelligentRoutingEngine() {
  ...
  const summary = trpc.intelligentRoutingEngine.getSummary.useQuery()?.data as
    | Record<string, unknown>
    | undefined;
  const listQ = trpc.intelligentRoutingEngine.list.useQuery({
    limit: 20,
    offset: page * 20,
        ...
        <div className="flex items-center justify-between flex-wrap gap-4">
          <div>
            ...
            <p className="text-muted-foreground">
              Smart transaction routing, provider selection, and failover
              management
            </p>
          </div>
          <div className="flex gap-2 flex-wrap">
            ...
            <Button
              variant="outline"
              onClick={() => toast.success("Test Provider initiated")}
            >
              Test Provider
            </Button>
          </div>
          ...
          <Card key="0">
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {(summary?.totalRouted ?? 0).toLocaleString()}
              </div>
            </CardContent>
          </Card>
          <Card key="1">
