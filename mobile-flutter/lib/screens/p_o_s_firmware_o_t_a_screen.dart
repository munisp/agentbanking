...
class POSFirmwareOTAScreen extends StatefulWidget {
  const POSFirmwareOTAScreen({super.key});
  @override
  State<POSFirmwareOTAScreen> createState() => _POSFirmwareOTAScreenState();
}

class _POSFirmwareOTAScreenState extends State<POSFirmwareOTAScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('P O S Firmware O T A'),
        actions: [
