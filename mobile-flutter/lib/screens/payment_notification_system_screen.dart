...
class PaymentNotificationSystemScreen extends StatefulWidget {
  const PaymentNotificationSystemScreen({super.key});
  @override
  State<PaymentNotificationSystemScreen> createState() => _PaymentNotificationSystemScreenState();
}

class _PaymentNotificationSystemScreenState extends State<PaymentNotificationSystemScreen> {
  ...
  Future<void> _load() async {
    try {
      final result = await ApiService.instance.get('/payments/list', queryParams: {'page': '1', 'limit': '50'});
      setState(() {
        _data = result ?? {};
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Payment Notification System'),
        actions: [
