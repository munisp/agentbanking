  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.headerTitle}>Agent Hierarchy</Text>
        ...
        renderItem={({ item }) => (
          <TouchableOpacity style={styles.card}>
            <View style={styles.cardHeader}>
              <Text style={styles.cardTitle}>{item.parentAgent}</Text>
              <Text style={styles.cardBadge}>{item.level}</Text>
            </View>
            <Text style={styles.cardSubtitle}>{item.territory}</Text>
            <Text style={styles.cardMeta}>{item.commissionSplit}</Text>
          </TouchableOpacity>
        )}
      />
    </View>
