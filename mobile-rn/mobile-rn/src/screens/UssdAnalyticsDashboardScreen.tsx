...
const UssdAnalyticsDashboardScreen: React.FC = () => {
  ...
  const load = useCallback(async () => {
    try {
      setError('');
      const { data } = await apiClient.get('/ussd/list?page=1&limit=50');
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.header}>Ussd Analytics</Text>
...
export default UssdAnalyticsDashboardScreen;
