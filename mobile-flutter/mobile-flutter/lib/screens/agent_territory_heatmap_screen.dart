...
class AgentTerritoryHeatmapScreen extends StatefulWidget {
  const AgentTerritoryHeatmapScreen({super.key});
  @override
  State<AgentTerritoryHeatmapScreen> createState() => _AgentTerritoryHeatmapScreenState();
}

class _AgentTerritoryHeatmapScreenState extends State<AgentTerritoryHeatmapScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Agent Territory Heatmap'),
        actions: [
