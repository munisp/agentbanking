...
import (
	...
	"github.com/54agent/tb-commission-sidecar/internal/api"
	"github.com/54agent/tb-commission-sidecar/internal/ledger"
)
...
func main() {
	...
	if dbPath == "" {
		dbPath = "/var/lib/54agent/tb-commission.db"
	}

	os.MkdirAll("/var/lib/54agent", 0755)
