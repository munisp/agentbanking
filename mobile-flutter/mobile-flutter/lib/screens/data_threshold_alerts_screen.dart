...
class DataThresholdAlertsScreen extends StatefulWidget {
  const DataThresholdAlertsScreen({super.key});
  @override
  State<DataThresholdAlertsScreen> createState() => _DataThresholdAlertsScreenState();
}

class _DataThresholdAlertsScreenState extends State<DataThresholdAlertsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Data Threshold Alerts'),
        actions: [
