...
class WhiteLabelOnboardingScreen extends StatefulWidget {
  const WhiteLabelOnboardingScreen({super.key});
  @override
  State<WhiteLabelOnboardingScreen> createState() => _WhiteLabelOnboardingScreenState();
}

class _WhiteLabelOnboardingScreenState extends State<WhiteLabelOnboardingScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('White Label Onboarding'),
        actions: [
