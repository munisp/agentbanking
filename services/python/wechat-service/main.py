...
DATABASE_URL = os.environ.get("DATABASE_URL", "postgres://postgres:postgres@localhost:5432/wechat_service")
...
messages_cache = []  # PG-backed via pg_get_list("wechat-service", "messages")
orders_cache = []  # PG-backed via pg_get_list("wechat-service", "orders")
