// cmd/gateway/main.go
// 54agent Platform API Gateway (Go)
//
...
func main() {
	...
	go func() {
		log.Printf("[gateway] 54agent API Gateway v2.0.0 listening on :%s (%d services registered)", port, len(serviceRegistry))
