...
class UssdSessionReplayScreen extends StatefulWidget {
  const UssdSessionReplayScreen({super.key});
  @override
  State<UssdSessionReplayScreen> createState() => _UssdSessionReplayScreenState();
}

class _UssdSessionReplayScreenState extends State<UssdSessionReplayScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Ussd Session Replay'),
        actions: [
