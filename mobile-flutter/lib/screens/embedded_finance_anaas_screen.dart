...
class EmbeddedFinanceAnaasScreen extends StatefulWidget {
  const EmbeddedFinanceAnaasScreen({super.key});
  @override
  State<EmbeddedFinanceAnaasScreen> createState() => _EmbeddedFinanceAnaasScreenState();
}

class _EmbeddedFinanceAnaasScreenState extends State<EmbeddedFinanceAnaasScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Embedded Finance Anaas'),
        actions: [
