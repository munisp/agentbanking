...
if _otel_endpoint:
    try:
        ...
        _resource = Resource.create({
            "service.name": os.environ.get("OTEL_SERVICE_NAME", "rule-engine"),
...
DATABASE_URL = os.environ.get("DATABASE_URL", "postgres://postgres:postgres@localhost:5432/rule_engine")
...
async def startup_event():
    ...
    await publish_kafka("rule.engine.started", {
        "service": "rule-engine",
