...
if _otel_endpoint:
    try:
        ...
        _resource = Resource.create({
            "service.name": os.environ.get("OTEL_SERVICE_NAME", "fraud-ml-pipeline"),
...
DATABASE_URL = os.environ.get("DATABASE_URL", "postgres://postgres:postgres@localhost:5432/fraud_ml_pipeline")
...
async def startup_event():
    ...
    await publish_kafka("fraud.ml.pipeline.started", {
        "service": "fraud-ml-pipeline",
