...
export default function DynamicFeeScreen() {
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.headerTitle}>Dynamic Fees</Text>
        ...
        renderItem={({ item }) => (
          <TouchableOpacity style={styles.card}>
            <View style={styles.cardHeader}>
              ...
              <Text style={styles.cardBadge}>{item.flatAmount}</Text>
            </View>
            <Text style={styles.cardSubtitle}>{item.percentage}</Text>
