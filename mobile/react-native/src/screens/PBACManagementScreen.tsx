...
export default function PBACManagementScreen() {
  ...
  const fetchData = async () => {
    try {
      setError(null);
      const res = await fetch(`${API_BASE}/api/trpc/pBACManagement.list`);
  ...
  return (
    ...
    >
      <View style={styles.header}>
        <Text style={styles.title}>P B A C Management</Text>
