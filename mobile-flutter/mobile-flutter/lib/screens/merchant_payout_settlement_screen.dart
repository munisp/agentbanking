...
class MerchantPayoutSettlementScreen extends StatefulWidget {
  const MerchantPayoutSettlementScreen({super.key});
  @override
  State<MerchantPayoutSettlementScreen> createState() => _MerchantPayoutSettlementScreenState();
}

class _MerchantPayoutSettlementScreenState extends State<MerchantPayoutSettlementScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Merchant Payout Settlement'),
        actions: [
