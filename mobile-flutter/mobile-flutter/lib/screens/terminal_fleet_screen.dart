...
class TerminalFleetScreen extends StatefulWidget {
  const TerminalFleetScreen({super.key});
  @override
  State<TerminalFleetScreen> createState() => _TerminalFleetScreenState();
}

class _TerminalFleetScreenState extends State<TerminalFleetScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Terminal Fleet'),
        actions: [
