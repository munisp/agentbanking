...
class EventDrivenArchScreen extends StatefulWidget {
  const EventDrivenArchScreen({super.key});
  @override
  State<EventDrivenArchScreen> createState() => _EventDrivenArchScreenState();
}

class _EventDrivenArchScreenState extends State<EventDrivenArchScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Event Driven Arch'),
        actions: [
