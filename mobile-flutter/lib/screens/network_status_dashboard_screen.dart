...
class NetworkStatusDashboardScreen extends StatefulWidget {
  const NetworkStatusDashboardScreen({super.key});
  @override
  State<NetworkStatusDashboardScreen> createState() => _NetworkStatusDashboardScreenState();
}

class _NetworkStatusDashboardScreenState extends State<NetworkStatusDashboardScreen> {
