...
const AgentPerformanceIncentivesScreen: React.FC = () => {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.header}>Agent Performance Incentives</Text>
...
export default AgentPerformanceIncentivesScreen;
