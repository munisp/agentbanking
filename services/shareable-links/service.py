...
Features:
- Unique short URLs (e.g., 54agent.ng/s/ABC123)
...
class ShareableLinksService:
    ...
    BASE_URL = os.environ.get("PLATFORM_BASE_URL", "https://54agent.ng")
    SHORT_URL_BASE = os.environ.get("SHORT_URL_BASE", "https://54agent.ng/s")
    ...
    def create_shop_link(self, req: CreateShopLinkRequest) -> ShareableLinkResponse:
        ...
        return self.create_link(CreateLinkRequest(
            ...
            title=req.shop_name,
            description=req.shop_description or f"Shop at {req.shop_name} on 54agent",
    ...
    def create_referral_link(self, agent_id: str, campaign: Optional[str] = None) -> ShareableLinkResponse:
        ...
        return self.create_link(CreateLinkRequest(
            ...
            destination_url=destination,
            title="Join 54agent — Nigeria's #1 Agency Banking Platform",
