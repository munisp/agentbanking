...
export default function ScheduledEmailDeliveryScreen() {
  ...
  const fetchData = async () => {
    try {
      setError(null);
      const res = await fetch(`${API_BASE}/api/trpc/scheduledEmailDelivery.list`);
  ...
  return (
    ...
    >
      <View style={styles.header}>
        <Text style={styles.title}>Scheduled Email Delivery</Text>
