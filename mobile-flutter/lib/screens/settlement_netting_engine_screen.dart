...
class SettlementNettingEngineScreen extends StatefulWidget {
  const SettlementNettingEngineScreen({super.key});
  @override
  State<SettlementNettingEngineScreen> createState() => _SettlementNettingEngineScreenState();
}

class _SettlementNettingEngineScreenState extends State<SettlementNettingEngineScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Settlement Netting Engine'),
        actions: [
