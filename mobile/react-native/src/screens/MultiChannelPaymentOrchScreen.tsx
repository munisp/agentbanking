...
export default function MultiChannelPaymentOrchScreen() {
  ...
  const fetchData = async () => {
    try {
      setError(null);
      const res = await fetch(`${API_BASE}/api/trpc/multiChannelPaymentOrch.list`);
  ...
  return (
    ...
    >
      <View style={styles.header}>
        <Text style={styles.title}>Multi Channel Payment Orch</Text>
