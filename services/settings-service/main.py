"""
54agent Platform Settings Service
...
def _default_settings() -> Dict[str, Any]:
    return {
        "platform_name": os.getenv("PLATFORM_NAME", "54agent Agency Banking Platform"),
        "support_email": os.getenv("SUPPORT_EMAIL", "support@54agent.com"),
