...
class HealthInsuranceMicroScreen extends StatefulWidget {
  const HealthInsuranceMicroScreen({super.key});
  @override
  State<HealthInsuranceMicroScreen> createState() => _HealthInsuranceMicroScreenState();
}

class _HealthInsuranceMicroScreenState extends State<HealthInsuranceMicroScreen> {
  ...
  Future<void> _load() async {
    try {
      final result = await ApiService.instance.get('/insurance/list', queryParams: {'page': '1', 'limit': '50'});
      setState(() {
        _data = result ?? {};
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Health Insurance Micro'),
        actions: [
