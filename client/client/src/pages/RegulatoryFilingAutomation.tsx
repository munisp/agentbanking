...
export default function RegulatoryFilingAutomation() {
  ...
  const summary = trpc.regulatoryFilingAutomation.getSummary.useQuery()
    ?.data as Record<string, unknown> | undefined;
  const listQ = trpc.regulatoryFilingAutomation.list.useQuery({
    limit: 20,
    offset: page * 20,
      ...
      <div className="space-y-6 p-6">
        <div className="flex items-center justify-between flex-wrap gap-4">
          <div>
            ...
            <p className="text-muted-foreground">
              Automated regulatory report filing, compliance deadlines, and
              submission tracking
            </p>
          </div>
          <div className="flex gap-2 flex-wrap">
            ...
            <Button
              variant="outline"
              onClick={() => toast.success("Submit Filing initiated")}
            >
              Submit Filing
            </Button>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <Card key="0">
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {(summary?.totalFilings ?? 0).toLocaleString()}
              </div>
            </CardContent>
          </Card>
          <Card key="1">
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {(summary?.onTime ?? 0).toLocaleString()}
              </div>
            </CardContent>
          </Card>
          <Card key="2">
          ...
          <Card key="3">
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {(summary?.nextDeadline ?? 0).toLocaleString()}
              </div>
            </CardContent>
          </Card>
        </div>
