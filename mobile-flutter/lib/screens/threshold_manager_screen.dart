...
class ThresholdManagerScreen extends StatefulWidget {
  const ThresholdManagerScreen({super.key});
  @override
  State<ThresholdManagerScreen> createState() => _ThresholdManagerScreenState();
}

class _ThresholdManagerScreenState extends State<ThresholdManagerScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Threshold Manager'),
        actions: [
