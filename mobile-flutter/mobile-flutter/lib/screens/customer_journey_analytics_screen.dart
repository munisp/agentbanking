...
class CustomerJourneyAnalyticsScreen extends StatefulWidget {
  const CustomerJourneyAnalyticsScreen({super.key});
  @override
  State<CustomerJourneyAnalyticsScreen> createState() => _CustomerJourneyAnalyticsScreenState();
}

class _CustomerJourneyAnalyticsScreenState extends State<CustomerJourneyAnalyticsScreen> {
  ...
  Future<void> _load() async {
    try {
      final result = await ApiService.instance.get('/analytics/list', queryParams: {'page': '1', 'limit': '50'});
      setState(() {
        _data = result ?? {};
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Customer Journey Analytics'),
        actions: [
