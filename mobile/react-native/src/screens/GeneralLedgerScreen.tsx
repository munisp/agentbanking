...
/** GL entries and journal postings */
        ...
        renderItem={({ item }) => (
          <TouchableOpacity style={styles.card}>
            <View style={styles.cardHeader}>
              <Text style={styles.cardTitle}>{item.accountCode}</Text>
              <Text style={styles.cardBadge}>{item.credit}</Text>
            </View>
            <Text style={styles.cardSubtitle}>{item.debit}</Text>
            <Text style={styles.cardMeta}>{item.narration}</Text>
          </TouchableOpacity>
        )}
      />
    </View>
