...
class MultiTenantIsolationScreen extends StatefulWidget {
  const MultiTenantIsolationScreen({super.key});
  @override
  State<MultiTenantIsolationScreen> createState() => _MultiTenantIsolationScreenState();
}

class _MultiTenantIsolationScreenState extends State<MultiTenantIsolationScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Multi Tenant Isolation'),
        actions: [
