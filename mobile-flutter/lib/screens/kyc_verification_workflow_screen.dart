...
class KycVerificationWorkflowScreen extends StatefulWidget {
  const KycVerificationWorkflowScreen({super.key});
  @override
  State<KycVerificationWorkflowScreen> createState() => _KycVerificationWorkflowScreenState();
}

class _KycVerificationWorkflowScreenState extends State<KycVerificationWorkflowScreen> {
  ...
  Future<void> _load() async {
    try {
      final result = await ApiService.instance.get('/kyc/list', queryParams: {'page': '1', 'limit': '50'});
      setState(() {
        _data = result ?? {};
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Kyc Verification Workflow'),
        actions: [
