...
class PartnerSelfServiceScreen extends StatefulWidget {
  const PartnerSelfServiceScreen({super.key});
  @override
  State<PartnerSelfServiceScreen> createState() => _PartnerSelfServiceScreenState();
}

class _PartnerSelfServiceScreenState extends State<PartnerSelfServiceScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Partner Self Service'),
        actions: [
