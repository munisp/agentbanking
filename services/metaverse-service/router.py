...
The real implementation lives in the standalone service (services/metaverse-service/).
...
_UNAVAILABLE = (
    "metaverse-service endpoints are not served by this gateway router. "
    "Use the standalone metaverse-service service."
)
...
async def health_check():
    return JSONResponse(
        status_code=503,
        content={"status": "unavailable", "service": "metaverse-service", "detail": _UNAVAILABLE},
    )
