...
if _otel_endpoint:
    try:
        ...
        _resource = Resource.create({
            "service.name": os.environ.get("OTEL_SERVICE_NAME", "agent-ecommerce-platform"),
...
async def startup_event():
    ...
    await publish_kafka("agent.ecommerce.platform.started", {
        "service": "agent-ecommerce-platform",
