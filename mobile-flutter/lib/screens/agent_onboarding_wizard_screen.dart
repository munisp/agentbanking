...
class AgentOnboardingWizardScreen extends StatefulWidget {
  const AgentOnboardingWizardScreen({super.key});
  @override
  State<AgentOnboardingWizardScreen> createState() => _AgentOnboardingWizardScreenState();
}

class _AgentOnboardingWizardScreenState extends State<AgentOnboardingWizardScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Agent Onboarding Wizard'),
        actions: [
