...
class TemporalWorkflowMonitorScreen extends StatefulWidget {
  const TemporalWorkflowMonitorScreen({super.key});
  @override
  State<TemporalWorkflowMonitorScreen> createState() => _TemporalWorkflowMonitorScreenState();
}

class _TemporalWorkflowMonitorScreenState extends State<TemporalWorkflowMonitorScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Temporal Workflow Monitor'),
        actions: [
