...
class AgentManagementDashboardScreen extends StatefulWidget {
  const AgentManagementDashboardScreen({super.key});
  @override
  State<AgentManagementDashboardScreen> createState() => _AgentManagementDashboardScreenState();
}

class _AgentManagementDashboardScreenState extends State<AgentManagementDashboardScreen> {
