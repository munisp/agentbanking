...
class RealtimePnlDashboardScreen extends StatefulWidget {
  const RealtimePnlDashboardScreen({super.key});
  @override
  State<RealtimePnlDashboardScreen> createState() => _RealtimePnlDashboardScreenState();
}

class _RealtimePnlDashboardScreenState extends State<RealtimePnlDashboardScreen> {
