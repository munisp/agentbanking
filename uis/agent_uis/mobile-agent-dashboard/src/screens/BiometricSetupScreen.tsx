 ...
 * (Fingerprint and Face ID) for the 54agent Agency Banking app.
 * 
 * Brand Colors:
 * - Primary: #6C63FF (Purple)
 * - Background: colors.primary (Dark Navy)
 * - Card: #FFFFFF
 * - Text: colors.primary
 */
      ...
      <ScrollView style={styles.container} contentContainerStyle={styles.contentContainer}>
        ...
        <View style={styles.infoBox}>
          ...
          <Text style={styles.infoText}>
            Biometric authentication adds an extra layer of security by ensuring only you can access your 54agent account. It's faster than typing a PIN and highly secure.
          </Text>
        </View>
