...
class DigitalTwinSimulatorScreen extends StatefulWidget {
  const DigitalTwinSimulatorScreen({super.key});
  @override
  State<DigitalTwinSimulatorScreen> createState() => _DigitalTwinSimulatorScreenState();
}
...
class _DigitalTwinSimulatorScreenState extends State<DigitalTwinSimulatorScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Digital Twin Simulator'),
        actions: [
