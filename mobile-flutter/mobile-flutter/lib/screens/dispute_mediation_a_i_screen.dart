...
class DisputeMediationAIScreen extends StatefulWidget {
  const DisputeMediationAIScreen({super.key});
  @override
  State<DisputeMediationAIScreen> createState() => _DisputeMediationAIScreenState();
}

class _DisputeMediationAIScreenState extends State<DisputeMediationAIScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Dispute Mediation A I'),
        actions: [
