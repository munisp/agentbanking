...
if _otel_endpoint:
    try:
        ...
        _resource = Resource.create({
            "service.name": os.environ.get("OTEL_SERVICE_NAME", "agent-embedded-finance"),
...
DATABASE_URL = os.environ.get("DATABASE_URL", "postgres://postgres:postgres@localhost:5432/agent_embedded_finance")
...
async def startup_event():
    ...
    await publish_kafka("agent.embedded.finance.started", {
        "service": "agent-embedded-finance",
