...
class AgentNetworkTopologyScreen extends StatefulWidget {
  const AgentNetworkTopologyScreen({super.key});
  @override
  State<AgentNetworkTopologyScreen> createState() => _AgentNetworkTopologyScreenState();
}

class _AgentNetworkTopologyScreenState extends State<AgentNetworkTopologyScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Agent Network Topology'),
        actions: [
