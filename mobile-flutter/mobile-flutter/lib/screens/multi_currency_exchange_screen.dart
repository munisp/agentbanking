...
class MultiCurrencyExchangeScreen extends StatefulWidget {
  const MultiCurrencyExchangeScreen({super.key});
  @override
  State<MultiCurrencyExchangeScreen> createState() => _MultiCurrencyExchangeScreenState();
}

class _MultiCurrencyExchangeScreenState extends State<MultiCurrencyExchangeScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Multi Currency Exchange'),
        actions: [
