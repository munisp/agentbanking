...
class FinancialNlEngineScreen extends StatefulWidget {
  const FinancialNlEngineScreen({super.key});
  @override
  State<FinancialNlEngineScreen> createState() => _FinancialNlEngineScreenState();
}

class _FinancialNlEngineScreenState extends State<FinancialNlEngineScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Financial Nl Engine'),
        actions: [
