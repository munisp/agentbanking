...
class SuperAppFrameworkScreen extends StatefulWidget {
  const SuperAppFrameworkScreen({super.key});
  @override
  State<SuperAppFrameworkScreen> createState() => _SuperAppFrameworkScreenState();
}

class _SuperAppFrameworkScreenState extends State<SuperAppFrameworkScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Super App Framework'),
        actions: [
