...
class CrossBorderRemittanceHubScreen extends StatefulWidget {
  const CrossBorderRemittanceHubScreen({super.key});
  @override
  State<CrossBorderRemittanceHubScreen> createState() => _CrossBorderRemittanceHubScreenState();
}

class _CrossBorderRemittanceHubScreenState extends State<CrossBorderRemittanceHubScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Cross Border Remittance Hub'),
        actions: [
