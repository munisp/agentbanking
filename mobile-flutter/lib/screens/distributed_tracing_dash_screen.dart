...
class DistributedTracingDashScreen extends StatefulWidget {
  const DistributedTracingDashScreen({super.key});
  @override
  State<DistributedTracingDashScreen> createState() => _DistributedTracingDashScreenState();
}

class _DistributedTracingDashScreenState extends State<DistributedTracingDashScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Distributed Tracing Dash'),
        actions: [
