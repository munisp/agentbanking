        ...
        renderItem={({ item }) => (
          <TouchableOpacity style={styles.card}>
            <View style={styles.cardHeader}>
              <Text style={styles.cardTitle}>{item.operationType}</Text>
              <Text style={styles.cardBadge}>{item.processed}</Text>
            </View>
            <Text style={styles.cardSubtitle}>{item.totalRecords}</Text>
            <Text style={styles.cardMeta}>{item.failed}</Text>
          </TouchableOpacity>
        )}
      />
    </View>
