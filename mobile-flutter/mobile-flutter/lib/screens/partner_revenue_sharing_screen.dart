...
class PartnerRevenueSharingScreen extends StatefulWidget {
  const PartnerRevenueSharingScreen({super.key});
  @override
  State<PartnerRevenueSharingScreen> createState() => _PartnerRevenueSharingScreenState();
}

class _PartnerRevenueSharingScreenState extends State<PartnerRevenueSharingScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Partner Revenue Sharing'),
        actions: [
