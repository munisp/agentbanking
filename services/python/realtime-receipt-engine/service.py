...
RECEIPT_TEMPLATES = {
    "en": {
        ...
        "status_label": "Status",
        "success": "SUCCESSFUL",
        "footer": "Thank you for using 54link Agency Banking",
    },
    "ha": {
        ...
        "footer": "Na gode da amfani da 54link",
    },
    "yo": {
        "header": "IWE IṢOWO",
        ...
        async with httpx.AsyncClient(timeout=10.0) as client:
            response = await client.post(
                ...
                json={
                    ...
                    "from": {"email": "receipts@54link.com", "name": "54link Agency Banking"},
