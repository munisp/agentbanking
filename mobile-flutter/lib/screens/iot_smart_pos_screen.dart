...
class IotSmartPosScreen extends ConsumerStatefulWidget {
  const IotSmartPosScreen({super.key});

  @override
  ConsumerState<IotSmartPosScreen> createState() => _IotSmartPosScreenState();
}

class _IotSmartPosScreenState extends ConsumerState<IotSmartPosScreen> {
  ...
  Future<void> _loadData() async {
    ...
    try {
      ...
      final statsResp = await api.get('/api/trpc/iot_pos.getStats');
      final listResp = await api.get('/api/trpc/iot_pos.list?input={"limit":20,"offset":0}');
      setState(() {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('IoT Smart POS'),
        actions: [
          IconButton(
