...
export default function TransactionReversalScreen() {
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.headerTitle}>Transaction Reversal</Text>
        ...
        renderItem={({ item }) => (
          <TouchableOpacity style={styles.card}>
            <View style={styles.cardHeader}>
              <Text style={styles.cardTitle}>{item.originalRef}</Text>
              <Text style={styles.cardBadge}>{item.amount}</Text>
            </View>
            <Text style={styles.cardSubtitle}>{item.reversalRef}</Text>
