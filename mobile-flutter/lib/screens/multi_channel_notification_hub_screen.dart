...
class MultiChannelNotificationHubScreen extends StatefulWidget {
  const MultiChannelNotificationHubScreen({super.key});
  @override
  State<MultiChannelNotificationHubScreen> createState() => _MultiChannelNotificationHubScreenState();
}

class _MultiChannelNotificationHubScreenState extends State<MultiChannelNotificationHubScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Multi Channel Notification Hub'),
        actions: [
