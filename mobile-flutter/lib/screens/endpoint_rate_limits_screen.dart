...
class EndpointRateLimitsScreen extends StatefulWidget {
  const EndpointRateLimitsScreen({super.key});
  @override
  State<EndpointRateLimitsScreen> createState() => _EndpointRateLimitsScreenState();
}

class _EndpointRateLimitsScreenState extends State<EndpointRateLimitsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Endpoint Rate Limits'),
        actions: [
