...
class ResilienceMonitorScreen extends StatefulWidget {
  const ResilienceMonitorScreen({super.key});
  @override
  State<ResilienceMonitorScreen> createState() => _ResilienceMonitorScreenState();
}

class _ResilienceMonitorScreenState extends State<ResilienceMonitorScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Resilience Monitor'),
        actions: [
