...
class QdrantVectorSearchScreen extends StatefulWidget {
  const QdrantVectorSearchScreen({super.key});
  @override
  State<QdrantVectorSearchScreen> createState() => _QdrantVectorSearchScreenState();
}

class _QdrantVectorSearchScreenState extends State<QdrantVectorSearchScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Qdrant Vector Search'),
        actions: [
