...
class WhatsAppChannelScreen extends StatefulWidget {
  const WhatsAppChannelScreen({super.key});
  @override
  State<WhatsAppChannelScreen> createState() => _WhatsAppChannelScreenState();
}

class _WhatsAppChannelScreenState extends State<WhatsAppChannelScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Whats App Channel'),
        actions: [
