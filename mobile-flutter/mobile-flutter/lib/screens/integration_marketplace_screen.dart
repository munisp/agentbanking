...
class IntegrationMarketplaceScreen extends StatefulWidget {
  const IntegrationMarketplaceScreen({super.key});
  @override
  State<IntegrationMarketplaceScreen> createState() => _IntegrationMarketplaceScreenState();
}

class _IntegrationMarketplaceScreenState extends State<IntegrationMarketplaceScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Integration Marketplace'),
        actions: [
