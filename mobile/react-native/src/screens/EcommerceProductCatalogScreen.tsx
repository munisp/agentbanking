...
export default function EcommerceProductCatalogScreen() {
  ...
  const fetchData = async () => {
    try {
      setError(null);
      const res = await fetch(`${API_BASE}/api/trpc/ecommerceProductCatalog.list`);
  ...
  return (
    ...
    >
      <View style={styles.header}>
        <Text style={styles.title}>Ecommerce Product Catalog</Text>
