...
export default function MerchantOnboardingPortalScreen() {
  ...
  const fetchData = async () => {
    try {
      setError(null);
      const res = await fetch(`${API_BASE}/api/trpc/merchantOnboardingPortal.list`);
  ...
  return (
    ...
    >
      <View style={styles.header}>
        <Text style={styles.title}>Merchant Onboarding Portal</Text>
