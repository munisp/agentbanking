...
const AutomatedSettlementSchedulerScreen: React.FC = () => {
  ...
  const load = useCallback(async () => {
    try {
      setError('');
      const { data } = await apiClient.get('/settlement/list?page=1&limit=50');
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.header}>Automated Settlement Scheduler</Text>
...
export default AutomatedSettlementSchedulerScreen;
