...
class ComplianceTrainingTrackerScreen extends StatefulWidget {
  const ComplianceTrainingTrackerScreen({super.key});
  @override
  State<ComplianceTrainingTrackerScreen> createState() => _ComplianceTrainingTrackerScreenState();
}

class _ComplianceTrainingTrackerScreenState extends State<ComplianceTrainingTrackerScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Compliance Training Tracker'),
        actions: [
