...
class WebSocketServiceScreen extends StatefulWidget {
  const WebSocketServiceScreen({super.key});
  @override
  State<WebSocketServiceScreen> createState() => _WebSocketServiceScreenState();
}

class _WebSocketServiceScreenState extends State<WebSocketServiceScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Web Socket Service'),
        actions: [
