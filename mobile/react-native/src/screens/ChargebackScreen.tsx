...
export default function ChargebackScreen() {
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.headerTitle}>Chargebacks</Text>
        ...
        renderItem={({ item }) => (
          <TouchableOpacity style={styles.card}>
            <View style={styles.cardHeader}>
              <Text style={styles.cardTitle}>{item.chargebackRef}</Text>
              <Text style={styles.cardBadge}>{item.reason}</Text>
            </View>
            <Text style={styles.cardSubtitle}>{item.amount}</Text>
            <Text style={styles.cardMeta}>{item.deadline}</Text>
          </TouchableOpacity>
        )}
      />
    </View>
