...
class PlatformFeatureFlagsScreen extends StatefulWidget {
  const PlatformFeatureFlagsScreen({super.key});
  @override
  State<PlatformFeatureFlagsScreen> createState() => _PlatformFeatureFlagsScreenState();
}

class _PlatformFeatureFlagsScreenState extends State<PlatformFeatureFlagsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Platform Feature Flags'),
        actions: [
