...
class E2ETestFrameworkScreen extends StatefulWidget {
  const E2ETestFrameworkScreen({super.key});
  @override
  State<E2ETestFrameworkScreen> createState() => _E2ETestFrameworkScreenState();
}

class _E2ETestFrameworkScreenState extends State<E2ETestFrameworkScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('E2 E Test Framework'),
        actions: [
