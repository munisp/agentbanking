...
export default function AIMonitoringDashboardScreen() {
  ...
  const fetchData = async () => {
    try {
      setError(null);
      const res = await fetch(`${API_BASE}/api/trpc/aIMonitoringDashboard.list`);
  ...
  return (
    ...
    >
      <View style={styles.header}>
        <Text style={styles.title}>A I Monitoring Dashboard</Text>
