...
class BulkTransactionProcessorScreen extends StatefulWidget {
  const BulkTransactionProcessorScreen({super.key});
  @override
  State<BulkTransactionProcessorScreen> createState() => _BulkTransactionProcessorScreenState();
}

class _BulkTransactionProcessorScreenState extends State<BulkTransactionProcessorScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Bulk Transaction Processor'),
        actions: [
