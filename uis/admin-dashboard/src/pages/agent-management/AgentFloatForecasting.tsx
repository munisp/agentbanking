...
export default function AgentFloatForecasting() {
  ...
  const agents = (forecast.data as any)?.forecasts ?? MOCK_AGENTS;
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                ₦{((stats.data as any)?.totalFloat ?? 2450000000).toLocaleString()}
              </div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold text-red-500">
                {(stats.data as any)?.stockoutRisk ?? 47}
              </div>
              <p className="text-xs text-muted-foreground">
                of {(stats.data as any)?.agentsMonitored ?? 1250} active agents
              </p>
            </CardContent>
          </Card>
          <Card>
        ...
        <Card>
          <CardHeader>
            <div className="flex items-center justify-between">
              ...
              <Button
                onClick={() => triggerReplenishment.mutate()}
