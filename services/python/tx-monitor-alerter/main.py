...
if _otel_endpoint:
    try:
        ...
        _resource = Resource.create({
            "service.name": os.environ.get("OTEL_SERVICE_NAME", "tx-monitor-alerter"),
...
DATABASE_URL = os.environ.get("DATABASE_URL", "postgres://postgres:postgres@localhost:5432/tx_monitor_alerter")
...
async def startup_event():
    ...
    await publish_kafka("tx.monitor.alerter.started", {
        "service": "tx-monitor-alerter",
