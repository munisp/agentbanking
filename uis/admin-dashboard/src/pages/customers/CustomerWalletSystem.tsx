...
export default function CustomerWalletSystem() {
  ...
  const summary = trpc.customerWalletSystem.getStats.useQuery()?.data as
      ...
      <div className="space-y-6 p-6">
        <div className="flex items-center justify-between flex-wrap gap-4">
          <div>
            ...
            <p className="text-muted-foreground">
              Digital wallet management, balance tracking, and wallet-to-wallet
              transfers
            </p>
          </div>
          <div className="flex gap-2 flex-wrap">
            ...
            <Button
              variant="outline"
              onClick={() => toast.success("Freeze initiated")}
            >
              Freeze
            </Button>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <Card key="0">
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {(summary?.totalWallets ?? 0).toLocaleString()}
              </div>
            </CardContent>
          </Card>
          <Card key="1">
          ...
          <Card key="2">
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {(summary?.activeWallets ?? 0).toLocaleString()}
              </div>
            </CardContent>
          </Card>
          <Card key="3">
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {(summary?.transfersToday ?? 0).toLocaleString()}
              </div>
            </CardContent>
          </Card>
        </div>
