...
func init() {
	...
	samples := []DeviceCompliance{
		{DeviceID: "DEV-001", AgentCode: "54agent-001", OSVersion: "Android 14", AppVersion: "5.2.1", SecurityPatch: "2025-11-01", EncryptionOn: true, RootDetected: false},
		{DeviceID: "DEV-002", AgentCode: "54agent-002", OSVersion: "Android 13", AppVersion: "5.1.0", SecurityPatch: "2025-09-01", EncryptionOn: true, RootDetected: false},
		{DeviceID: "DEV-003", AgentCode: "54agent-003", OSVersion: "Android 12", AppVersion: "4.8.0", SecurityPatch: "2024-06-01", EncryptionOn: false, RootDetected: true},
	}
	for i := range samples {
