...
const FEATURES = ["ECOWAS corridors", "FX rate quotes", "Send remittance", "Transfer history"];

export default function CrossBorderRemittanceScreen() {
