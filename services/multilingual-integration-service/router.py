...
The real implementation lives in the standalone service (services/multilingual-integration-service/).
...
_UNAVAILABLE = (
    "multilingual-integration-service endpoints are not served by this gateway router. "
    "Use the standalone multilingual-integration-service service."
)
...
async def health_check():
    return JSONResponse(
        status_code=503,
        content={"status": "unavailable", "service": "multilingual-integration-service", "detail": _UNAVAILABLE},
    )
