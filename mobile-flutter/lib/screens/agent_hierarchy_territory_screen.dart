...
class AgentHierarchyTerritoryScreen extends StatefulWidget {
  const AgentHierarchyTerritoryScreen({super.key});
  @override
  State<AgentHierarchyTerritoryScreen> createState() => _AgentHierarchyTerritoryScreenState();
}

class _AgentHierarchyTerritoryScreenState extends State<AgentHierarchyTerritoryScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Agent Hierarchy Territory'),
        actions: [
