...
const AgentPerformanceLeaderboardScreen: React.FC = () => {
  ...
  const load = useCallback(async () => {
    try {
      setError('');
      const { data } = await apiClient.get('/agent/list?page=1&limit=50');
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.header}>Agent Performance Leaderboard</Text>
...
export default AgentPerformanceLeaderboardScreen;
