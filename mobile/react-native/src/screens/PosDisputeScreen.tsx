...
export default function PosDisputeScreen() {
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.headerTitle}>POS Disputes</Text>
        ...
        renderItem={({ item }) => (
          <TouchableOpacity style={styles.card}>
            <View style={styles.cardHeader}>
              <Text style={styles.cardTitle}>{item.disputeRef}</Text>
              <Text style={styles.cardBadge}>{item.amount}</Text>
            </View>
            <Text style={styles.cardSubtitle}>{item.transactionRef}</Text>
