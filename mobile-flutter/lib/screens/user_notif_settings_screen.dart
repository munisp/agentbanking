...
class UserNotifSettingsScreen extends StatefulWidget {
  const UserNotifSettingsScreen({super.key});
  @override
  State<UserNotifSettingsScreen> createState() => _UserNotifSettingsScreenState();
}

class _UserNotifSettingsScreenState extends State<UserNotifSettingsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('User Notif Settings'),
        actions: [
