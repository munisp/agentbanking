...
export default function POSFirmwareOTAScreen() {
  ...
  const fetchData = async () => {
    try {
      setError(null);
      const res = await fetch(`${API_BASE}/api/trpc/pOSFirmwareOTA.list`);
  ...
  return (
    ...
    >
      <View style={styles.header}>
        <Text style={styles.title}>P O S Firmware O T A</Text>
