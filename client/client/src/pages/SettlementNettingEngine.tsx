...
export default function SettlementNettingEngine() {
  ...
  const summary = trpc.settlementNettingEngine.getStats.useQuery()?.data as
    | Record<string, unknown>
    | undefined;
  const listQ = trpc.settlementNettingEngine.listSessions.useQuery({
    limit: 20,
  });
      ...
      <div className="space-y-6 p-6">
        <div className="flex items-center justify-between flex-wrap gap-4">
          <div>
            ...
            <p className="text-muted-foreground">
              Bilateral netting, settlement batches, and reconciliation
              management
            </p>
          </div>
          <div className="flex gap-2 flex-wrap">
            <Button onClick={() => toast.success("Run Netting initiated")}>
              Run Netting
            </Button>
            <Button
              variant="outline"
              onClick={() => toast.success("Reconcile initiated")}
            >
              Reconcile
            </Button>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <Card key="1">
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {formatCurrency(summary?.netSettled)}
              </div>
            </CardContent>
          </Card>
          <Card key="2">
          ...
          <Card key="3">
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {formatCurrency(summary?.savingsFromNetting)}
              </div>
            </CardContent>
          </Card>
        </div>
