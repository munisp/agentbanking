...
const TransactionReceiptGeneratorScreen: React.FC = () => {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.header}>Transaction Receipt Generator</Text>
...
export default TransactionReceiptGeneratorScreen;
