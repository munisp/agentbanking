...
class PlatformChangelogScreen extends StatefulWidget {
  const PlatformChangelogScreen({super.key});
  @override
  State<PlatformChangelogScreen> createState() => _PlatformChangelogScreenState();
}

class _PlatformChangelogScreenState extends State<PlatformChangelogScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Platform Changelog'),
        actions: [
