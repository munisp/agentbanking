"""
MinIO / S3-Compatible Storage for 54agent Lakehouse
...
MINIO_ACCESS_KEY = os.getenv("MINIO_ACCESS_KEY", "54agent-lakehouse")
MINIO_SECRET_KEY = os.getenv("MINIO_SECRET_KEY", "54agent-lakehouse-secret-2026")
MINIO_REGION    = os.getenv("MINIO_REGION",      "us-east-1")

# Bucket per data layer
BUCKETS = {
    "bronze":   "54agent-bronze",
    "silver":   "54agent-silver",
    "gold":     "54agent-gold",
    "platinum": "54agent-platinum",
}
    ...
    def upload_parquet(
        ...
        self.client.put_object(
            ...
            Metadata={
                ...
                "platform": "54agent-agency-banking",
            },
        )
