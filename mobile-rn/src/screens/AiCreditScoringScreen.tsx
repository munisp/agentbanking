...
export default function AiCreditScoringScreen() {
  ...
  if (loading) {
    return (
      <View style={styles.center}>
        ...
        <Text style={styles.loadingText}>Loading AI Credit Scoring...</Text>
      </View>
    );
  }
  ...
  return (
    ...
    >
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.subtitle}>ML-powered credit scores and risk assessment</Text>
      </View>
