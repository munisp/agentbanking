...
class PlatformCapacityPlannerScreen extends StatefulWidget {
  const PlatformCapacityPlannerScreen({super.key});
  @override
  State<PlatformCapacityPlannerScreen> createState() => _PlatformCapacityPlannerScreenState();
}

class _PlatformCapacityPlannerScreenState extends State<PlatformCapacityPlannerScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Platform Capacity Planner'),
        actions: [
