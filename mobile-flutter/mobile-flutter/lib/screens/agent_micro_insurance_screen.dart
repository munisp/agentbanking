...
class AgentMicroInsuranceScreen extends StatefulWidget {
  const AgentMicroInsuranceScreen({super.key});
  @override
  State<AgentMicroInsuranceScreen> createState() => _AgentMicroInsuranceScreenState();
}

class _AgentMicroInsuranceScreenState extends State<AgentMicroInsuranceScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Agent Micro Insurance'),
        actions: [
