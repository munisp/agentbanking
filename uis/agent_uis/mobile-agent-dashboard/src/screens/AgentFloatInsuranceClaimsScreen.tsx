...
const AgentFloatInsuranceClaimsScreen: React.FC = () => {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.header}>Agent Float Insurance Claims</Text>
...
export default AgentFloatInsuranceClaimsScreen;
