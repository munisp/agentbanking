...
export default function RevenueForecastingEngine() {
  ...
  const summary = trpc.revenueForecastingEngine.getSummary.useQuery()?.data as
    | Record<string, unknown>
    | undefined;
  const listQ = trpc.revenueForecastingEngine.list.useQuery({
    limit: 20,
    offset: page * 20,
        ...
        <div className="flex items-center justify-between flex-wrap gap-4">
          <div>
            ...
            <p className="text-muted-foreground">
              Revenue projections, scenario modeling, and budget vs actual
              tracking
            </p>
          </div>
          <div className="flex gap-2 flex-wrap">
            ...
            <Button
              variant="outline"
              onClick={() => toast.success("Create Scenario initiated")}
            >
              Create Scenario
            </Button>
          </div>
