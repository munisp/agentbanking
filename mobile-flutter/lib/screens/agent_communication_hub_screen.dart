...
class AgentCommunicationHubScreen extends StatefulWidget {
  const AgentCommunicationHubScreen({super.key});
  @override
  State<AgentCommunicationHubScreen> createState() => _AgentCommunicationHubScreenState();
}

class _AgentCommunicationHubScreenState extends State<AgentCommunicationHubScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Agent Communication Hub'),
        actions: [
