...
const CustomerOnboardingPipelineScreen: React.FC = () => {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.header}>Customer Onboarding Pipeline</Text>
...
export default CustomerOnboardingPipelineScreen;
