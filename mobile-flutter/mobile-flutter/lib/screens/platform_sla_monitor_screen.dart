...
class PlatformSlaMonitorScreen extends StatefulWidget {
  const PlatformSlaMonitorScreen({super.key});
  @override
  State<PlatformSlaMonitorScreen> createState() => _PlatformSlaMonitorScreenState();
}

class _PlatformSlaMonitorScreenState extends State<PlatformSlaMonitorScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Platform Sla Monitor'),
        actions: [
