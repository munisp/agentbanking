...
class NfcTapToPayScreen extends ConsumerStatefulWidget {
  const NfcTapToPayScreen({super.key});

  @override
  ConsumerState<NfcTapToPayScreen> createState() => _NfcTapToPayScreenState();
}

class _NfcTapToPayScreenState extends ConsumerState<NfcTapToPayScreen> {
  ...
  Future<void> _loadData() async {
    ...
    try {
      ...
      final statsResp = await api.get('/api/trpc/nfc_tap_to_pay.getStats');
      final listResp = await api.get('/api/trpc/nfc_tap_to_pay.list?input={"limit":20,"offset":0}');
      setState(() {
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                'NFC terminal and contactless payments',
