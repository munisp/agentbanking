...
class MerchantAcquirerGatewayScreen extends StatefulWidget {
  const MerchantAcquirerGatewayScreen({super.key});
  @override
  State<MerchantAcquirerGatewayScreen> createState() => _MerchantAcquirerGatewayScreenState();
}

class _MerchantAcquirerGatewayScreenState extends State<MerchantAcquirerGatewayScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Merchant Acquirer Gateway'),
        actions: [
