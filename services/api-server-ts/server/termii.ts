...
/**
 * termii.ts — Shared Termii SMS helper for the 54agent platform.
 *
...
export function buildConfirmationSms(data: {
  ...
  lines.push(`Time: ${ts}`);
  lines.push(`To dispute, call 0700-54agent or reply DISPUTE to this number.`);
  return lines.join("\n");
}
