...
class TrainingCertificationScreen extends StatefulWidget {
  const TrainingCertificationScreen({super.key});
  @override
  State<TrainingCertificationScreen> createState() => _TrainingCertificationScreenState();
}

class _TrainingCertificationScreenState extends State<TrainingCertificationScreen> {
