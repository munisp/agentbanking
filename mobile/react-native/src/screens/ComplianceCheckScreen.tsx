...
/** CBN regulatory checks and filings */
        ...
        renderItem={({ item }) => (
          <TouchableOpacity style={styles.card}>
            <View style={styles.cardHeader}>
              <Text style={styles.cardTitle}>{item.checkType}</Text>
              <Text style={styles.cardBadge}>{item.dueDate}</Text>
            </View>
            <Text style={styles.cardSubtitle}>{item.status}</Text>
            <Text style={styles.cardMeta}>{item.filingRef}</Text>
          </TouchableOpacity>
        )}
      />
    </View>
