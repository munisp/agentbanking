...
class PlatformMaturityScorecardScreen extends StatefulWidget {
  const PlatformMaturityScorecardScreen({super.key});
  @override
  State<PlatformMaturityScorecardScreen> createState() => _PlatformMaturityScorecardScreenState();
}

class _PlatformMaturityScorecardScreenState extends State<PlatformMaturityScorecardScreen> {
  ...
  Future<void> _load() async {
    try {
      final result = await ApiService.instance.get('/cards/list', queryParams: {'page': '1', 'limit': '50'});
      setState(() {
        _data = result ?? {};
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Platform Maturity Scorecard'),
        actions: [
