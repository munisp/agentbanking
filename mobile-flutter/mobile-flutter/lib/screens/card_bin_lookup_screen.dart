...
class CardBinLookupScreen extends StatefulWidget {
  const CardBinLookupScreen({super.key});
  @override
  State<CardBinLookupScreen> createState() => _CardBinLookupScreenState();
}

class _CardBinLookupScreenState extends State<CardBinLookupScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Card Bin Lookup'),
        actions: [
