...
class AgentGeoFencingScreen extends StatefulWidget {
  const AgentGeoFencingScreen({super.key});
  @override
  State<AgentGeoFencingScreen> createState() => _AgentGeoFencingScreenState();
}

class _AgentGeoFencingScreenState extends State<AgentGeoFencingScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Agent Geo Fencing'),
        actions: [
