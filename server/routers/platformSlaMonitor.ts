...
async function publishplatformSlaMonitorMiddleware(
  action: string,
  ref: string,
  ...
  create: protectedProcedure
    ...
    .mutation(async ({ input, ctx }) => {
      ...
      try {
        ...
        await publishplatformSlaMonitorMiddleware("create", `${Date.now()}`, {
          action: "create",
        }).catch(() => {});
  ...
  delete: protectedProcedure
    ...
    .mutation(async ({ input }) => {
      try {
        ...
        // Middleware fan-out (fail-open)
        await publishplatformSlaMonitorMiddleware("delete", `${Date.now()}`, {
          action: "delete",
        }).catch(() => {});
