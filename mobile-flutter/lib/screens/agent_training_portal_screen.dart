...
class AgentTrainingPortalScreen extends StatefulWidget {
  const AgentTrainingPortalScreen({super.key});
  @override
  State<AgentTrainingPortalScreen> createState() => _AgentTrainingPortalScreenState();
}

class _AgentTrainingPortalScreenState extends State<AgentTrainingPortalScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Agent Training Portal'),
        actions: [
