...
class AiCashFlowPredictorScreen extends StatefulWidget {
  const AiCashFlowPredictorScreen({super.key});
  @override
  State<AiCashFlowPredictorScreen> createState() => _AiCashFlowPredictorScreenState();
}

class _AiCashFlowPredictorScreenState extends State<AiCashFlowPredictorScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Ai Cash Flow Predictor'),
        actions: [
