...
export default function TransactionEnrichmentServiceScreen() {
  ...
  const fetchData = async () => {
    try {
      setError(null);
      const res = await fetch(`${API_BASE}/api/trpc/transactionEnrichmentService.list`);
  ...
  return (
    ...
    >
      <View style={styles.header}>
        <Text style={styles.title}>Transaction Enrichment Service</Text>
