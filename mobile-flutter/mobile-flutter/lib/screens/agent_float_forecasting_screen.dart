...
class AgentFloatForecastingScreen extends StatefulWidget {
  const AgentFloatForecastingScreen({super.key});
  @override
  State<AgentFloatForecastingScreen> createState() => _AgentFloatForecastingScreenState();
}

class _AgentFloatForecastingScreenState extends State<AgentFloatForecastingScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Agent Float Forecasting'),
        actions: [
