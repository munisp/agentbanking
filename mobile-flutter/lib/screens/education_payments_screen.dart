...
class _EducationPaymentsScreenState extends ConsumerState<EducationPaymentsScreen> {
  ...
  Future<void> _loadData() async {
    ...
    try {
      ...
      final statsResp = await api.get('/api/trpc/education.getStats');
      final listResp = await api.get('/api/trpc/education.list?input={"limit":20,"offset":0}');
      setState(() {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Education Payments'),
        actions: [
          IconButton(
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                'School fees and exam registration',
