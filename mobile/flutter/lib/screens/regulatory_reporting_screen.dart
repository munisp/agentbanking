...
/// CBN regulatory reports and filings
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return Card(
            ...
            child: ListTile(
              title: Text(item['reportType']?.toString() ?? 'N/A'),
              subtitle: Text(item['period']?.toString() ?? ''),
              trailing: Text(item['filingDeadline']?.toString() ?? '', style: const TextStyle(fontWeight: FontWeight.bold)),
            ),
          );
        },
      ),
