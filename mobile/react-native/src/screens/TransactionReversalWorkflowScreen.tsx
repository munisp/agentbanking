...
export default function TransactionReversalWorkflowScreen() {
  ...
  const fetchData = async () => {
    try {
      setError(null);
      const res = await fetch(`${API_BASE}/api/trpc/transactionReversalWorkflow.list`);
  ...
  return (
    ...
    >
      <View style={styles.header}>
        <Text style={styles.title}>Transaction Reversal Workflow</Text>
