...
class ComplianceChatbotScreen extends StatefulWidget {
  const ComplianceChatbotScreen({super.key});
  @override
  State<ComplianceChatbotScreen> createState() => _ComplianceChatbotScreenState();
}

class _ComplianceChatbotScreenState extends State<ComplianceChatbotScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Compliance Chatbot'),
        actions: [
