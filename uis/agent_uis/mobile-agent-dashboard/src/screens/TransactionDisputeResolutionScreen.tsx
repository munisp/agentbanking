...
const TransactionDisputeResolutionScreen: React.FC = () => {
  ...
  const load = useCallback(async () => {
    try {
      setError('');
      const { data } = await apiClient.get('/transactions/list?page=1&limit=50');
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.header}>Transaction Dispute Resolution</Text>
...
export default TransactionDisputeResolutionScreen;
