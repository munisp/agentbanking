...
async function publishplatformFeatureFlagsMiddleware(
  action: string,
  ref: string,
  ...
  create: protectedProcedure
    ...
    .mutation(async ({ input, ctx }) => {
      ...
      try {
        ...
        await publishplatformFeatureFlagsMiddleware("create", `${Date.now()}`, {
          action: "create",
        }).catch(() => {});
  ...
  delete: protectedProcedure
    ...
    .mutation(async ({ input }) => {
      try {
        ...
        // Middleware fan-out (fail-open)
        await publishplatformFeatureFlagsMiddleware("delete", `${Date.now()}`, {
          action: "delete",
        }).catch(() => {});
