...
class Customer360ViewScreen extends StatefulWidget {
  const Customer360ViewScreen({super.key});
  @override
  State<Customer360ViewScreen> createState() => _Customer360ViewScreenState();
}

class _Customer360ViewScreenState extends State<Customer360ViewScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Customer360 View'),
        actions: [
