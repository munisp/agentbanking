...
class DataExportHubScreen extends StatefulWidget {
  const DataExportHubScreen({super.key});
  @override
  State<DataExportHubScreen> createState() => _DataExportHubScreenState();
}

class _DataExportHubScreenState extends State<DataExportHubScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Data Export Hub'),
        actions: [
