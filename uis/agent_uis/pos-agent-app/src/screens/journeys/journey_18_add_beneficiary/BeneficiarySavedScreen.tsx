...
const makeStyles = (colors: any) => StyleSheet.create({
  ...
  primaryButton: { backgroundColor: colors.primary, padding: 16, borderRadius: 14, alignItems: 'center', marginTop: 24 },
  ...
  amountBtnSelected: { borderColor: colors.primary, backgroundColor: '#EBF3FF' },
  amountBtnText: { fontSize: 15, fontWeight: '600', color: '#3C3C43' },
  amountBtnTextSelected: { color: colors.primary },
  ...
  tenureBtnSelected: { borderColor: colors.primary, backgroundColor: '#EBF3FF' },
  tenureBtnText: { fontSize: 14, fontWeight: '600', color: '#3C3C43' },
  tenureBtnTextSelected: { color: colors.primary },

});

export default BeneficiarySavedScreen;
