...
class AgentFloatInsuranceClaimsScreen extends StatefulWidget {
  const AgentFloatInsuranceClaimsScreen({super.key});
  @override
  State<AgentFloatInsuranceClaimsScreen> createState() => _AgentFloatInsuranceClaimsScreenState();
}

class _AgentFloatInsuranceClaimsScreenState extends State<AgentFloatInsuranceClaimsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Agent Float Insurance Claims'),
        actions: [
