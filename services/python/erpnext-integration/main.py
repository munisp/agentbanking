...
if _otel_endpoint:
    try:
        ...
        _resource = Resource.create({
            "service.name": os.environ.get("OTEL_SERVICE_NAME", "erpnext-integration"),
...
DATABASE_URL = os.environ.get("DATABASE_URL", "postgres://postgres:postgres@localhost:5432/erpnext_integration")
...
async def startup_event():
    ...
    await publish_kafka("erpnext.integration.started", {
