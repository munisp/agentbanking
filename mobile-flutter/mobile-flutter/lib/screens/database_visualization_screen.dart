...
class DatabaseVisualizationScreen extends StatefulWidget {
  const DatabaseVisualizationScreen({super.key});
  @override
  State<DatabaseVisualizationScreen> createState() => _DatabaseVisualizationScreenState();
}

class _DatabaseVisualizationScreenState extends State<DatabaseVisualizationScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Database Visualization'),
        actions: [
