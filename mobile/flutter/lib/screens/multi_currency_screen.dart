      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return Card(
            ...
            child: ListTile(
              title: Text(item['fromCurrency']?.toString() ?? 'N/A'),
              subtitle: Text(item['toCurrency']?.toString() ?? ''),
              trailing: Text(item['rate']?.toString() ?? '', style: const TextStyle(fontWeight: FontWeight.bold)),
            ),
          );
        },
      ),
