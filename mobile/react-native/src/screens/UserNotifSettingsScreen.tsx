...
export default function UserNotifSettingsScreen() {
  ...
  const fetchData = async () => {
    try {
      setError(null);
      const res = await fetch(`${API_BASE}/api/trpc/userNotifSettings.list`);
  ...
  return (
    ...
    >
      <View style={styles.header}>
        <Text style={styles.title}>User Notif Settings</Text>
