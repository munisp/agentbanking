...
const EcommerceMerchantStorefrontScreen: React.FC = () => {
  ...
  const load = useCallback(async () => {
    try {
      setError('');
      const { data } = await apiClient.get('/merchants/list?page=1&limit=50');
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.header}>Ecommerce Merchant Storefront</Text>
...
export default EcommerceMerchantStorefrontScreen;
