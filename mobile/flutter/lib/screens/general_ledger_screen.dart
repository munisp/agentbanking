      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return Card(
            ...
            child: ListTile(
              title: Text(item['accountCode']?.toString() ?? 'N/A'),
              subtitle: Text(item['debit']?.toString() ?? ''),
              trailing: Text(item['credit']?.toString() ?? '', style: const TextStyle(fontWeight: FontWeight.bold)),
            ),
          );
        },
      ),
