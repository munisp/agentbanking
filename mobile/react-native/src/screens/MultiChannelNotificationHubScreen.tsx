...
export default function MultiChannelNotificationHubScreen() {
  ...
  const fetchData = async () => {
    try {
      setError(null);
      const res = await fetch(`${API_BASE}/api/trpc/multiChannelNotificationHub.list`);
  ...
  return (
    ...
    >
      <View style={styles.header}>
        <Text style={styles.title}>Multi Channel Notification Hub</Text>
