...
class BiometricAuthGatewayScreen extends StatefulWidget {
  const BiometricAuthGatewayScreen({super.key});
  @override
  State<BiometricAuthGatewayScreen> createState() => _BiometricAuthGatewayScreenState();
}

class _BiometricAuthGatewayScreenState extends State<BiometricAuthGatewayScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Biometric Auth Gateway'),
        actions: [
