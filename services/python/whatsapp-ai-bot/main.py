...
user_sessions_cache = {}  # PG-backed via pg_get_dict("whatsapp-ai-bot", "user_sessions")

# Conversation history
conversation_history_cache = {}  # PG-backed via pg_get_dict("whatsapp-ai-bot", "conversation_history")
