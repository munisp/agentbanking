...
export default function AgentLoanAdvance() {
  ...
  const summary = trpc.agentLoanAdvance.getSummary.useQuery()?.data as
    | Record<string, unknown>
    | undefined;
  const listQ = trpc.agentLoanAdvance.list.useQuery({
    limit: 20,
    offset: page * 20,
      ...
      <div className="space-y-6 p-6">
        <div className="flex items-center justify-between flex-wrap gap-4">
          ...
          <div className="flex gap-2 flex-wrap">
            <Button onClick={() => toast.success("New Advance initiated")}>
              New Advance
            </Button>
            <Button
              variant="outline"
