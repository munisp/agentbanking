...
class CustomerFeedbackNpsScreen extends StatefulWidget {
  const CustomerFeedbackNpsScreen({super.key});
  @override
  State<CustomerFeedbackNpsScreen> createState() => _CustomerFeedbackNpsScreenState();
}

class _CustomerFeedbackNpsScreenState extends State<CustomerFeedbackNpsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Customer Feedback Nps'),
        actions: [
