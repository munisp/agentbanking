...
/** Real-time fraud alerts and suspicious transactions */
        ...
        renderItem={({ item }) => (
          <TouchableOpacity style={styles.card}>
            <View style={styles.cardHeader}>
              <Text style={styles.cardTitle}>{item.alertType}</Text>
              <Text style={styles.cardBadge}>{item.transactionRef}</Text>
            </View>
            <Text style={styles.cardSubtitle}>{item.severity}</Text>
            <Text style={styles.cardMeta}>{item.riskScore}</Text>
          </TouchableOpacity>
        )}
      />
    </View>
