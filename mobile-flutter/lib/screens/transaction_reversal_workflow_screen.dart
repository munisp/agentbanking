...
class TransactionReversalWorkflowScreen extends StatefulWidget {
  const TransactionReversalWorkflowScreen({super.key});
  @override
  State<TransactionReversalWorkflowScreen> createState() => _TransactionReversalWorkflowScreenState();
}

class _TransactionReversalWorkflowScreenState extends State<TransactionReversalWorkflowScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Transaction Reversal Workflow'),
        actions: [
