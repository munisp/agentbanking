...
class WhiteLabelApprovalScreen extends StatefulWidget {
  const WhiteLabelApprovalScreen({super.key});
  @override
  State<WhiteLabelApprovalScreen> createState() => _WhiteLabelApprovalScreenState();
}

class _WhiteLabelApprovalScreenState extends State<WhiteLabelApprovalScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('White Label Approval'),
        actions: [
