...
export default function ChaosEngineeringConsoleScreen() {
  ...
  const fetchData = async () => {
    try {
      setError(null);
      const res = await fetch(`${API_BASE}/api/trpc/chaosEngineeringConsole.list`);
  ...
  return (
    ...
    >
      <View style={styles.header}>
        <Text style={styles.title}>Chaos Engineering Console</Text>
