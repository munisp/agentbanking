...
class MerchantKycOnboardingScreen extends StatefulWidget {
  const MerchantKycOnboardingScreen({super.key});
  @override
  State<MerchantKycOnboardingScreen> createState() => _MerchantKycOnboardingScreenState();
}

class _MerchantKycOnboardingScreenState extends State<MerchantKycOnboardingScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Merchant Kyc Onboarding'),
        actions: [
