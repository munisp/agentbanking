...
class PlatformCostAllocatorScreen extends StatefulWidget {
  const PlatformCostAllocatorScreen({super.key});
  @override
  State<PlatformCostAllocatorScreen> createState() => _PlatformCostAllocatorScreenState();
}

class _PlatformCostAllocatorScreenState extends State<PlatformCostAllocatorScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Platform Cost Allocator'),
        actions: [
