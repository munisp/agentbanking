/**
 * 54agent Agency Banking Platform — Merchant Portal
    ...
    >
      <div className="flex flex-col items-center gap-2">
        ...
        <div className="text-sm text-gray-400 text-center max-w-sm">
          ...
          54agent Agency Banking Network.
        </div>
      </div>
      ...
      <div className="text-xs text-gray-600 text-center">
        <Link to="/privacy" className="underline" style={{ color: BLUE }}>
          Privacy Policy
        </Link>
        {" · "}
        <Link to="/hub" className="underline text-gray-500">Back to Hub</Link>
      </div>
    </div>
  );
}
          ...
          <div className="flex flex-col gap-4">
            ...
            >
              ...
              <label htmlFor="agree" className="text-xs text-gray-300">
                ...
                to the{" "}
                <Link to="/privacy" style={{ color: BLUE }} className="underline">
                  Privacy Policy
                </Link>{" "}
                and the 54agent Merchant Terms of Service.
              </label>
            </div>
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ borderColor: BORDER }}
      >
        <Link to="/privacy" className="hover:text-gray-400 transition-colors" style={{ color: BLUE }}>
          Privacy Policy
        </Link>
        <span>·</span>
        <span>© 2026 54agent Agency Banking</span>
      </div>
    </div>
  );
}
