...
export default function UssdAnalyticsDashboardScreen() {
  ...
  const fetchData = async () => {
    try {
      setError(null);
      const res = await fetch(`${API_BASE}/api/trpc/ussdAnalyticsDashboard.list`);
  ...
  return (
    ...
    >
      <View style={styles.header}>
        <Text style={styles.title}>Ussd Analytics Dashboard</Text>
