...
class EscalationChainsScreen extends StatefulWidget {
  const EscalationChainsScreen({super.key});
  @override
  State<EscalationChainsScreen> createState() => _EscalationChainsScreenState();
}

class _EscalationChainsScreenState extends State<EscalationChainsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Escalation Chains'),
        actions: [
