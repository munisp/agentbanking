...
class PaymentLinkGeneratorScreen extends StatefulWidget {
  const PaymentLinkGeneratorScreen({super.key});
  @override
  State<PaymentLinkGeneratorScreen> createState() => _PaymentLinkGeneratorScreenState();
}

class _PaymentLinkGeneratorScreenState extends State<PaymentLinkGeneratorScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Payment Link Generator'),
        actions: [
