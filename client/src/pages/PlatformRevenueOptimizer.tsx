...
export default function PlatformRevenueOptimizer() {
  ...
  const summary = trpc.platformRevenueOptimizer.getStats.useQuery()?.data as
      ...
      <div className="space-y-6 p-6">
        <div className="flex items-center justify-between flex-wrap gap-4">
          <div>
            ...
            <p className="text-muted-foreground">
              Revenue optimization strategies, pricing experiments, and yield
              management
            </p>
          </div>
          <div className="flex gap-2 flex-wrap">
            <Button onClick={() => toast.success("New Strategy initiated")}>
              New Strategy
            </Button>
            <Button
              variant="outline"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <Card key="1">
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {formatCurrency(summary?.optimizedRevenue)}
              </div>
            </CardContent>
          </Card>
          <Card key="2">
          ...
          <Card key="3">
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {(summary?.activeStrategies ?? 0).toLocaleString()}
              </div>
            </CardContent>
          </Card>
        </div>
                      ...
                      {items.map((row: any, idx: number) => (
                        ...
                        >
                          ...
                          <td className="p-3 font-mono">
                            {formatCurrency(row.projectedImpact)}
                          </td>
