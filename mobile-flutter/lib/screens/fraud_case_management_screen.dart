...
class FraudCaseManagementScreen extends StatefulWidget {
  const FraudCaseManagementScreen({super.key});
  @override
  State<FraudCaseManagementScreen> createState() => _FraudCaseManagementScreenState();
}

class _FraudCaseManagementScreenState extends State<FraudCaseManagementScreen> {
  ...
  Future<void> _load() async {
    try {
      final result = await ApiService.instance.get('/fraud/list', queryParams: {'page': '1', 'limit': '50'});
      setState(() {
        _data = result ?? {};
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Fraud Case Management'),
        actions: [
