...
class CustomerJourneyMapperScreen extends StatefulWidget {
  const CustomerJourneyMapperScreen({super.key});
  @override
  State<CustomerJourneyMapperScreen> createState() => _CustomerJourneyMapperScreenState();
}

class _CustomerJourneyMapperScreenState extends State<CustomerJourneyMapperScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Customer Journey Mapper'),
        actions: [
