...
class ArchivalAdminScreen extends StatefulWidget {
  const ArchivalAdminScreen({super.key});
  @override
  State<ArchivalAdminScreen> createState() => _ArchivalAdminScreenState();
}

class _ArchivalAdminScreenState extends State<ArchivalAdminScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Archival Admin'),
        actions: [
