...
class DisputeAutoRulesScreen extends StatefulWidget {
  const DisputeAutoRulesScreen({super.key});
  @override
  State<DisputeAutoRulesScreen> createState() => _DisputeAutoRulesScreenState();
}

class _DisputeAutoRulesScreenState extends State<DisputeAutoRulesScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Dispute Auto Rules'),
        actions: [
