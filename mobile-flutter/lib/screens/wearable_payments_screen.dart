...
class WearablePaymentsScreen extends ConsumerStatefulWidget {
  const WearablePaymentsScreen({super.key});

  @override
  ConsumerState<WearablePaymentsScreen> createState() => _WearablePaymentsScreenState();
}

class _WearablePaymentsScreenState extends ConsumerState<WearablePaymentsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Wearable Payments'),
        actions: [
          IconButton(
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                'NFC wristband and ring payments',
