...
class Settings:
    DATABASE_URL: str = os.getenv("TRAINING_DATABASE_URL", "postgresql://postgres:postgres@localhost:5432/platform")
    SERVICE_PORT: int = int(os.getenv("TRAINING_PORT", "8036"))
