...
if _otel_endpoint:
    try:
        ...
        _resource = Resource.create({
            "service.name": os.environ.get("OTEL_SERVICE_NAME", "agent-liquidity-network"),
...
DATABASE_URL = os.environ.get("DATABASE_URL", "postgres://postgres:postgres@localhost:5432/agent_liquidity_network")
...
async def startup_event():
    ...
    await publish_kafka("agent.liquidity.network.started", {
        "service": "agent-liquidity-network",
