...
class PlatformMetricsExporterScreen extends StatefulWidget {
  const PlatformMetricsExporterScreen({super.key});
  @override
  State<PlatformMetricsExporterScreen> createState() => _PlatformMetricsExporterScreenState();
}

class _PlatformMetricsExporterScreenState extends State<PlatformMetricsExporterScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Platform Metrics Exporter'),
        actions: [
