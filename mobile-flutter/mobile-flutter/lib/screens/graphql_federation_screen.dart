...
class GraphqlFederationScreen extends StatefulWidget {
  const GraphqlFederationScreen({super.key});
  @override
  State<GraphqlFederationScreen> createState() => _GraphqlFederationScreenState();
}

class _GraphqlFederationScreenState extends State<GraphqlFederationScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Graphql Federation'),
        actions: [
