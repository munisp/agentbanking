...
export default function AutomatedSettlementScheduler() {
  ...
  const summary = trpc.automatedSettlementScheduler.getStats.useQuery()
      ...
      <div className="space-y-6 p-6">
        <div className="flex items-center justify-between flex-wrap gap-4">
          <div>
            ...
            <p className="text-muted-foreground">
              Automated settlement scheduling, batch processing, and
              reconciliation
            </p>
          </div>
          <div className="flex gap-2 flex-wrap">
            <Button onClick={() => toast.success("Schedule Batch initiated")}>
              Schedule Batch
            </Button>
            <Button
              variant="outline"
              onClick={() => toast.success("Force Run initiated")}
            >
              Force Run
            </Button>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <Card key="0">
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {(summary?.scheduledBatches ?? 0).toLocaleString()}
              </div>
            </CardContent>
          </Card>
          <Card key="1">
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {(summary?.completedToday ?? 0).toLocaleString()}
              </div>
            </CardContent>
          </Card>
          <Card key="2">
          ...
          <Card key="3">
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {(summary?.nextBatch ?? 0).toLocaleString()}
              </div>
            </CardContent>
          </Card>
        </div>
