...
class PayrollDisbursementScreen extends StatefulWidget {
  const PayrollDisbursementScreen({super.key});
  @override
  State<PayrollDisbursementScreen> createState() => _PayrollDisbursementScreenState();
}

class _PayrollDisbursementScreenState extends State<PayrollDisbursementScreen> {
  ...
  Future<void> _load() async {
    try {
      final result = await ApiService.instance.get('/payroll/list', queryParams: {'page': '1', 'limit': '50'});
      setState(() {
        _data = result ?? {};
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Payroll Disbursement'),
        actions: [
