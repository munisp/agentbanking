...
class TenantFeatureToggleScreen extends StatefulWidget {
  const TenantFeatureToggleScreen({super.key});
  @override
  State<TenantFeatureToggleScreen> createState() => _TenantFeatureToggleScreenState();
}

class _TenantFeatureToggleScreenState extends State<TenantFeatureToggleScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Tenant Feature Toggle'),
        actions: [
