...
class ApacheAirflowScreen extends StatefulWidget {
  const ApacheAirflowScreen({super.key});
  @override
  State<ApacheAirflowScreen> createState() => _ApacheAirflowScreenState();
}

class _ApacheAirflowScreenState extends State<ApacheAirflowScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Apache Airflow'),
        actions: [
