...
class RealtimeNotificationsScreen extends StatefulWidget {
  const RealtimeNotificationsScreen({super.key});
  @override
  State<RealtimeNotificationsScreen> createState() => _RealtimeNotificationsScreenState();
}

class _RealtimeNotificationsScreenState extends State<RealtimeNotificationsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Realtime Notifications'),
        actions: [
