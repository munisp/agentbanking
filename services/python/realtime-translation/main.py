import httpx
"""
Real-time Translation - FastAPI microservice
Multi-language translation service supporting Nigerian languages: Yoruba, Hausa, Igbo, Pidgin, and more
"""
import os
import logging
...
if _otel_endpoint:
    try:
        ...
        _resource = Resource.create({
            "service.name": os.environ.get("OTEL_SERVICE_NAME", "realtime-translation"),
...
app = FastAPI(title="Real-time Translation", description="Multi-language translation service supporting Nigerian languages: Yoruba, Hausa, Igbo, Pidgin, and more", version="1.0.0")
...
DATABASE_URL = os.environ.get("DATABASE_URL", "postgres://postgres:postgres@localhost:5432/realtime_translation")
...
@app.get("/health")
async def health():
    return {"status": "healthy", "service": "realtime-translation", "version": "1.0.0", "timestamp": datetime.utcnow().isoformat()}
...
async def startup_event():
    ...
    await publish_kafka("realtime.translation.started", {
