...
const TransactionReversalManagerScreen: React.FC = () => {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.header}>Transaction Reversal Manager</Text>
...
export default TransactionReversalManagerScreen;
