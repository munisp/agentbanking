...
class LoadTestComparisonScreen extends StatefulWidget {
  const LoadTestComparisonScreen({super.key});
  @override
  State<LoadTestComparisonScreen> createState() => _LoadTestComparisonScreenState();
}

class _LoadTestComparisonScreenState extends State<LoadTestComparisonScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Load Test Comparison'),
        actions: [
