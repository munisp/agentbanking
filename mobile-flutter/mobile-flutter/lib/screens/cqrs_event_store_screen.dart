...
class CqrsEventStoreScreen extends StatefulWidget {
  const CqrsEventStoreScreen({super.key});
  @override
  State<CqrsEventStoreScreen> createState() => _CqrsEventStoreScreenState();
}

class _CqrsEventStoreScreenState extends State<CqrsEventStoreScreen> {
  ...
  Future<void> _load() async {
    try {
      final result = await ApiService.instance.get('/qr/list', queryParams: {'page': '1', 'limit': '50'});
      setState(() {
        _data = result ?? {};
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Cqrs Event Store'),
        actions: [
