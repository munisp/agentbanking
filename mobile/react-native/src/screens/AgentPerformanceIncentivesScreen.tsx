...
export default function AgentPerformanceIncentivesScreen() {
  ...
  const fetchData = async () => {
    try {
      setError(null);
      const res = await fetch(`${API_BASE}/api/trpc/agentPerformanceIncentives.list`);
  ...
  return (
    ...
    >
      <View style={styles.header}>
        <Text style={styles.title}>Agent Performance Incentives</Text>
