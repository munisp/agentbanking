...
class RegulatoryFilingAutomationScreen extends StatefulWidget {
  const RegulatoryFilingAutomationScreen({super.key});
  @override
  State<RegulatoryFilingAutomationScreen> createState() => _RegulatoryFilingAutomationScreenState();
}

class _RegulatoryFilingAutomationScreenState extends State<RegulatoryFilingAutomationScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Regulatory Filing Automation'),
        actions: [
