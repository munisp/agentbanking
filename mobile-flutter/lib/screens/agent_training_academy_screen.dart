...
class AgentTrainingAcademyScreen extends StatefulWidget {
  const AgentTrainingAcademyScreen({super.key});
  @override
  State<AgentTrainingAcademyScreen> createState() => _AgentTrainingAcademyScreenState();
}

class _AgentTrainingAcademyScreenState extends State<AgentTrainingAcademyScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Agent Training Academy'),
        actions: [
