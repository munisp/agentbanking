...
export default function CustomerOnboardingPipelineScreen() {
  ...
  const fetchData = async () => {
    try {
      setError(null);
      const res = await fetch(`${API_BASE}/api/trpc/customerOnboardingPipeline.list`);
  ...
  return (
    ...
    >
      <View style={styles.header}>
        <Text style={styles.title}>Customer Onboarding Pipeline</Text>
