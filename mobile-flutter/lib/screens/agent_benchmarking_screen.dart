...
class AgentBenchmarkingScreen extends StatefulWidget {
  const AgentBenchmarkingScreen({super.key});
  @override
  State<AgentBenchmarkingScreen> createState() => _AgentBenchmarkingScreenState();
}

class _AgentBenchmarkingScreenState extends State<AgentBenchmarkingScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Agent Benchmarking'),
        actions: [
