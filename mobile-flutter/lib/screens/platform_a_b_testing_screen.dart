...
class PlatformABTestingScreen extends StatefulWidget {
  const PlatformABTestingScreen({super.key});
  @override
  State<PlatformABTestingScreen> createState() => _PlatformABTestingScreenState();
}

class _PlatformABTestingScreenState extends State<PlatformABTestingScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Platform A B Testing'),
        actions: [
