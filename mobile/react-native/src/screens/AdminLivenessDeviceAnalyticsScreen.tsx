...
export default function AdminLivenessDeviceAnalyticsScreen() {
  ...
  const fetchData = async () => {
    try {
      setError(null);
      const res = await fetch(`${API_BASE}/api/trpc/adminLivenessDeviceAnalytics.list`);
  ...
  return (
    ...
    >
      <View style={styles.header}>
        <Text style={styles.title}>Admin Liveness Device Analytics</Text>
