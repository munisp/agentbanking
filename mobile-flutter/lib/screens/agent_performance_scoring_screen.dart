...
class AgentPerformanceScoringScreen extends StatefulWidget {
  const AgentPerformanceScoringScreen({super.key});
  @override
  State<AgentPerformanceScoringScreen> createState() => _AgentPerformanceScoringScreenState();
}

class _AgentPerformanceScoringScreenState extends State<AgentPerformanceScoringScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Agent Performance Scoring'),
        actions: [
