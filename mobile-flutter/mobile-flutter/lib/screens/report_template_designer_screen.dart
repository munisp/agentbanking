...
class ReportTemplateDesignerScreen extends StatefulWidget {
  const ReportTemplateDesignerScreen({super.key});
  @override
  State<ReportTemplateDesignerScreen> createState() => _ReportTemplateDesignerScreenState();
}

class _ReportTemplateDesignerScreenState extends State<ReportTemplateDesignerScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Report Template Designer'),
        actions: [
