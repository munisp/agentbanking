...
class SettlementReconciliationScreen extends StatefulWidget {
  const SettlementReconciliationScreen({super.key});
  @override
  State<SettlementReconciliationScreen> createState() => _SettlementReconciliationScreenState();
}

class _SettlementReconciliationScreenState extends State<SettlementReconciliationScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Settlement Reconciliation'),
        actions: [
