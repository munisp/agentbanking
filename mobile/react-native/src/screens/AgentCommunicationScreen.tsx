...
export default function AgentCommunicationScreen() {
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.headerTitle}>Agent Communication</Text>
        ...
        renderItem={({ item }) => (
          <TouchableOpacity style={styles.card}>
            <View style={styles.cardHeader}>
              <Text style={styles.cardTitle}>{item.messageType}</Text>
              <Text style={styles.cardBadge}>{item.subject}</Text>
            </View>
            <Text style={styles.cardSubtitle}>{item.recipient}</Text>
