...
class FraudRealtimeVizScreen extends StatefulWidget {
  const FraudRealtimeVizScreen({super.key});
  @override
  State<FraudRealtimeVizScreen> createState() => _FraudRealtimeVizScreenState();
}

class _FraudRealtimeVizScreenState extends State<FraudRealtimeVizScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Fraud Realtime Viz'),
        actions: [
