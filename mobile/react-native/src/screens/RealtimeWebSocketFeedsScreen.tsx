...
export default function RealtimeWebSocketFeedsScreen() {
  ...
  const fetchData = async () => {
    try {
      setError(null);
      const res = await fetch(`${API_BASE}/api/trpc/realtimeWebSocketFeeds.list`);
  ...
  return (
    ...
    >
      <View style={styles.header}>
        <Text style={styles.title}>Realtime Web Socket Feeds</Text>
