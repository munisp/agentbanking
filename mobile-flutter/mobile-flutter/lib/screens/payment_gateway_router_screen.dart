...
class PaymentGatewayRouterScreen extends StatefulWidget {
  const PaymentGatewayRouterScreen({super.key});
  @override
  State<PaymentGatewayRouterScreen> createState() => _PaymentGatewayRouterScreenState();
}

class _PaymentGatewayRouterScreenState extends State<PaymentGatewayRouterScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Payment Gateway Router'),
        actions: [
