...
class PlatformMigrationToolkitScreen extends StatefulWidget {
  const PlatformMigrationToolkitScreen({super.key});
  @override
  State<PlatformMigrationToolkitScreen> createState() => _PlatformMigrationToolkitScreenState();
}

class _PlatformMigrationToolkitScreenState extends State<PlatformMigrationToolkitScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Platform Migration Toolkit'),
        actions: [
