...
export default function GraphqlSubscriptionGatewayScreen() {
  ...
  const fetchData = async () => {
    try {
      setError(null);
      const res = await fetch(`${API_BASE}/api/trpc/graphqlSubscriptionGateway.list`);
  ...
  return (
    ...
    >
      <View style={styles.header}>
        <Text style={styles.title}>Graphql Subscription Gateway</Text>
