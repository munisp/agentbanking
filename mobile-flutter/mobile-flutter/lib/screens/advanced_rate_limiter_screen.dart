...
class AdvancedRateLimiterScreen extends StatefulWidget {
  const AdvancedRateLimiterScreen({super.key});
  @override
  State<AdvancedRateLimiterScreen> createState() => _AdvancedRateLimiterScreenState();
}

class _AdvancedRateLimiterScreenState extends State<AdvancedRateLimiterScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Advanced Rate Limiter'),
        actions: [
