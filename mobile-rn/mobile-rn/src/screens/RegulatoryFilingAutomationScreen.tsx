...
const RegulatoryFilingAutomationScreen: React.FC = () => {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.header}>Regulatory Filing Automation</Text>
...
export default RegulatoryFilingAutomationScreen;
