...
class SystemHealthDashboardScreen extends StatefulWidget {
  const SystemHealthDashboardScreen({super.key});
  @override
  State<SystemHealthDashboardScreen> createState() => _SystemHealthDashboardScreenState();
}

class _SystemHealthDashboardScreenState extends State<SystemHealthDashboardScreen> {
