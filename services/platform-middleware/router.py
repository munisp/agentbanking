...
The real implementation lives in the standalone service (services/platform-middleware/).
...
_UNAVAILABLE = (
    "platform-middleware endpoints are not served by this gateway router. "
    "Use the standalone platform-middleware service."
)
...
async def health_check():
    return JSONResponse(
        status_code=503,
        content={"status": "unavailable", "service": "platform-middleware", "detail": _UNAVAILABLE},
    )
