...
The real implementation lives in the standalone service (services/twitter-service/).
...
_UNAVAILABLE = (
    "twitter-service endpoints are not served by this gateway router. "
    "Use the standalone twitter-service service."
)
...
async def health_check():
    return JSONResponse(
        status_code=503,
        content={"status": "unavailable", "service": "twitter-service", "detail": _UNAVAILABLE},
    )
