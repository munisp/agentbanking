...
class GeofenceZoneEditorScreen extends StatefulWidget {
  const GeofenceZoneEditorScreen({super.key});
  @override
  State<GeofenceZoneEditorScreen> createState() => _GeofenceZoneEditorScreenState();
}

class _GeofenceZoneEditorScreenState extends State<GeofenceZoneEditorScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Geofence Zone Editor'),
        actions: [
