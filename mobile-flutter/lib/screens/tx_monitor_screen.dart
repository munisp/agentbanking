...
class TxMonitorScreen extends StatefulWidget {
  const TxMonitorScreen({super.key});
  @override
  State<TxMonitorScreen> createState() => _TxMonitorScreenState();
}

class _TxMonitorScreenState extends State<TxMonitorScreen> {
