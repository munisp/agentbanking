...
class DynamicFeeEngineScreen extends StatefulWidget {
  const DynamicFeeEngineScreen({super.key});
  @override
  State<DynamicFeeEngineScreen> createState() => _DynamicFeeEngineScreenState();
}

class _DynamicFeeEngineScreenState extends State<DynamicFeeEngineScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Dynamic Fee Engine'),
        actions: [
