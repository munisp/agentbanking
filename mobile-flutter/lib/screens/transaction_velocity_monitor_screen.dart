...
class TransactionVelocityMonitorScreen extends StatefulWidget {
  const TransactionVelocityMonitorScreen({super.key});
  @override
  State<TransactionVelocityMonitorScreen> createState() => _TransactionVelocityMonitorScreenState();
}

class _TransactionVelocityMonitorScreenState extends State<TransactionVelocityMonitorScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Transaction Velocity Monitor'),
        actions: [
