...
export default function NotificationPreferenceMatrixScreen() {
  ...
  const fetchData = async () => {
    try {
      setError(null);
      const res = await fetch(`${API_BASE}/api/trpc/notificationPreferenceMatrix.list`);
  ...
  return (
    ...
    >
      <View style={styles.header}>
        <Text style={styles.title}>Notification Preference Matrix</Text>
