...
class ReversalApprovalScreen extends StatefulWidget {
  const ReversalApprovalScreen({super.key});
  @override
  State<ReversalApprovalScreen> createState() => _ReversalApprovalScreenState();
}

class _ReversalApprovalScreenState extends State<ReversalApprovalScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Reversal Approval'),
        actions: [
