...
class PlatformHealthMonitorScreen extends StatefulWidget {
  const PlatformHealthMonitorScreen({super.key});
  @override
  State<PlatformHealthMonitorScreen> createState() => _PlatformHealthMonitorScreenState();
}

class _PlatformHealthMonitorScreenState extends State<PlatformHealthMonitorScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Platform Health Monitor'),
        actions: [
