...
class SharedLayoutGalleryScreen extends StatefulWidget {
  const SharedLayoutGalleryScreen({super.key});
  @override
  State<SharedLayoutGalleryScreen> createState() => _SharedLayoutGalleryScreenState();
}

class _SharedLayoutGalleryScreenState extends State<SharedLayoutGalleryScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Shared Layout Gallery'),
        actions: [
