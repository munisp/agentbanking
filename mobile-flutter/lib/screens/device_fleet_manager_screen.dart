...
class DeviceFleetManagerScreen extends StatefulWidget {
  const DeviceFleetManagerScreen({super.key});
  @override
  State<DeviceFleetManagerScreen> createState() => _DeviceFleetManagerScreenState();
}

class _DeviceFleetManagerScreenState extends State<DeviceFleetManagerScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Device Fleet Manager'),
        actions: [
