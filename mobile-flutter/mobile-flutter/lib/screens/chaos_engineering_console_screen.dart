...
class ChaosEngineeringConsoleScreen extends StatefulWidget {
  const ChaosEngineeringConsoleScreen({super.key});
  @override
  State<ChaosEngineeringConsoleScreen> createState() => _ChaosEngineeringConsoleScreenState();
}

class _ChaosEngineeringConsoleScreenState extends State<ChaosEngineeringConsoleScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Chaos Engineering Console'),
        actions: [
