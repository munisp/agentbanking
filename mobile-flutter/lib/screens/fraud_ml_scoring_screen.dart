...
class FraudMlScoringScreen extends StatefulWidget {
  const FraudMlScoringScreen({super.key});
  @override
  State<FraudMlScoringScreen> createState() => _FraudMlScoringScreenState();
}

class _FraudMlScoringScreenState extends State<FraudMlScoringScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Fraud Ml Scoring'),
        actions: [
