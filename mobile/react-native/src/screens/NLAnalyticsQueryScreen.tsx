...
export default function NLAnalyticsQueryScreen() {
  ...
  const fetchData = async () => {
    try {
      setError(null);
      const res = await fetch(`${API_BASE}/api/trpc/nLAnalyticsQuery.list`);
  ...
  return (
    ...
    >
      <View style={styles.header}>
        <Text style={styles.title}>N L Analytics Query</Text>
