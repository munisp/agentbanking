...
class AdvancedBiReportingScreen extends StatefulWidget {
  const AdvancedBiReportingScreen({super.key});
  @override
  State<AdvancedBiReportingScreen> createState() => _AdvancedBiReportingScreenState();
}

class _AdvancedBiReportingScreenState extends State<AdvancedBiReportingScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Advanced Bi Reporting'),
        actions: [
