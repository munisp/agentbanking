...
export default function MerchantPayoutSettlementScreen() {
  ...
  const fetchData = async () => {
    try {
      setError(null);
      const res = await fetch(`${API_BASE}/api/trpc/merchantPayoutSettlement.list`);
  ...
  return (
    ...
    >
      <View style={styles.header}>
        <Text style={styles.title}>Merchant Payout Settlement</Text>
