...
class AdminLivenessDeviceAnalyticsScreen extends StatefulWidget {
  const AdminLivenessDeviceAnalyticsScreen({super.key});
  @override
  State<AdminLivenessDeviceAnalyticsScreen> createState() => _AdminLivenessDeviceAnalyticsScreenState();
}

class _AdminLivenessDeviceAnalyticsScreenState extends State<AdminLivenessDeviceAnalyticsScreen> {
  ...
  Future<void> _load() async {
    try {
      final result = await ApiService.instance.get('/admin/list', queryParams: {'page': '1', 'limit': '50'});
      setState(() {
        _data = result ?? {};
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Admin Liveness Device Analytics'),
        actions: [
