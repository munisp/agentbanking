...
class StablecoinRailsScreen extends StatefulWidget {
  const StablecoinRailsScreen({super.key});
  @override
  State<StablecoinRailsScreen> createState() => _StablecoinRailsScreenState();
}

class _StablecoinRailsScreenState extends State<StablecoinRailsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Stablecoin Rails'),
        actions: [
