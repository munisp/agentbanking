...
/** Manage wallets and fund transfers */
        ...
        renderItem={({ item }) => (
          <TouchableOpacity style={styles.card}>
            <View style={styles.cardHeader}>
              <Text style={styles.cardTitle}>{item.walletId}</Text>
              <Text style={styles.cardBadge}>{item.currency}</Text>
            </View>
            <Text style={styles.cardSubtitle}>{item.balance}</Text>
            <Text style={styles.cardMeta}>{item.tier}</Text>
          </TouchableOpacity>
        )}
      />
    </View>
