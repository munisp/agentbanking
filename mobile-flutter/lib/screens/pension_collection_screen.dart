...
class PensionCollectionScreen extends StatefulWidget {
  const PensionCollectionScreen({super.key});
  @override
  State<PensionCollectionScreen> createState() => _PensionCollectionScreenState();
}

class _PensionCollectionScreenState extends State<PensionCollectionScreen> {
  ...
  Future<void> _load() async {
    try {
      final result = await ApiService.instance.get('/pension/list', queryParams: {'page': '1', 'limit': '50'});
      setState(() {
        _data = result ?? {};
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Pension Collection'),
        actions: [
