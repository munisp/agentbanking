...
class AgentLoanAdvanceScreen extends StatefulWidget {
  const AgentLoanAdvanceScreen({super.key});
  @override
  State<AgentLoanAdvanceScreen> createState() => _AgentLoanAdvanceScreenState();
}

class _AgentLoanAdvanceScreenState extends State<AgentLoanAdvanceScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Agent Loan Advance'),
        actions: [
