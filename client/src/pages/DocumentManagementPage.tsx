...
export default function DocumentManagementPage() {
  ...
  const listData = (d?.recentDocuments ?? d?.recent ?? []) as Record<
    string,
    unknown
  >[];
        ...
        <div className="flex items-center justify-between flex-wrap gap-4">
          <div>
            ...
            <p className="text-muted-foreground">
              Document storage, version control, and compliance documentation
            </p>
          </div>
          <div className="flex gap-2 flex-wrap">
            <Button onClick={() => toast.success("Upload Document initiated")}>
              Upload Document
            </Button>
            <Button
              variant="outline"
              onClick={() => toast.success("Create Folder initiated")}
            >
              Create Folder
            </Button>
          </div>
