...
The real implementation lives in the standalone service (services/compliance-reporting/).
...
_UNAVAILABLE = (
    "compliance-reporting endpoints are not served by this gateway router. "
    "Use the standalone compliance-reporting service."
)
...
async def health_check():
    return JSONResponse(
        status_code=503,
        content={"status": "unavailable", "service": "compliance-reporting", "detail": _UNAVAILABLE},
    )
