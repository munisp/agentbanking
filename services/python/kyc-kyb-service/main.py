...
if _otel_endpoint:
    try:
        ...
        _resource = Resource.create({
            "service.name": os.environ.get("OTEL_SERVICE_NAME", "kyc-kyb-service"),
...
DATABASE_URL = os.environ.get("DATABASE_URL", "postgres://postgres:postgres@localhost:5432/kyc_kyb_service")
...
async def startup_event():
    ...
    await publish_kafka("kyc.kyb.service.started", {
