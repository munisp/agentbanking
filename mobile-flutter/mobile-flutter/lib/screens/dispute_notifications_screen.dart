...
class DisputeNotificationsScreen extends StatefulWidget {
  const DisputeNotificationsScreen({super.key});
  @override
  State<DisputeNotificationsScreen> createState() => _DisputeNotificationsScreenState();
}

class _DisputeNotificationsScreenState extends State<DisputeNotificationsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Dispute Notifications'),
        actions: [
