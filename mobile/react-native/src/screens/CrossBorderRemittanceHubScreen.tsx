...
export default function CrossBorderRemittanceHubScreen() {
  ...
  const fetchData = async () => {
    try {
      setError(null);
      const res = await fetch(`${API_BASE}/api/trpc/crossBorderRemittanceHub.list`);
  ...
  return (
    ...
    >
      <View style={styles.header}>
        <Text style={styles.title}>Cross Border Remittance Hub</Text>
