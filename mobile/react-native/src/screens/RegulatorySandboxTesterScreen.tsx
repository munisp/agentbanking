...
export default function RegulatorySandboxTesterScreen() {
  ...
  const fetchData = async () => {
    try {
      setError(null);
      const res = await fetch(`${API_BASE}/api/trpc/regulatorySandboxTester.list`);
  ...
  return (
    ...
    >
      <View style={styles.header}>
        <Text style={styles.title}>Regulatory Sandbox Tester</Text>
