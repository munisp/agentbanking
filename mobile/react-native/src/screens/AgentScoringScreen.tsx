...
export default function AgentScoringScreen() {
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.headerTitle}>Agent Scoring</Text>
        ...
        renderItem={({ item }) => (
          <TouchableOpacity style={styles.card}>
            <View style={styles.cardHeader}>
              <Text style={styles.cardTitle}>{item.score}</Text>
              <Text style={styles.cardBadge}>{item.totalTransactions}</Text>
            </View>
            <Text style={styles.cardSubtitle}>{item.rank}</Text>
            <Text style={styles.cardMeta}>{item.successRate}</Text>
          </TouchableOpacity>
        )}
      />
    </View>
