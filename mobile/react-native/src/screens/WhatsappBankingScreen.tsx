...
const FEATURES = ["Link WhatsApp number", "Command reference", "Transaction history via WhatsApp"];

export default function WhatsappBankingScreen() {
