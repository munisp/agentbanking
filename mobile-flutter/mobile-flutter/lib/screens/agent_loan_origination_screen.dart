...
class AgentLoanOriginationScreen extends StatefulWidget {
  const AgentLoanOriginationScreen({super.key});
  @override
  State<AgentLoanOriginationScreen> createState() => _AgentLoanOriginationScreenState();
}

class _AgentLoanOriginationScreenState extends State<AgentLoanOriginationScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Agent Loan Origination'),
        actions: [
