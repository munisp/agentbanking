...
class AgentSuspensionWorkflowScreen extends StatefulWidget {
  const AgentSuspensionWorkflowScreen({super.key});
  @override
  State<AgentSuspensionWorkflowScreen> createState() => _AgentSuspensionWorkflowScreenState();
}

class _AgentSuspensionWorkflowScreenState extends State<AgentSuspensionWorkflowScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Agent Suspension Workflow'),
        actions: [
