...
export default function WhiteLabelOnboardingScreen() {
  ...
  const fetchData = async () => {
    try {
      setError(null);
      const res = await fetch(`${API_BASE}/api/trpc/whiteLabelOnboarding.list`);
  ...
  return (
    ...
    >
      <View style={styles.header}>
        <Text style={styles.title}>White Label Onboarding</Text>
