...
class TxVelocityMonitorScreen extends StatefulWidget {
  const TxVelocityMonitorScreen({super.key});
  @override
  State<TxVelocityMonitorScreen> createState() => _TxVelocityMonitorScreenState();
}

class _TxVelocityMonitorScreenState extends State<TxVelocityMonitorScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Tx Velocity Monitor'),
        actions: [
