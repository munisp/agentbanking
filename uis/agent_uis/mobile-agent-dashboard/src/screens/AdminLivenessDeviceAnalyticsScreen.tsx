...
const AdminLivenessDeviceAnalyticsScreen: React.FC = () => {
  ...
  const load = useCallback(async () => {
    try {
      setError('');
      const { data } = await apiClient.get('/admin/list?page=1&limit=50');
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.header}>Admin Liveness Device Analytics</Text>
...
export default AdminLivenessDeviceAnalyticsScreen;
