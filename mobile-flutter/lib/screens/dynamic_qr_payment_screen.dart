...
class DynamicQrPaymentScreen extends StatefulWidget {
  const DynamicQrPaymentScreen({super.key});
  @override
  State<DynamicQrPaymentScreen> createState() => _DynamicQrPaymentScreenState();
}

class _DynamicQrPaymentScreenState extends State<DynamicQrPaymentScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Dynamic Qr Payment'),
        actions: [
