...
export default function AgentSuspensionScreen() {
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.headerTitle}>Agent Suspension</Text>
        ...
        renderItem={({ item }) => (
          <TouchableOpacity style={styles.card}>
            <View style={styles.cardHeader}>
              <Text style={styles.cardTitle}>{item.agentCode}</Text>
              <Text style={styles.cardBadge}>{item.suspendedAt}</Text>
            </View>
            <Text style={styles.cardSubtitle}>{item.reason}</Text>
            <Text style={styles.cardMeta}>{item.appealStatus}</Text>
          </TouchableOpacity>
        )}
      />
    </View>
