  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.headerTitle}>Rate Limits</Text>
        ...
        renderItem={({ item }) => (
          <TouchableOpacity style={styles.card}>
            <View style={styles.cardHeader}>
              ...
              <Text style={styles.cardBadge}>{item.window}</Text>
            </View>
            <Text style={styles.cardSubtitle}>{item.limit}</Text>
            <Text style={styles.cardMeta}>{item.current}</Text>
          </TouchableOpacity>
        )}
      />
    </View>
