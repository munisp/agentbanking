...
class LakehouseAnalyticsScreen extends StatefulWidget {
  const LakehouseAnalyticsScreen({super.key});
  @override
  State<LakehouseAnalyticsScreen> createState() => _LakehouseAnalyticsScreenState();
}

class _LakehouseAnalyticsScreenState extends State<LakehouseAnalyticsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Lakehouse Analytics'),
        actions: [
