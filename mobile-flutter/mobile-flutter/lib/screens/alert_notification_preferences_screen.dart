...
class AlertNotificationPreferencesScreen extends StatefulWidget {
  const AlertNotificationPreferencesScreen({super.key});
  @override
  State<AlertNotificationPreferencesScreen> createState() => _AlertNotificationPreferencesScreenState();
}

class _AlertNotificationPreferencesScreenState extends State<AlertNotificationPreferencesScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Alert Notification Preferences'),
        actions: [
