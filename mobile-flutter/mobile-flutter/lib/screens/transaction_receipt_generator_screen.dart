...
class TransactionReceiptGeneratorScreen extends StatefulWidget {
  const TransactionReceiptGeneratorScreen({super.key});
  @override
  State<TransactionReceiptGeneratorScreen> createState() => _TransactionReceiptGeneratorScreenState();
}

class _TransactionReceiptGeneratorScreenState extends State<TransactionReceiptGeneratorScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Transaction Receipt Generator'),
        actions: [
