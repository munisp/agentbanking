...
class AgentKycDocVaultScreen extends StatefulWidget {
  const AgentKycDocVaultScreen({super.key});
  @override
  State<AgentKycDocVaultScreen> createState() => _AgentKycDocVaultScreenState();
}

class _AgentKycDocVaultScreenState extends State<AgentKycDocVaultScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Agent Kyc Doc Vault'),
        actions: [
