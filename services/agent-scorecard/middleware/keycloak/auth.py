...
KEYCLOAK_REALM     = os.getenv("KEYCLOAK_REALM", "54agent")
KEYCLOAK_CLIENT_ID = os.getenv("KEYCLOAK_CLIENT_ID", "agent-scorecard")
KEYCLOAK_AUDIENCE  = os.getenv("KEYCLOAK_AUDIENCE", "agent-scorecard")
