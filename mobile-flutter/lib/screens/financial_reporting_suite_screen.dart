...
class FinancialReportingSuiteScreen extends StatefulWidget {
  const FinancialReportingSuiteScreen({super.key});
  @override
  State<FinancialReportingSuiteScreen> createState() => _FinancialReportingSuiteScreenState();
}

class _FinancialReportingSuiteScreenState extends State<FinancialReportingSuiteScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Financial Reporting Suite'),
        actions: [
