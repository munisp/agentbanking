...
class DigitalIdentityLayerScreen extends StatefulWidget {
  const DigitalIdentityLayerScreen({super.key});
  @override
  State<DigitalIdentityLayerScreen> createState() => _DigitalIdentityLayerScreenState();
}

class _DigitalIdentityLayerScreenState extends State<DigitalIdentityLayerScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Digital Identity Layer'),
        actions: [
