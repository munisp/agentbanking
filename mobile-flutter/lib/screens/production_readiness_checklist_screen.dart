...
class ProductionReadinessChecklistScreen extends StatefulWidget {
  const ProductionReadinessChecklistScreen({super.key});
  @override
  State<ProductionReadinessChecklistScreen> createState() => _ProductionReadinessChecklistScreenState();
}

class _ProductionReadinessChecklistScreenState extends State<ProductionReadinessChecklistScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Production Readiness Checklist'),
        actions: [
