...
class TransactionMapVizScreen extends StatefulWidget {
  const TransactionMapVizScreen({super.key});
  @override
  State<TransactionMapVizScreen> createState() => _TransactionMapVizScreenState();
}

class _TransactionMapVizScreenState extends State<TransactionMapVizScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Transaction Map Viz'),
        actions: [
