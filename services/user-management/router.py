...
The real implementation lives in the standalone service (services/user-management/).
...
_UNAVAILABLE = (
    "user-management endpoints are not served by this gateway router. "
    "Use the standalone user-management service."
)
...
async def health_check():
    return JSONResponse(
        status_code=503,
        content={"status": "unavailable", "service": "user-management", "detail": _UNAVAILABLE},
    )
