...
export default function AgentPerformanceScorecardScreen() {
  ...
  const fetchData = async () => {
    try {
      setError(null);
      const res = await fetch(`${API_BASE}/api/trpc/agentPerformanceScorecard.list`);
  ...
  return (
    ...
    >
      <View style={styles.header}>
        <Text style={styles.title}>Agent Performance Scorecard</Text>
