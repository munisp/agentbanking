...
class PredictiveAgentChurnScreen extends StatefulWidget {
  const PredictiveAgentChurnScreen({super.key});
  @override
  State<PredictiveAgentChurnScreen> createState() => _PredictiveAgentChurnScreenState();
}

class _PredictiveAgentChurnScreenState extends State<PredictiveAgentChurnScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Predictive Agent Churn'),
        actions: [
