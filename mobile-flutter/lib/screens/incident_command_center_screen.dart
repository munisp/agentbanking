...
class IncidentCommandCenterScreen extends StatefulWidget {
  const IncidentCommandCenterScreen({super.key});
  @override
  State<IncidentCommandCenterScreen> createState() => _IncidentCommandCenterScreenState();
}

class _IncidentCommandCenterScreenState extends State<IncidentCommandCenterScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Incident Command Center'),
        actions: [
