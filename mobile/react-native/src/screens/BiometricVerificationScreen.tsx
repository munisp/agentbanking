        ...
        renderItem={({ item }) => (
          <TouchableOpacity style={styles.card}>
            <View style={styles.cardHeader}>
              <Text style={styles.cardTitle}>{item.verificationType}</Text>
              <Text style={styles.cardBadge}>{item.deviceId}</Text>
            </View>
            <Text style={styles.cardSubtitle}>{item.confidence}</Text>
