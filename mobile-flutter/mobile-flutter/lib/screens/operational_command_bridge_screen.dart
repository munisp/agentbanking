...
class OperationalCommandBridgeScreen extends StatefulWidget {
  const OperationalCommandBridgeScreen({super.key});
  @override
  State<OperationalCommandBridgeScreen> createState() => _OperationalCommandBridgeScreenState();
}

class _OperationalCommandBridgeScreenState extends State<OperationalCommandBridgeScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Operational Command Bridge'),
        actions: [
