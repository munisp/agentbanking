...
/**
 * 54agent — Kafka Dead-Letter Queue (DLQ) Consumer
 *
 ...
 *
 * Topics consumed:
 *   - 54agent.dlq.transactions
 *   - 54agent.dlq.settlements
 *   - 54agent.dlq.notifications
 */
