        ...
        >
          {!isAuthenticated ? (
            <>
              ...
              {/* New auth screen variants */}
              <Stack.Screen name="LoginScreenV2" component={LoginScreenV2} />
              <Stack.Screen name="LoginScreenCDP" component={LoginScreenCDP} />
              <Stack.Screen name="OnboardingScreenV2" component={OnboardingScreenV2} />
