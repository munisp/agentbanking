...
class ChargebackManagementScreen extends StatefulWidget {
  const ChargebackManagementScreen({super.key});
  @override
  State<ChargebackManagementScreen> createState() => _ChargebackManagementScreenState();
}

class _ChargebackManagementScreenState extends State<ChargebackManagementScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Chargeback Management'),
        actions: [
