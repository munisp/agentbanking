...
class NotificationTemplateManagerScreen extends StatefulWidget {
  const NotificationTemplateManagerScreen({super.key});
  @override
  State<NotificationTemplateManagerScreen> createState() => _NotificationTemplateManagerScreenState();
}

class _NotificationTemplateManagerScreenState extends State<NotificationTemplateManagerScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Notification Template Manager'),
        actions: [
