...
const PaymentDisputeArbitrationScreen: React.FC = () => {
  ...
  const load = useCallback(async () => {
    try {
      setError('');
      const { data } = await apiClient.get('/disputes/list?page=1&limit=50');
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.header}>Payment Dispute Arbitration</Text>
...
export default PaymentDisputeArbitrationScreen;
