...
class AgritechPaymentsScreen extends StatefulWidget {
  const AgritechPaymentsScreen({super.key});
  @override
  State<AgritechPaymentsScreen> createState() => _AgritechPaymentsScreenState();
}

class _AgritechPaymentsScreenState extends State<AgritechPaymentsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Agritech Payments'),
        actions: [
