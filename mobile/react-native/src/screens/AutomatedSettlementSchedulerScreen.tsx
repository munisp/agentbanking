...
export default function AutomatedSettlementSchedulerScreen() {
  ...
  const fetchData = async () => {
    try {
      setError(null);
      const res = await fetch(`${API_BASE}/api/trpc/automatedSettlementScheduler.list`);
  ...
  return (
    ...
    >
      <View style={styles.header}>
        <Text style={styles.title}>Automated Settlement Scheduler</Text>
