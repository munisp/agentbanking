...
class TenantBillingPortalScreen extends StatefulWidget {
  const TenantBillingPortalScreen({super.key});
  @override
  State<TenantBillingPortalScreen> createState() => _TenantBillingPortalScreenState();
}

class _TenantBillingPortalScreenState extends State<TenantBillingPortalScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Tenant Billing Portal'),
        actions: [
