...
class AutoComplianceWorkflowScreen extends StatefulWidget {
  const AutoComplianceWorkflowScreen({super.key});
  @override
  State<AutoComplianceWorkflowScreen> createState() => _AutoComplianceWorkflowScreenState();
}

class _AutoComplianceWorkflowScreenState extends State<AutoComplianceWorkflowScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Auto Compliance Workflow'),
        actions: [
