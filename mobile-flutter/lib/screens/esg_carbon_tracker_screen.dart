...
class EsgCarbonTrackerScreen extends StatefulWidget {
  const EsgCarbonTrackerScreen({super.key});
  @override
  State<EsgCarbonTrackerScreen> createState() => _EsgCarbonTrackerScreenState();
}

class _EsgCarbonTrackerScreenState extends State<EsgCarbonTrackerScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Esg Carbon Tracker'),
        actions: [
