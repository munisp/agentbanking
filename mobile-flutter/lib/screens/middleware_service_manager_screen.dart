...
class MiddlewareServiceManagerScreen extends StatefulWidget {
  const MiddlewareServiceManagerScreen({super.key});
  @override
  State<MiddlewareServiceManagerScreen> createState() => _MiddlewareServiceManagerScreenState();
}

class _MiddlewareServiceManagerScreenState extends State<MiddlewareServiceManagerScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Middleware Service Manager'),
        actions: [
