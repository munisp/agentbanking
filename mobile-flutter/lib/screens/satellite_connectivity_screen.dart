...
class SatelliteConnectivityScreen extends StatefulWidget {
  const SatelliteConnectivityScreen({super.key});
  @override
  State<SatelliteConnectivityScreen> createState() => _SatelliteConnectivityScreenState();
}

class _SatelliteConnectivityScreenState extends State<SatelliteConnectivityScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Satellite Connectivity'),
        actions: [
