...
class RealtimeTxMonitorScreen extends StatefulWidget {
  const RealtimeTxMonitorScreen({super.key});
  @override
  State<RealtimeTxMonitorScreen> createState() => _RealtimeTxMonitorScreenState();
}

class _RealtimeTxMonitorScreenState extends State<RealtimeTxMonitorScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Realtime Tx Monitor'),
        actions: [
