...
class TransactionReconciliationScreen extends StatefulWidget {
  const TransactionReconciliationScreen({super.key});
  @override
  State<TransactionReconciliationScreen> createState() => _TransactionReconciliationScreenState();
}

class _TransactionReconciliationScreenState extends State<TransactionReconciliationScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Transaction Reconciliation'),
        actions: [
