...
export default function MerchantAnalyticsDashScreen() {
  ...
  const fetchData = async () => {
    try {
      setError(null);
      const res = await fetch(`${API_BASE}/api/trpc/merchantAnalyticsDash.list`);
  ...
  return (
    ...
    >
      <View style={styles.header}>
        <Text style={styles.title}>Merchant Analytics Dash</Text>
