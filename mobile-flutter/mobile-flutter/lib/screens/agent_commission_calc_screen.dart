...
class AgentCommissionCalcScreen extends StatefulWidget {
  const AgentCommissionCalcScreen({super.key});
  @override
  State<AgentCommissionCalcScreen> createState() => _AgentCommissionCalcScreenState();
}

class _AgentCommissionCalcScreenState extends State<AgentCommissionCalcScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Agent Commission Calc'),
        actions: [
