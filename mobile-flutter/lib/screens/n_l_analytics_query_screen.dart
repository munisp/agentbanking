...
class NLAnalyticsQueryScreen extends StatefulWidget {
  const NLAnalyticsQueryScreen({super.key});
  @override
  State<NLAnalyticsQueryScreen> createState() => _NLAnalyticsQueryScreenState();
}

class _NLAnalyticsQueryScreenState extends State<NLAnalyticsQueryScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('N L Analytics Query'),
        actions: [
