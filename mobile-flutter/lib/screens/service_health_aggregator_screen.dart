...
class ServiceHealthAggregatorScreen extends StatefulWidget {
  const ServiceHealthAggregatorScreen({super.key});
  @override
  State<ServiceHealthAggregatorScreen> createState() => _ServiceHealthAggregatorScreenState();
}

class _ServiceHealthAggregatorScreenState extends State<ServiceHealthAggregatorScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Service Health Aggregator'),
        actions: [
