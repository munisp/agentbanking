...
class RegulatoryReportGeneratorScreen extends StatefulWidget {
  const RegulatoryReportGeneratorScreen({super.key});
  @override
  State<RegulatoryReportGeneratorScreen> createState() => _RegulatoryReportGeneratorScreenState();
}

class _RegulatoryReportGeneratorScreenState extends State<RegulatoryReportGeneratorScreen> {
  ...
  Future<void> _load() async {
    try {
      final result = await ApiService.instance.get('/reports/list', queryParams: {'page': '1', 'limit': '50'});
      setState(() {
        _data = result ?? {};
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Regulatory Report Generator'),
        actions: [
