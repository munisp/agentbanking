...
class CurrencyHedgingScreen extends StatefulWidget {
  const CurrencyHedgingScreen({super.key});
  @override
  State<CurrencyHedgingScreen> createState() => _CurrencyHedgingScreenState();
}

class _CurrencyHedgingScreenState extends State<CurrencyHedgingScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Currency Hedging'),
        actions: [
