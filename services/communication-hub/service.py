...
class CommunicationHubService:
    ...
    def _handle_bot_command(self, text: str, sender_id: str, channel: MessageChannel,
        ...
        if command == "/help":
            ...
            response_text = "To check your balance, please log in to the 54agent app or visit your nearest agent."
        elif command == "/agents":
            response_text = "Find your nearest agent at: https://54agent.ng/agents"
