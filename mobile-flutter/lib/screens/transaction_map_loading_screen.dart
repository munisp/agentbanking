...
class TransactionMapLoadingScreen extends StatefulWidget {
  const TransactionMapLoadingScreen({super.key});
  @override
  State<TransactionMapLoadingScreen> createState() => _TransactionMapLoadingScreenState();
}

class _TransactionMapLoadingScreenState extends State<TransactionMapLoadingScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Transaction Map Loading'),
        actions: [
