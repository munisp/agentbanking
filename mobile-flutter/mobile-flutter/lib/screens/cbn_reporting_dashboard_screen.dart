...
class CbnReportingDashboardScreen extends StatefulWidget {
  const CbnReportingDashboardScreen({super.key});
  @override
  State<CbnReportingDashboardScreen> createState() => _CbnReportingDashboardScreenState();
}

class _CbnReportingDashboardScreenState extends State<CbnReportingDashboardScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Cbn Reporting'),
        actions: [
