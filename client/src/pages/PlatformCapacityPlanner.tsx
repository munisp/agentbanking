...
export default function PlatformCapacityPlanner() {
  ...
  const summary = trpc.platformCapacityPlanner.getStats.useQuery()?.data as
      ...
      <div className="space-y-6 p-6">
        <div className="flex items-center justify-between flex-wrap gap-4">
          <div>
            ...
            <p className="text-muted-foreground">
              Infrastructure capacity planning, resource forecasting, and
              scaling recommendations
            </p>
          </div>
          <div className="flex gap-2 flex-wrap">
            <Button onClick={() => toast.success("Scale Up initiated")}>
              Scale Up
            </Button>
            <Button
              variant="outline"
              onClick={() => toast.success("Scale Down initiated")}
            >
              Scale Down
            </Button>
            <Button
              variant="outline"
              onClick={() => toast.success("Forecast initiated")}
            >
              Forecast
            </Button>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <Card key="3">
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {(summary?.scaleRecommendation ?? 0).toLocaleString()}
              </div>
            </CardContent>
          </Card>
        </div>
