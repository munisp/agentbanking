# 54agent POS Shell — Environment Variables Reference
...
| `APP_URL`  | `https://pos.54agent.ng` | Public URL       |
...
| `KEYCLOAK_REALM`     | `54agent`               | Realm name          |
...
| `MINIO_BUCKET`     | `54agent-pos-shell`  | Default bucket |
...
| `SMTP_FROM` | `noreply@54agent.ng` | From address |
...
| `VAPID_SUBJECT`     | `mailto:admin@54agent.ng` | VAPID subject     |
...
| `CBN_INSTITUTION_CODE`      | `54agent001` | CBN institution code          |
...
| `CORS_ORIGIN`      | `https://pos.54agent.ng` | CORS allowed origin    |
