...
class VaultSecretsManagerScreen extends StatefulWidget {
  const VaultSecretsManagerScreen({super.key});
  @override
  State<VaultSecretsManagerScreen> createState() => _VaultSecretsManagerScreenState();
}

class _VaultSecretsManagerScreenState extends State<VaultSecretsManagerScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Vault Secrets Manager'),
        actions: [
