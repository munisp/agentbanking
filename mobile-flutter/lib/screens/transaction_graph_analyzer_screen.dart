...
class TransactionGraphAnalyzerScreen extends StatefulWidget {
  const TransactionGraphAnalyzerScreen({super.key});
  @override
  State<TransactionGraphAnalyzerScreen> createState() => _TransactionGraphAnalyzerScreenState();
}

class _TransactionGraphAnalyzerScreenState extends State<TransactionGraphAnalyzerScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Transaction Graph Analyzer'),
        actions: [
