...
class AutoReconciliationEngineScreen extends StatefulWidget {
  const AutoReconciliationEngineScreen({super.key});
  @override
  State<AutoReconciliationEngineScreen> createState() => _AutoReconciliationEngineScreenState();
}

class _AutoReconciliationEngineScreenState extends State<AutoReconciliationEngineScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Auto Reconciliation Engine'),
        actions: [
