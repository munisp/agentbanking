...
class BulkPaymentProcessorScreen extends StatefulWidget {
  const BulkPaymentProcessorScreen({super.key});
  @override
  State<BulkPaymentProcessorScreen> createState() => _BulkPaymentProcessorScreenState();
}

class _BulkPaymentProcessorScreenState extends State<BulkPaymentProcessorScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Bulk Payment Processor'),
        actions: [
