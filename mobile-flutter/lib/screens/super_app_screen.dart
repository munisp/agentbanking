...
class SuperAppScreen extends ConsumerStatefulWidget {
  const SuperAppScreen({super.key});

  @override
  ConsumerState<SuperAppScreen> createState() => _SuperAppScreenState();
}

class _SuperAppScreenState extends ConsumerState<SuperAppScreen> {
  ...
  Future<void> _loadData() async {
    ...
    try {
      ...
      final statsResp = await api.get('/api/trpc/super_app.getStats');
      final listResp = await api.get('/api/trpc/super_app.list?input={"limit":20,"offset":0}');
      setState(() {
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                'Mini-app ecosystem and unified services',
