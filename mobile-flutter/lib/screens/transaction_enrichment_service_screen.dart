...
class TransactionEnrichmentServiceScreen extends StatefulWidget {
  const TransactionEnrichmentServiceScreen({super.key});
  @override
  State<TransactionEnrichmentServiceScreen> createState() => _TransactionEnrichmentServiceScreenState();
}

class _TransactionEnrichmentServiceScreenState extends State<TransactionEnrichmentServiceScreen> {
  ...
  Future<void> _load() async {
    try {
      final result = await ApiService.instance.get('/transactions/list', queryParams: {'page': '1', 'limit': '50'});
      setState(() {
        _data = result ?? {};
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Transaction Enrichment Service'),
        actions: [
