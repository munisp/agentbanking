...
class AdvancedSearchFilteringScreen extends StatefulWidget {
  const AdvancedSearchFilteringScreen({super.key});
  @override
  State<AdvancedSearchFilteringScreen> createState() => _AdvancedSearchFilteringScreenState();
}

class _AdvancedSearchFilteringScreenState extends State<AdvancedSearchFilteringScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Advanced Search Filtering'),
        actions: [
