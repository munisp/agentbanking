...
class RevenueLeakageDetectorScreen extends StatefulWidget {
  const RevenueLeakageDetectorScreen({super.key});
  @override
  State<RevenueLeakageDetectorScreen> createState() => _RevenueLeakageDetectorScreenState();
}

class _RevenueLeakageDetectorScreenState extends State<RevenueLeakageDetectorScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Revenue Leakage Detector'),
        actions: [
