...
const DecentralizedIdentityManagerScreen: React.FC = () => {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.header}>Decentralized Identity Manager</Text>
...
export default DecentralizedIdentityManagerScreen;
