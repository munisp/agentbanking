...
/// Real biometric-preference client backed by the 54Link backend.
...
/*
 ...
 - API Integration: Registers the biometric preference with the 54Link backend (success only on server confirmation); mocks are DEBUG-only.
