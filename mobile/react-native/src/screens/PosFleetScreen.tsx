...
export default function PosFleetScreen() {
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.headerTitle}>POS Fleet</Text>
        ...
        renderItem={({ item }) => (
          <TouchableOpacity style={styles.card}>
            <View style={styles.cardHeader}>
              <Text style={styles.cardTitle}>{item.terminalId}</Text>
              <Text style={styles.cardBadge}>{item.status}</Text>
            </View>
            <Text style={styles.cardSubtitle}>{item.serialNumber}</Text>
            <Text style={styles.cardMeta}>{item.assignedAgent}</Text>
          </TouchableOpacity>
        )}
      />
    </View>
