...
class StoreMallScreen extends StatefulWidget {
  const StoreMallScreen({super.key});
  @override
  State<StoreMallScreen> createState() => _StoreMallScreenState();
}

class _StoreMallScreenState extends State<StoreMallScreen> {
