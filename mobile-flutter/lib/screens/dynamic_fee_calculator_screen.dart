...
class DynamicFeeCalculatorScreen extends StatefulWidget {
  const DynamicFeeCalculatorScreen({super.key});
  @override
  State<DynamicFeeCalculatorScreen> createState() => _DynamicFeeCalculatorScreenState();
}

class _DynamicFeeCalculatorScreenState extends State<DynamicFeeCalculatorScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Dynamic Fee Calculator'),
        actions: [
