...
class NotificationOrchestratorScreen extends StatefulWidget {
  const NotificationOrchestratorScreen({super.key});
  @override
  State<NotificationOrchestratorScreen> createState() => _NotificationOrchestratorScreenState();
}

class _NotificationOrchestratorScreenState extends State<NotificationOrchestratorScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Notification Orchestrator'),
        actions: [
