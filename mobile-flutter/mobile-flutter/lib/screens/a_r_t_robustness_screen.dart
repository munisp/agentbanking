...
class ARTRobustnessScreen extends StatefulWidget {
  const ARTRobustnessScreen({super.key});
  @override
  State<ARTRobustnessScreen> createState() => _ARTRobustnessScreenState();
}

class _ARTRobustnessScreenState extends State<ARTRobustnessScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('A R T Robustness'),
        actions: [
