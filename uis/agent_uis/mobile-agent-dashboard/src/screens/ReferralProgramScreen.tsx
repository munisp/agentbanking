...
const ReferralProgramScreen = () => {
  ...
  const [referralCode, setReferralCode] = useState<string>('54agent-REF-2024');
  ...
  const handleShare = async () => {
    try {
      const result = await Share.share({
        message: `Join me on 54agent Agency Banking! Use my referral code ${referralCode} to get started. Download here: https://54agent.io/download`,
      });
