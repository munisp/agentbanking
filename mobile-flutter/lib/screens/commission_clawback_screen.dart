...
class CommissionClawbackScreen extends StatefulWidget {
  const CommissionClawbackScreen({super.key});
  @override
  State<CommissionClawbackScreen> createState() => _CommissionClawbackScreenState();
}

class _CommissionClawbackScreenState extends State<CommissionClawbackScreen> {
  ...
  Future<void> _load() async {
    try {
      final result = await ApiService.instance.get('/commission/list', queryParams: {'page': '1', 'limit': '50'});
      setState(() {
        _data = result ?? {};
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Commission Clawback'),
        actions: [
