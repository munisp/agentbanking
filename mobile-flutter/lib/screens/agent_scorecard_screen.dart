...
class AgentScorecardScreen extends StatefulWidget {
  const AgentScorecardScreen({super.key});
  @override
  State<AgentScorecardScreen> createState() => _AgentScorecardScreenState();
}

class _AgentScorecardScreenState extends State<AgentScorecardScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Agent Scorecard'),
        actions: [
