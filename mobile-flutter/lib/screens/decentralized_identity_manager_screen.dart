...
class DecentralizedIdentityManagerScreen extends StatefulWidget {
  const DecentralizedIdentityManagerScreen({super.key});
  @override
  State<DecentralizedIdentityManagerScreen> createState() => _DecentralizedIdentityManagerScreenState();
}

class _DecentralizedIdentityManagerScreenState extends State<DecentralizedIdentityManagerScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Decentralized Identity Manager'),
        actions: [
