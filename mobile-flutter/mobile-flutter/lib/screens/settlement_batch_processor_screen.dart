...
class SettlementBatchProcessorScreen extends StatefulWidget {
  const SettlementBatchProcessorScreen({super.key});
  @override
  State<SettlementBatchProcessorScreen> createState() => _SettlementBatchProcessorScreenState();
}

class _SettlementBatchProcessorScreenState extends State<SettlementBatchProcessorScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Settlement Batch Processor'),
        actions: [
