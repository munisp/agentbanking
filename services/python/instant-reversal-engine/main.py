...
if _otel_endpoint:
    try:
        ...
        _resource = Resource.create({
            "service.name": os.environ.get("OTEL_SERVICE_NAME", "instant-reversal-engine"),
...
DATABASE_URL = os.environ.get("DATABASE_URL", "postgres://postgres:postgres@localhost:5432/instant_reversal_engine")
...
async def startup_event():
    ...
    await publish_kafka("instant.reversal.engine.started", {
