...
class LoadTestDashboardScreen extends StatefulWidget {
  const LoadTestDashboardScreen({super.key});
  @override
  State<LoadTestDashboardScreen> createState() => _LoadTestDashboardScreenState();
}

class _LoadTestDashboardScreenState extends State<LoadTestDashboardScreen> {
