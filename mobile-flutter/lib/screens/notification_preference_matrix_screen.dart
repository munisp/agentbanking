...
class NotificationPreferenceMatrixScreen extends StatefulWidget {
  const NotificationPreferenceMatrixScreen({super.key});
  @override
  State<NotificationPreferenceMatrixScreen> createState() => _NotificationPreferenceMatrixScreenState();
}

class _NotificationPreferenceMatrixScreenState extends State<NotificationPreferenceMatrixScreen> {
  ...
  Future<void> _load() async {
    try {
      final result = await ApiService.instance.get('/notifications/list', queryParams: {'page': '1', 'limit': '50'});
      setState(() {
        _data = result ?? {};
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Notification Preference Matrix'),
        actions: [
