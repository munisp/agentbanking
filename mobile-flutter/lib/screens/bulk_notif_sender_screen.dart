...
class BulkNotifSenderScreen extends StatefulWidget {
  const BulkNotifSenderScreen({super.key});
  @override
  State<BulkNotifSenderScreen> createState() => _BulkNotifSenderScreenState();
}

class _BulkNotifSenderScreenState extends State<BulkNotifSenderScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Bulk Notif Sender'),
        actions: [
