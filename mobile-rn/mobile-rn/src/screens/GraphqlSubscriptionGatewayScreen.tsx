...
const GraphqlSubscriptionGatewayScreen: React.FC = () => {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.header}>Graphql Subscription Gateway</Text>
...
export default GraphqlSubscriptionGatewayScreen;
