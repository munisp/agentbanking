...
class WhiteLabelBrandingScreen extends StatefulWidget {
  const WhiteLabelBrandingScreen({super.key});
  @override
  State<WhiteLabelBrandingScreen> createState() => _WhiteLabelBrandingScreenState();
}

class _WhiteLabelBrandingScreenState extends State<WhiteLabelBrandingScreen> {
