...
export const PLATFORM_URLS = {
  kyc: ENV.PLATFORM_KYC_URL ?? "https://kyc.54agent.io",
  videoKyc: ENV.PLATFORM_VIDEO_KYC_URL ?? "https://videokyc.54agent.io",
  fraud: ENV.PLATFORM_FRAUD_URL ?? "https://fraud.54agent.io",
  settlement: ENV.PLATFORM_SETTLEMENT_URL ?? "https://settlement.54agent.io",
  geofencing: ENV.PLATFORM_GEOFENCING_URL ?? "https://geofencing.54agent.io",
  loyalty: ENV.PLATFORM_LOYALTY_URL ?? "https://loyalty.54agent.io",
  float: ENV.PLATFORM_FLOAT_URL ?? "https://float.54agent.io",
  dispute: ENV.PLATFORM_DISPUTE_URL ?? "https://disputes.54agent.io",
  analytics: ENV.PLATFORM_ANALYTICS_URL ?? "https://analytics.54agent.io",
  notification: ENV.PLATFORM_NOTIFICATION_URL ?? "https://notify.54agent.io",
} as const;
