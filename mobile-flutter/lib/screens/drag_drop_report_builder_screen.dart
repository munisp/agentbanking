...
class DragDropReportBuilderScreen extends StatefulWidget {
  const DragDropReportBuilderScreen({super.key});
  @override
  State<DragDropReportBuilderScreen> createState() => _DragDropReportBuilderScreenState();
}

class _DragDropReportBuilderScreenState extends State<DragDropReportBuilderScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Drag Drop Report Builder'),
        actions: [
