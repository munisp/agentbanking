...
class _LoyaltyProgramScreenState extends ConsumerState<LoyaltyProgramScreen> {
  ...
  Future<void> _loadData() async {
    ...
    try {
      ...
      final statsResp = await api.get('/api/trpc/loyalty.getStats');
      final listResp = await api.get('/api/trpc/loyalty.list?input={"limit":20,"offset":0}');
      setState(() {
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                'Coalition loyalty points and rewards',
