...
class PublishReadinessCheckerScreen extends StatefulWidget {
  const PublishReadinessCheckerScreen({super.key});
  @override
  State<PublishReadinessCheckerScreen> createState() => _PublishReadinessCheckerScreenState();
}

class _PublishReadinessCheckerScreenState extends State<PublishReadinessCheckerScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Publish Readiness Checker'),
        actions: [
