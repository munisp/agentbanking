...
export default function AgentInventoryMgmt() {
  ...
  const summary = trpc.agentInventoryMgmt.getSummary.useQuery()?.data as
    | Record<string, unknown>
    | undefined;
  const listQ = trpc.agentInventoryMgmt.list.useQuery({
    limit: 20,
    offset: page * 20,
      ...
      <div className="space-y-6 p-6">
        <div className="flex items-center justify-between flex-wrap gap-4">
          ...
          <div className="flex gap-2 flex-wrap">
            <Button onClick={() => toast.success("Assign Device initiated")}>
              Assign Device
            </Button>
            <Button
              variant="outline"
              onClick={() => toast.success("Report Fault initiated")}
            >
              Report Fault
            </Button>
            <Button
