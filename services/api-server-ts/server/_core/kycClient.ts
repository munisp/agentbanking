 ...
 *  5. Video-KYC liveness (legacy)          (KYC_SERVICE_URL, default: https://videokyc.54agent.io)
 *  6. PaddleOCR document service           (PADDLEOCR_SERVICE_URL, default: https://ocr.54agent.io)
 *  7. Compliance-KYC record store          (COMPLIANCE_KYC_URL, default: https://kyc.54agent.io)
...
const KYC_SERVICE_URL =
  (ENV as any).KYC_SERVICE_URL ?? "https://videokyc.54agent.io";
const PADDLEOCR_URL =
  (ENV as any).PADDLEOCR_SERVICE_URL ?? "https://ocr.54agent.io";
const COMPLIANCE_KYC_URL =
  (ENV as any).COMPLIANCE_KYC_URL ?? "https://kyc.54agent.io";
