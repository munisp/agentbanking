...
class ComplianceFilingScreen extends StatefulWidget {
  const ComplianceFilingScreen({super.key});
  @override
  State<ComplianceFilingScreen> createState() => _ComplianceFilingScreenState();
}

class _ComplianceFilingScreenState extends State<ComplianceFilingScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Compliance Filing'),
        actions: [
