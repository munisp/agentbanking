...
class NetworkQualityHeatmapScreen extends StatefulWidget {
  const NetworkQualityHeatmapScreen({super.key});
  @override
  State<NetworkQualityHeatmapScreen> createState() => _NetworkQualityHeatmapScreenState();
}

class _NetworkQualityHeatmapScreenState extends State<NetworkQualityHeatmapScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Network Quality Heatmap'),
        actions: [
