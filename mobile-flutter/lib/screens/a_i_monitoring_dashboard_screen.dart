...
class AIMonitoringDashboardScreen extends StatefulWidget {
  const AIMonitoringDashboardScreen({super.key});
  @override
  State<AIMonitoringDashboardScreen> createState() => _AIMonitoringDashboardScreenState();
}

class _AIMonitoringDashboardScreenState extends State<AIMonitoringDashboardScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('A I Monitoring'),
        actions: [
