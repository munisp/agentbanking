...
export default function AgentHierarchyTerritoryScreen() {
  ...
  const fetchData = async () => {
    try {
      setError(null);
      const res = await fetch(`${API_BASE}/api/trpc/agentHierarchyTerritory.list`);
  ...
  return (
    ...
    >
      <View style={styles.header}>
        <Text style={styles.title}>Agent Hierarchy Territory</Text>
