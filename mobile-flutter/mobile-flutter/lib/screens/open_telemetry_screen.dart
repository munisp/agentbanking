...
class OpenTelemetryScreen extends StatefulWidget {
  const OpenTelemetryScreen({super.key});
  @override
  State<OpenTelemetryScreen> createState() => _OpenTelemetryScreenState();
}

class _OpenTelemetryScreenState extends State<OpenTelemetryScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Open Telemetry'),
        actions: [
