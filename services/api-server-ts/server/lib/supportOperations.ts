...
const cannedResponses: CannedResponse[] = [
  {
    ...
    title: "Greeting",
    content:
      "Hello {{customer_name}}! Thank you for contacting 54agent support. My name is {{agent_name}} and I'll be happy to assist you today. How can I help?",
    category: "General",
  ...
  },
  {
    ...
    title: "Closing",
    content:
      "Thank you for contacting 54agent support, {{customer_name}}. If you need further assistance, don't hesitate to reach out. Have a great day!",
    category: "General",
