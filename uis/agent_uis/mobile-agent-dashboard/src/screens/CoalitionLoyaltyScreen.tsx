...
const CoalitionLoyaltyScreen: React.FC = () => {
  ...
  const load = useCallback(async () => {
    try {
      setError('');
      const { data } = await apiClient.get('/loyalty/list?page=1&limit=50');
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.header}>Coalition Loyalty</Text>
...
export default CoalitionLoyaltyScreen;
