...
class PipelineMonitoringScreen extends StatefulWidget {
  const PipelineMonitoringScreen({super.key});
  @override
  State<PipelineMonitoringScreen> createState() => _PipelineMonitoringScreenState();
}

class _PipelineMonitoringScreenState extends State<PipelineMonitoringScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Pipeline Monitoring'),
        actions: [
