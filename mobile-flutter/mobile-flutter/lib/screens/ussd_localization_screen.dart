...
class UssdLocalizationScreen extends StatefulWidget {
  const UssdLocalizationScreen({super.key});
  @override
  State<UssdLocalizationScreen> createState() => _UssdLocalizationScreenState();
}

class _UssdLocalizationScreenState extends State<UssdLocalizationScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Ussd Localization'),
        actions: [
