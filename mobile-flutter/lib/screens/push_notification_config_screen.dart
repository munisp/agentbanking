...
class PushNotificationConfigScreen extends StatefulWidget {
  const PushNotificationConfigScreen({super.key});
  @override
  State<PushNotificationConfigScreen> createState() => _PushNotificationConfigScreenState();
}

class _PushNotificationConfigScreenState extends State<PushNotificationConfigScreen> {
