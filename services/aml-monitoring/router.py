...
The real implementation lives in the standalone service (services/aml-monitoring/).
...
_UNAVAILABLE = (
    "aml-monitoring endpoints are not served by this gateway router. "
    "Use the standalone aml-monitoring service."
)
...
async def health_check():
    return JSONResponse(
        status_code=503,
        content={"status": "unavailable", "service": "aml-monitoring", "detail": _UNAVAILABLE},
    )
