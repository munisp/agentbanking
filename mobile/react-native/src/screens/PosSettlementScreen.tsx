  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.headerTitle}>POS Settlement</Text>
        ...
        renderItem={({ item }) => (
          <TouchableOpacity style={styles.card}>
            <View style={styles.cardHeader}>
              <Text style={styles.cardTitle}>{item.batchRef}</Text>
              <Text style={styles.cardBadge}>{item.netAmount}</Text>
            </View>
            <Text style={styles.cardSubtitle}>{item.totalAmount}</Text>
