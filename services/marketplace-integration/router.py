...
The real implementation lives in the standalone service (services/marketplace-integration/).
...
_UNAVAILABLE = (
    "marketplace-integration endpoints are not served by this gateway router. "
    "Use the standalone marketplace-integration service."
)
...
async def health_check():
    return JSONResponse(
        status_code=503,
        content={"status": "unavailable", "service": "marketplace-integration", "detail": _UNAVAILABLE},
    )
