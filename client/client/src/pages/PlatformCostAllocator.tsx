...
export default function PlatformCostAllocator() {
  ...
  const summary = trpc.platformCostAllocator.getStats.useQuery()?.data as
      ...
      <div className="space-y-6 p-6">
        <div className="flex items-center justify-between flex-wrap gap-4">
          <div>
            ...
            <p className="text-muted-foreground">
              Infrastructure cost allocation, chargeback, and cost optimization
            </p>
          </div>
          <div className="flex gap-2 flex-wrap">
            ...
            <Button
              variant="outline"
              onClick={() => toast.success("Set Budgets initiated")}
            >
              Set Budgets
            </Button>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <Card key="1">
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {formatCurrency(summary?.allocatedCost)}
              </div>
            </CardContent>
          </Card>
          <Card key="2">
          ...
          <Card key="3">
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {formatCurrency(summary?.savingsIdentified)}
              </div>
            </CardContent>
          </Card>
        </div>
