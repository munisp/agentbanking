...
54Link POS Credit Scoring Engine
...
app = FastAPI(
    title="54Link Credit Scoring API",
    description="Agent credit scoring engine for the 54Link POS platform",
    version="1.0.0",
)
...
if __name__ == "__main__":
    ...
    logger.info(f"54Link Credit Scoring Service starting on :{port}")
