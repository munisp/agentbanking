...
class RealtimeDashboardWidgetsScreen extends StatefulWidget {
  const RealtimeDashboardWidgetsScreen({super.key});
  @override
  State<RealtimeDashboardWidgetsScreen> createState() => _RealtimeDashboardWidgetsScreenState();
}

class _RealtimeDashboardWidgetsScreenState extends State<RealtimeDashboardWidgetsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Realtime Widgets'),
        actions: [
