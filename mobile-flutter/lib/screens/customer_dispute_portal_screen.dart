...
class CustomerDisputePortalScreen extends StatefulWidget {
  const CustomerDisputePortalScreen({super.key});
  @override
  State<CustomerDisputePortalScreen> createState() => _CustomerDisputePortalScreenState();
}

class _CustomerDisputePortalScreenState extends State<CustomerDisputePortalScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Customer Dispute Portal'),
        actions: [
