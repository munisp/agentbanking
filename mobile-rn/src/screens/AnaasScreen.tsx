  ...
  if (loading) {
    return (
      <View style={styles.center}>
        ...
        <Text style={styles.loadingText}>Loading ANaaS...</Text>
      </View>
    );
  }
  ...
  return (
    ...
    >
      ...
      <View style={styles.header}>
        <Text style={styles.title}>ANaaS</Text>
        <Text style={styles.subtitle}>Agent Network as a Service for banks and fintechs</Text>
      </View>
