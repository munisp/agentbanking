...
class AutomatedSettlementSchedulerScreen extends StatefulWidget {
  const AutomatedSettlementSchedulerScreen({super.key});
  @override
  State<AutomatedSettlementSchedulerScreen> createState() => _AutomatedSettlementSchedulerScreenState();
}

class _AutomatedSettlementSchedulerScreenState extends State<AutomatedSettlementSchedulerScreen> {
  ...
  Future<void> _load() async {
    try {
      final result = await ApiService.instance.get('/settlement/list', queryParams: {'page': '1', 'limit': '50'});
      setState(() {
        _data = result ?? {};
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Automated Settlement Scheduler'),
        actions: [
