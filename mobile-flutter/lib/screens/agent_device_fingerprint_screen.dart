...
class AgentDeviceFingerprintScreen extends StatefulWidget {
  const AgentDeviceFingerprintScreen({super.key});
  @override
  State<AgentDeviceFingerprintScreen> createState() => _AgentDeviceFingerprintScreenState();
}

class _AgentDeviceFingerprintScreenState extends State<AgentDeviceFingerprintScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Agent Device Fingerprint'),
        actions: [
