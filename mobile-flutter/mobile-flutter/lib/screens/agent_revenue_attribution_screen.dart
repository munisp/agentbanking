...
class AgentRevenueAttributionScreen extends StatefulWidget {
  const AgentRevenueAttributionScreen({super.key});
  @override
  State<AgentRevenueAttributionScreen> createState() => _AgentRevenueAttributionScreenState();
}

class _AgentRevenueAttributionScreenState extends State<AgentRevenueAttributionScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Agent Revenue Attribution'),
        actions: [
