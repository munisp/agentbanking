...
export default function AgentClusterAnalytics() {
  ...
  const summary = trpc.agentClusterAnalytics.getSummary.useQuery()?.data as
    | Record<string, unknown>
    | undefined;
  const listQ = trpc.agentClusterAnalytics.list.useQuery({
    limit: 20,
    offset: page * 20,
                    ...
                    <tbody>
                      {items.map((row: any, idx: number) => (
                        ...
                        >
                          ...
                          <td className="p-3">
                            {Number(row.agentCount ?? 0).toLocaleString()}
                          </td>
                          <td className="p-3">
