...
class AgentPerformanceLeaderboardScreen extends StatefulWidget {
  const AgentPerformanceLeaderboardScreen({super.key});
  @override
  State<AgentPerformanceLeaderboardScreen> createState() => _AgentPerformanceLeaderboardScreenState();
}

class _AgentPerformanceLeaderboardScreenState extends State<AgentPerformanceLeaderboardScreen> {
  ...
  Future<void> _load() async {
    try {
      final result = await ApiService.instance.get('/agent/list', queryParams: {'page': '1', 'limit': '50'});
      setState(() {
        _data = result ?? {};
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Agent Performance Leaderboard'),
        actions: [
