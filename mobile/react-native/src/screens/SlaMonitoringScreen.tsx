...
/** Monitor SLAs and breach alerts */
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.headerTitle}>SLA Monitoring</Text>
        ...
        renderItem={({ item }) => (
          <TouchableOpacity style={styles.card}>
            <View style={styles.cardHeader}>
              ...
              <Text style={styles.cardBadge}>{item.actual}</Text>
            </View>
            <Text style={styles.cardSubtitle}>{item.target}</Text>
            <Text style={styles.cardMeta}>{item.breached}</Text>
          </TouchableOpacity>
        )}
      />
    </View>
