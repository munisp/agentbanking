...
export default function EcommerceShoppingCartScreen() {
  ...
  const fetchData = async () => {
    try {
      setError(null);
      const res = await fetch(`${API_BASE}/api/trpc/ecommerceShoppingCart.list`);
  ...
  return (
    ...
    >
      <View style={styles.header}>
        <Text style={styles.title}>Ecommerce Shopping Cart</Text>
