...
class MerchantAnalyticsDashScreen extends StatefulWidget {
  const MerchantAnalyticsDashScreen({super.key});
  @override
  State<MerchantAnalyticsDashScreen> createState() => _MerchantAnalyticsDashScreenState();
}

class _MerchantAnalyticsDashScreenState extends State<MerchantAnalyticsDashScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Merchant Analytics Dash'),
        actions: [
