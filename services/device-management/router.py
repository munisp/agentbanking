...
The real implementation lives in the standalone service (services/device-management/).
...
_UNAVAILABLE = (
    "device-management endpoints are not served by this gateway router. "
    "Use the standalone device-management service."
)
...
async def health_check():
    return JSONResponse(
        status_code=503,
        content={"status": "unavailable", "service": "device-management", "detail": _UNAVAILABLE},
    )
