...
class CbdcIntegrationGatewayScreen extends StatefulWidget {
  const CbdcIntegrationGatewayScreen({super.key});
  @override
  State<CbdcIntegrationGatewayScreen> createState() => _CbdcIntegrationGatewayScreenState();
}

class _CbdcIntegrationGatewayScreenState extends State<CbdcIntegrationGatewayScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Cbdc Integration Gateway'),
        actions: [
