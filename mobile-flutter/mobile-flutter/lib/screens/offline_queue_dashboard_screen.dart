...
class OfflineQueueDashboardScreen extends StatefulWidget {
  const OfflineQueueDashboardScreen({super.key});
  @override
  State<OfflineQueueDashboardScreen> createState() => _OfflineQueueDashboardScreenState();
}

class _OfflineQueueDashboardScreenState extends State<OfflineQueueDashboardScreen> {
