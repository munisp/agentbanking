...
class AgentPerformanceAnalyticsScreen extends StatefulWidget {
  const AgentPerformanceAnalyticsScreen({super.key});
  @override
  State<AgentPerformanceAnalyticsScreen> createState() => _AgentPerformanceAnalyticsScreenState();
}

class _AgentPerformanceAnalyticsScreenState extends State<AgentPerformanceAnalyticsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Agent Performance Analytics'),
        actions: [
