...
class TransactionFeeCalcScreen extends StatefulWidget {
  const TransactionFeeCalcScreen({super.key});
  @override
  State<TransactionFeeCalcScreen> createState() => _TransactionFeeCalcScreenState();
}

class _TransactionFeeCalcScreenState extends State<TransactionFeeCalcScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Transaction Fee Calc'),
        actions: [
