...
/** @deprecated */
public interface PrinterOpt extends android.os.IInterface
{
  /** Default implementation for PrinterOpt. */
  public static class Default implements com.sunmi.pay.hardware.aidl.print.PrinterOpt
  {
    /**
         * 打开打印机
         * @return 0-成功，<0-错误码
    ...
    /**
         ...
         * @deprecated
         */
    @Override public void registerPrintCallback(com.sunmi.pay.hardware.aidl.print.PrinterCallback callback) throws android.os.RemoteException
    {
    }
    /**
         * 取消注册打印状态回调对象
  ...
  public static abstract class Stub extends android.os.Binder implements com.sunmi.pay.hardware.aidl.print.PrinterOpt
  {
    private static final java.lang.String DESCRIPTOR = "com.sunmi.pay.hardware.aidl.print.PrinterOpt";
    ...
    /**
     * Cast an IBinder object into an com.sunmi.pay.hardware.aidl.print.PrinterOpt interface,
     * generating a proxy if needed.
     */
    public static com.sunmi.pay.hardware.aidl.print.PrinterOpt asInterface(android.os.IBinder obj)
    {
      if ((obj==null)) {
        return null;
      }
      android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
      if (((iin!=null)&&(iin instanceof com.sunmi.pay.hardware.aidl.print.PrinterOpt))) {
        return ((com.sunmi.pay.hardware.aidl.print.PrinterOpt)iin);
      }
      return new com.sunmi.pay.hardware.aidl.print.PrinterOpt.Stub.Proxy(obj);
    }
    ...
    @Override public boolean onTransact(int code, android.os.Parcel data, android.os.Parcel reply, int flags) throws android.os.RemoteException
    {
      ...
      switch (code)
      {
        ...
        {
          data.enforceInterface(descriptor);
          com.sunmi.pay.hardware.aidl.print.PrinterCallback _arg0;
          _arg0 = com.sunmi.pay.hardware.aidl.print.PrinterCallback.Stub.asInterface(data.readStrongBinder());
    ...
    private static class Proxy implements com.sunmi.pay.hardware.aidl.print.PrinterOpt
    {
      ...
      public static com.sunmi.pay.hardware.aidl.print.PrinterOpt sDefaultImpl;
    }
    ...
    public static boolean setDefaultImpl(com.sunmi.pay.hardware.aidl.print.PrinterOpt impl) {
    ...
    public static com.sunmi.pay.hardware.aidl.print.PrinterOpt getDefaultImpl() {
  ...
  /**
       ...
       * @deprecated
       */
  public void registerPrintCallback(com.sunmi.pay.hardware.aidl.print.PrinterCallback callback) throws android.os.RemoteException;
  /**
       * 取消注册打印状态回调对象
       * @deprecated
       */
