...
export default function OfflinePosMode() {
  ...
  const summary = trpc.offlinePosMode.getStats.useQuery()?.data as
      ...
      <div className="space-y-6 p-6">
        <div className="flex items-center justify-between flex-wrap gap-4">
          <div>
            ...
            <p className="text-muted-foreground">
              Offline transaction queuing, sync management, and conflict
              resolution
            </p>
          </div>
          <div className="flex gap-2 flex-wrap">
            <Button onClick={() => toast.success("Force Sync initiated")}>
              Force Sync
            </Button>
            <Button
              variant="outline"
              onClick={() => toast.success("Resolve Conflicts initiated")}
            >
              Resolve Conflicts
            </Button>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <Card key="0">
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {(summary?.offlineDevices ?? 0).toLocaleString()}
              </div>
            </CardContent>
          </Card>
          <Card key="1">
          ...
          <Card key="2">
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {(summary?.totalQueued ?? 0).toLocaleString()}
              </div>
            </CardContent>
          </Card>
          <Card key="3">
