...
class UssdAnalyticsDashboardScreen extends StatefulWidget {
  const UssdAnalyticsDashboardScreen({super.key});
  @override
  State<UssdAnalyticsDashboardScreen> createState() => _UssdAnalyticsDashboardScreenState();
}

class _UssdAnalyticsDashboardScreenState extends State<UssdAnalyticsDashboardScreen> {
  ...
  Future<void> _load() async {
    try {
      final result = await ApiService.instance.get('/ussd/list', queryParams: {'page': '1', 'limit': '50'});
      setState(() {
        _data = result ?? {};
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Ussd Analytics'),
        actions: [
