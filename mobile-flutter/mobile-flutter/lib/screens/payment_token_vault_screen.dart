...
class PaymentTokenVaultScreen extends StatefulWidget {
  const PaymentTokenVaultScreen({super.key});
  @override
  State<PaymentTokenVaultScreen> createState() => _PaymentTokenVaultScreenState();
}

class _PaymentTokenVaultScreenState extends State<PaymentTokenVaultScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Payment Token Vault'),
        actions: [
