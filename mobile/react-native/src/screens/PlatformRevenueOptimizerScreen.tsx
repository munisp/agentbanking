...
export default function PlatformRevenueOptimizerScreen() {
  ...
  const fetchData = async () => {
    try {
      setError(null);
      const res = await fetch(`${API_BASE}/api/trpc/platformRevenueOptimizer.list`);
  ...
  return (
    ...
    >
      <View style={styles.header}>
        <Text style={styles.title}>Platform Revenue Optimizer</Text>
